...
#    define OMPI_DATATYPE_MPI_REAL2 OMPI_DATATYPE_MPI_REAL
    ...
    || (defined(HAVE_OPAL_SHORT_FLOAT_T)                                             \
        && OMPI_SIZEOF_FORTRAN_REAL2 == SIZEOF_OPAL_SHORT_FLOAT_T)
...
#    define OMPI_DATATYPE_MPI_REAL4 OMPI_DATATYPE_MPI_REAL
    ...
    || (defined(HAVE_OPAL_SHORT_FLOAT_T)                                             \
        && OMPI_SIZEOF_FORTRAN_REAL4 == SIZEOF_OPAL_SHORT_FLOAT_T)
...
#    define OMPI_DATATYPE_MPI_REAL8 OMPI_DATATYPE_MPI_REAL
    ...
    || (defined(HAVE_OPAL_SHORT_FLOAT_T)                                             \
        && OMPI_SIZEOF_FORTRAN_REAL8 == SIZEOF_OPAL_SHORT_FLOAT_T)
...
#    define OMPI_DATATYPE_MPI_REAL16 OMPI_DATATYPE_MPI_REAL
    ...
    || (defined(HAVE_OPAL_SHORT_FLOAT_T)                                              \
        && OMPI_SIZEOF_FORTRAN_REAL16 == SIZEOF_OPAL_SHORT_FLOAT_T)
...
#define OMPI_DATATYPE_EMPTY_DATA(NAME)                                                     \
    .id = OMPI_DATATYPE_MPI_##NAME, .d_f_to_c_index = -1, .d_keyhash = NULL, .args = NULL, \
    .packed_description = 0, .name = "MPI_" #NAME

#define OMPI_DATATYPE_INITIALIZER_UNAVAILABLE(FLAGS) OPAL_DATATYPE_INITIALIZER_UNAVAILABLE(FLAGS)
    ...
    { /*ompi_predefined_datatype_t*/                                                              \
        {                                                                                         \
            ...
            OMPI_DATATYPE_INITIALIZER_##TYPE(OMPI_DATATYPE_FLAG_PREDEFINED                        \
                                             ...
                                             | OMPI_DATATYPE_FLAG_MONOTONIC | (FLAGS)) /*super*/, \
            OMPI_DATATYPE_EMPTY_DATA(                                                             \
                NAME) /*id,d_f_to_c_index,d_keyhash,args,packed_description,name*/                \
        },                                                                                        \
        {                                                                                         \
            0,                                                                                    \
        } /* padding */                                                                           \
...
#define OMPI_DATATYPE_INIT_PREDEFINED_BASIC_TYPE(TYPE, NAME, FLAGS) \
    OMPI_DATATYPE_INIT_PREDEFINED_BASIC_TYPE_X(TYPE, NAME, FLAGS)
 ...
 */
#define OMPI_DATATYPE_INIT_DEFER(NAME, FLAGS) OMPI_DATATYPE_INIT_UNAVAILABLE(NAME, FLAGS)
...
#    define OMPI_DATATYPE_INITIALIZER_FORTRAN(TYPE, NAME, SIZE, ALIGN, FLAGS)                   \
        {                                                                                       \
            ...
            .flags = OPAL_DATATYPE_FLAG_BASIC | OMPI_DATATYPE_FLAG_PREDEFINED                   \
                     | OMPI_DATATYPE_FLAG_ANALYZED | OMPI_DATATYPE_FLAG_MONOTONIC               \
                     | OMPI_DATATYPE_FLAG_DATA_FORTRAN | (FLAGS),                               \
            .id = OPAL_DATATYPE_##TYPE##SIZE,                                                   \
            .bdt_used = (((uint32_t) 1) << (OPAL_DATATYPE_##TYPE##SIZE)), .size = SIZE,         \
            .true_lb = 0, .true_ub = SIZE, .lb = 0, .ub = SIZE, .align = (ALIGN), .nbElems = 1, \
...
#define OMPI_DATATYPE_INITIALIZER_C_SHORT_FLOAT_COMPLEX \
    OPAL_DATATYPE_INITIALIZER_SHORT_FLOAT_COMPLEX
...
#define OMPI_DATATYPE_INITIALIZER_C_LONG_DOUBLE_COMPLEX \
    OPAL_DATATYPE_INITIALIZER_LONG_DOUBLE_COMPLEX
...
/* If the number of basic datatype should change update OMPI_DATATYPE_MAX_PREDEFINED in
 * ompi_datatype.h */
