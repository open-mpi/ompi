...
const struct ompi_mtl_psm2_name_descs name_descs[PSM2_MQ_NUM_STATS] = {
    ...
    {"tx_num", "Total Messages transmitted (shm and hfi)", offsetof(struct psm2_mq_stats, tx_num)},
    {"tx_eager_num", "Messages transmitted eagerly", offsetof(struct psm2_mq_stats, tx_eager_num)},
    {"tx_eager_bytes", "Bytes transmitted eagerl", offsetof(struct psm2_mq_stats, tx_eager_bytes)},
    ...
    {"tx_shm_num", "Messages transmitted (shm only)", offsetof(struct psm2_mq_stats, tx_shm_num)},
    {"rx_shm_num", "Messages received through shm", offsetof(struct psm2_mq_stats, rx_shm_num)},
