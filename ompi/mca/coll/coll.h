...
struct mca_coll_base_module_2_2_0_t {
    ...
    mca_coll_base_module_iallgather_fn_t coll_iallgather_init;
    mca_coll_base_module_iallgatherv_fn_t coll_iallgatherv_init;
    mca_coll_base_module_iallreduce_fn_t coll_iallreduce_init;
    mca_coll_base_module_ialltoall_fn_t coll_ialltoall_init;
    mca_coll_base_module_ialltoallv_fn_t coll_ialltoallv_init;
    mca_coll_base_module_ialltoallw_fn_t coll_ialltoallw_init;
    mca_coll_base_module_ibarrier_fn_t coll_ibarrier_init;
    mca_coll_base_module_ibcast_fn_t coll_ibcast_init;
    mca_coll_base_module_iexscan_fn_t coll_iexscan_init;
    mca_coll_base_module_igather_fn_t coll_igather_init;
    mca_coll_base_module_igatherv_fn_t coll_igatherv_init;
    mca_coll_base_module_ireduce_fn_t coll_ireduce_init;
    mca_coll_base_module_ireduce_scatter_fn_t coll_ireduce_scatter_init;
    mca_coll_base_module_ireduce_scatter_block_fn_t coll_ireduce_scatter_block_init;
    mca_coll_base_module_iscan_fn_t coll_iscan_init;
    mca_coll_base_module_iscatter_fn_t coll_iscatter_init;
    mca_coll_base_module_iscatterv_fn_t coll_iscatterv_init;
