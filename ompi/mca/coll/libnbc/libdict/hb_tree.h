...
hb_tree *hb_tree_new __P((dict_cmp_func key_cmp, dict_del_func key_del, dict_del_func dat_del));
dict *hb_dict_new __P((dict_cmp_func key_cmp, dict_del_func key_del, dict_del_func dat_del));
