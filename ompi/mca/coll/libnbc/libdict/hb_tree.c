...
hb_tree *hb_tree_new(dict_cmp_func key_cmp, dict_del_func key_del, dict_del_func dat_del)
{
    hb_tree *tree;
...
dict *hb_dict_new(dict_cmp_func key_cmp, dict_del_func key_del, dict_del_func dat_del)
{
    dict *dct;
    hb_tree *tree;
...
void hb_itor_destroy(hb_itor *itor)
{
    ASSERT(itor != NULL);
