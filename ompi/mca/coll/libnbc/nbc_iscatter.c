                            ...
                            mca_coll_base_module_t *module, bool persistent)
{
    ...
    search.root = root;
    found = (NBC_Scatter_args *) hb_tree_search((hb_tree *) libnbc_module->NBC_Dict[NBC_SCATTER],
                                                &search);
    if (NULL == found) {
#endif
            ...
            for (int i = 0; i < p; ++i) {
                ...
                if (i == root) {
                    if (!inplace) {
                        ...
                        res = NBC_Sched_copy(sbuf, false, sendcount, sendtype, recvbuf, false,
...
int ompi_coll_libnbc_iscatter_inter(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                    ...
                                    mca_coll_base_module_t *module)
{
    int res = nbc_scatter_inter_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype,
