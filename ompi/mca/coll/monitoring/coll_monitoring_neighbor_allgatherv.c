                                            ...
                                            mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_neighbor_allgatherv(sbuf, scount, sdtype, rbuf, rcounts, disps, rdtype, comm,
                                  monitoring_module->real.coll_neighbor_allgatherv_module);
}

int mca_coll_monitoring_ineighbor_allgatherv(
    ...
    ompi_request_t **request, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_ineighbor_allgatherv(sbuf, scount, sdtype, rbuf, rcounts, disps, rdtype, comm,
                                   request,
                                   monitoring_module->real.coll_ineighbor_allgatherv_module);
}
