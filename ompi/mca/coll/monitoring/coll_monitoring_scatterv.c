                                 ...
                                 struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_scatterv(sbuf, scounts, disps, sdtype, rbuf, rcount, rdtype,
                                                 root, comm,
                                                 monitoring_module->real.coll_scatterv_module);
}
                                  ...
                                  mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_iscatterv(sbuf, scounts, disps, sdtype, rbuf, rcount,
