    ...
    do {                                                                                  \
        if (NULL != __module->real.coll_##__api##_module) {                               \
            if (NULL != __module->real.coll_##__api##_module->coll_module_disable) {      \
                __module->real.coll_##__api##_module                                      \
                    ->coll_module_disable(__module->real.coll_##__api##_module, __comm);  \
            }                                                                             \
        ...
        if (NULL != __module->real.coll_i##__api##_module) {                              \
            if (NULL != __module->real.coll_i##__api##_module->coll_module_disable) {     \
                __module->real.coll_i##__api##_module                                     \
                    ->coll_module_disable(__module->real.coll_i##__api##_module, __comm); \
            }                                                                             \
...
static int mca_coll_monitoring_component_init(bool enable_progress_threads, bool enable_mpi_threads)
{
...
static int mca_coll_monitoring_module_enable(mca_coll_base_module_t *module,
...
static int mca_coll_monitoring_module_disable(mca_coll_base_module_t *module,
                                              struct ompi_communicator_t *comm)
{
    mca_coll_monitoring_module_t *monitoring_module = (mca_coll_monitoring_module_t *) module;
...
static mca_coll_base_module_t *mca_coll_monitoring_component_query(struct ompi_communicator_t *comm,
                                                                   int *priority)
{
...
OBJ_CLASS_INSTANCE(mca_coll_monitoring_module_t, mca_coll_base_module_t, NULL, NULL);
