...
int mca_coll_monitoring_allgatherv(const void *sbuf, int scount, struct ompi_datatype_t *sdtype,
                                   ...
                                   mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_allgatherv(sbuf, scount, sdtype, rbuf, rcounts, disps,
                                                   rdtype, comm,
                                                   monitoring_module->real.coll_allgatherv_module);
}

int mca_coll_monitoring_iallgatherv(const void *sbuf, int scount, struct ompi_datatype_t *sdtype,
                                    void *rbuf, const int *rcounts, const int *disps,
                                    ...
                                    mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_iallgatherv(sbuf, scount, sdtype, rbuf, rcounts, disps, rdtype, comm, request,
                          monitoring_module->real.coll_iallgatherv_module);
}
