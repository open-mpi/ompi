                                          ...
                                          mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_neighbor_alltoall(sbuf, scount, sdtype, rbuf, rcount, rdtype, comm,
                                monitoring_module->real.coll_neighbor_alltoall_module);
}
                                           ...
                                           ompi_request_t **request, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_ineighbor_alltoall(sbuf, scount, sdtype, rbuf, rcount, rdtype, comm, request,
