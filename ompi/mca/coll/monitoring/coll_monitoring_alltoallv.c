                                  ...
                                  struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_alltoallv(sbuf, scounts, sdisps, sdtype, rbuf, rcounts,
                                                  rdisps, rdtype, comm,
                                                  monitoring_module->real.coll_alltoallv_module);
}

int mca_coll_monitoring_ialltoallv(const void *sbuf, const int *scounts, const int *sdisps,
                                   struct ompi_datatype_t *sdtype, void *rbuf, const int *rcounts,
                                   const int *rdisps, struct ompi_datatype_t *rdtype,
                                   ...
                                   mca_coll_base_module_t *module)
{
    ...
    mca_common_monitoring_coll_a2a(data_size_aggreg, monitoring_module->data);
    return monitoring_module->real.coll_ialltoallv(sbuf, scounts, sdisps, sdtype, rbuf, rcounts,
                                                   rdisps, rdtype, comm, request,
