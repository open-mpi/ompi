                                 ...
                                 struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_alltoall(sbuf, scount, sdtype, rbuf, rcount, rdtype, comm,
                                                 monitoring_module->real.coll_alltoall_module);
}

int mca_coll_monitoring_ialltoall(const void *sbuf, int scount, struct ompi_datatype_t *sdtype,
                                  void *rbuf, int rcount, struct ompi_datatype_t *rdtype,
                                  ...
                                  mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real.coll_ialltoall(sbuf, scount, sdtype, rbuf, rcount, rdtype, comm,
                                                  request,
                                                  monitoring_module->real.coll_ialltoall_module);
}
