                                           ...
                                           mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_neighbor_alltoallw(sbuf, scounts, sdisps, sdtypes, rbuf, rcounts, rdisps, rdtypes,
                                 comm, monitoring_module->real.coll_neighbor_alltoallw_module);
}

int mca_coll_monitoring_ineighbor_alltoallw(
    ...
    ompi_request_t **request, mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_ineighbor_alltoallw(sbuf, scounts, sdisps, sdtypes, rbuf, rcounts, rdisps, rdtypes,
                                  comm, request,
