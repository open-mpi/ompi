...
int mca_coll_monitoring_reduce_scatter(const void *sbuf, void *rbuf, const int *rcounts,
                                       ...
                                       mca_coll_base_module_t *module)
{
    ...
    return monitoring_module->real
        .coll_reduce_scatter(sbuf, rbuf, rcounts, dtype, op, comm,
                             monitoring_module->real.coll_reduce_scatter_module);
}

int mca_coll_monitoring_ireduce_scatter(const void *sbuf, void *rbuf, const int *rcounts,
                                        struct ompi_datatype_t *dtype, struct ompi_op_t *op,
                                        ...
                                        mca_coll_base_module_t *module)
{
    ...
    mca_common_monitoring_coll_a2a(data_size_aggreg, monitoring_module->data);
    return monitoring_module->real
        .coll_ireduce_scatter(sbuf, rbuf, rcounts, dtype, op, comm, request,
                              monitoring_module->real.coll_ireduce_scatter_module);
}
