...
int mca_coll_monitoring_barrier(struct ompi_communicator_t *comm, mca_coll_base_module_t *module)
{
...
int mca_coll_monitoring_ibarrier(struct ompi_communicator_t *comm, ompi_request_t **request,
                                 mca_coll_base_module_t *module)
{
    ...
    mca_common_monitoring_coll_a2a(0, monitoring_module->data);
    return monitoring_module->real.coll_ibarrier(comm, request,
                                                 monitoring_module->real.coll_ibarrier_module);
}
