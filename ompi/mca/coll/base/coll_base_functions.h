...
#define ALLGATHER_BASE_ARGS                                                              \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define ALLGATHERV_BASE_ARGS                                                             \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        const int recvcounts[], const int displs[], struct ompi_datatype_t *recvtype,    \
        struct ompi_communicator_t *comm
#define ALLREDUCE_BASE_ARGS                                                          \
    const void *sendbuf, void *recvbuf, int count, struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, struct ompi_communicator_t *comm
#define ALLTOALL_BASE_ARGS                                                               \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define ALLTOALLV_BASE_ARGS                                                      \
    const void *sendbuf, const int sendcounts[], const int sdispls[],            \
        struct ompi_datatype_t *sendtype, void *recvbuf, const int recvcounts[], \
        const int rdispls[], struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define ALLTOALLW_BASE_ARGS                                                               \
    const void *sendbuf, const int sendcounts[], const int sdispls[],                     \
...
#define BCAST_BASE_ARGS                                                  \
    void *buffer, int count, struct ompi_datatype_t *datatype, int root, \
        struct ompi_communicator_t *comm
#define EXSCAN_BASE_ARGS                                                             \
    const void *sendbuf, void *recvbuf, int count, struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, struct ompi_communicator_t *comm
#define GATHER_BASE_ARGS                                                                 \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, int root,                       \
        struct ompi_communicator_t *comm
#define GATHERV_BASE_ARGS                                                                       \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf,        \
        const int recvcounts[], const int displs[], struct ompi_datatype_t *recvtype, int root, \
        struct ompi_communicator_t *comm
#define REDUCE_BASE_ARGS                                                             \
    const void *sendbuf, void *recvbuf, int count, struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, int root, struct ompi_communicator_t *comm
#define REDUCESCATTER_BASE_ARGS                                                                   \
    const void *sendbuf, void *recvbuf, const int recvcounts[], struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, struct ompi_communicator_t *comm
#define REDUCESCATTERBLOCK_BASE_ARGS                                                     \
    const void *sendbuf, void *recvbuf, int recvcount, struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, struct ompi_communicator_t *comm
#define SCAN_BASE_ARGS                                                               \
    const void *sendbuf, void *recvbuf, int count, struct ompi_datatype_t *datatype, \
        struct ompi_op_t *op, struct ompi_communicator_t *comm
#define SCATTER_BASE_ARGS                                                                \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, int root,                       \
        struct ompi_communicator_t *comm
#define SCATTERV_BASE_ARGS                                              \
    const void *sendbuf, const int sendcounts[], const int displs[],    \
        struct ompi_datatype_t *sendtype, void *recvbuf, int recvcount, \
        struct ompi_datatype_t *recvtype, int root, struct ompi_communicator_t *comm
#define NEIGHBOR_ALLGATHER_BASE_ARGS                                                     \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define NEIGHBOR_ALLGATHERV_BASE_ARGS                                                    \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        const int recvcounts[], const int displs[], struct ompi_datatype_t *recvtype,    \
        struct ompi_communicator_t *comm
#define NEIGHBOR_ALLTOALL_BASE_ARGS                                                      \
    const void *sendbuf, int sendcount, struct ompi_datatype_t *sendtype, void *recvbuf, \
        int recvcount, struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define NEIGHBOR_ALLTOALLV_BASE_ARGS                                             \
    const void *sendbuf, const int sendcounts[], const int sdispls[],            \
        struct ompi_datatype_t *sendtype, void *recvbuf, const int recvcounts[], \
        const int rdispls[], struct ompi_datatype_t *recvtype, struct ompi_communicator_t *comm
#define NEIGHBOR_ALLTOALLW_BASE_ARGS                                                      \
    const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[],                \
        struct ompi_datatype_t *const sendtypes[], void *recvbuf, const int recvcounts[], \
        const MPI_Aint rdispls[], struct ompi_datatype_t *const recvtypes[],              \
        struct ompi_communicator_t *comm
...
#define IALLGATHER_ARGS \
    ALLGATHER_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IALLGATHERV_ARGS \
    ALLGATHERV_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IALLREDUCE_ARGS \
    ALLREDUCE_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IALLTOALL_ARGS ALLTOALL_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IALLTOALLV_ARGS \
    ALLTOALLV_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IALLTOALLW_ARGS \
    ALLTOALLW_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
...
#define IREDUCESCATTER_ARGS \
    REDUCESCATTER_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define IREDUCESCATTERBLOCK_ARGS \
    REDUCESCATTERBLOCK_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
...
#define INEIGHBOR_ALLGATHER_ARGS \
    NEIGHBOR_ALLGATHER_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define INEIGHBOR_ALLGATHERV_ARGS \
    NEIGHBOR_ALLGATHERV_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define INEIGHBOR_ALLTOALL_ARGS \
    NEIGHBOR_ALLTOALL_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define INEIGHBOR_ALLTOALLV_ARGS \
    NEIGHBOR_ALLTOALLV_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module
#define INEIGHBOR_ALLTOALLW_ARGS \
    NEIGHBOR_ALLTOALLW_BASE_ARGS, ompi_request_t **request, mca_coll_base_module_t *module

#define ALLGATHER_INIT_ARGS \
    ALLGATHER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define ALLGATHERV_INIT_ARGS                                           \
    ALLGATHERV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define ALLREDUCE_INIT_ARGS \
    ALLREDUCE_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define ALLTOALL_INIT_ARGS \
    ALLTOALL_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define ALLTOALLV_INIT_ARGS \
    ALLTOALLV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define ALLTOALLW_INIT_ARGS \
    ALLTOALLW_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define BARRIER_INIT_ARGS \
    BARRIER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define BCAST_INIT_ARGS \
    BCAST_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define EXSCAN_INIT_ARGS \
    EXSCAN_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define GATHER_INIT_ARGS \
    GATHER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define GATHERV_INIT_ARGS \
    GATHERV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define REDUCE_INIT_ARGS \
    REDUCE_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define REDUCESCATTER_INIT_ARGS                                           \
    REDUCESCATTER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define REDUCESCATTERBLOCK_INIT_ARGS                                           \
    REDUCESCATTERBLOCK_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define SCAN_INIT_ARGS \
    SCAN_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define SCATTER_INIT_ARGS \
    SCATTER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define SCATTERV_INIT_ARGS \
    SCATTERV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, mca_coll_base_module_t *module
#define NEIGHBOR_ALLGATHER_INIT_ARGS                                           \
    NEIGHBOR_ALLGATHER_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define NEIGHBOR_ALLGATHERV_INIT_ARGS                                           \
    NEIGHBOR_ALLGATHERV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define NEIGHBOR_ALLTOALL_INIT_ARGS                                           \
    NEIGHBOR_ALLTOALL_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define NEIGHBOR_ALLTOALLV_INIT_ARGS                                           \
    NEIGHBOR_ALLTOALLV_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module
#define NEIGHBOR_ALLTOALLW_INIT_ARGS                                           \
    NEIGHBOR_ALLTOALLW_BASE_ARGS, ompi_info_t *info, ompi_request_t **request, \
        mca_coll_base_module_t *module

#define ALLGATHER_BASE_ARG_NAMES sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm
#define ALLGATHERV_BASE_ARG_NAMES \
...
#define SCATTER_BASE_ARG_NAMES \
    sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm
#define SCATTERV_BASE_ARG_NAMES \
    sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm
#define NEIGHBOR_ALLGATHER_BASE_ARG_NAMES \
    sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm
#define NEIGHBOR_ALLGATHERV_BASE_ARG_NAMES \
    sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm
#define NEIGHBOR_ALLTOALL_BASE_ARG_NAMES \
    sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm
#define NEIGHBOR_ALLTOALLV_BASE_ARG_NAMES \
    sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm
#define NEIGHBOR_ALLTOALLW_BASE_ARG_NAMES \
    sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm
...
int mca_coll_base_alltoall_intra_basic_inplace(
    const void *rbuf, int rcount, struct ompi_datatype_t *rdtype, struct ompi_communicator_t *comm,
...
int mca_coll_base_alltoallv_intra_basic_inplace(
    const void *rbuf, const int *rcounts, const int *rdisps, struct ompi_datatype_t *rdtype,
    struct ompi_communicator_t *comm,
    mca_coll_base_module_t *module); /* special version for INPLACE */
...
/* Bcast */
int ompi_coll_base_bcast_intra_generic(BCAST_ARGS, uint32_t count_by_segment,
...
/* Reduce */
int ompi_coll_base_reduce_generic(REDUCE_ARGS, ompi_coll_tree_t *tree, int count_by_segment,
                                  int max_outstanding_reqs);
int ompi_coll_base_reduce_intra_basic_linear(REDUCE_ARGS);
int ompi_coll_base_reduce_intra_chain(REDUCE_ARGS, uint32_t segsize, int fanout,
                                      int max_outstanding_reqs);
...
int ompi_coll_base_reduce_intra_in_order_binary(REDUCE_ARGS, uint32_t segsize,
                                                int max_outstanding_reqs);
...
#define COLL_BASE_UPDATE_IN_ORDER_BMTREE(OMPI_COMM, BASE_MODULE, ROOT)                          \
    do {                                                                                        \
        ...
        if (!((coll_comm->cached_in_order_bmtree)                                               \
            ...
            coll_comm->cached_in_order_bmtree                                                   \
                = ompi_coll_base_topo_build_in_order_bmtree((OMPI_COMM), (ROOT));               \
            coll_comm->cached_in_order_bmtree_root = (ROOT);                                    \
        }                                                                                       \
    } while (0)
...
#define COLL_BASE_UPDATE_KMTREE(OMPI_COMM, BASE_MODULE, ROOT, RADIX)                         \
    do {                                                                                     \
        mca_coll_base_comm_t *coll_comm = (BASE_MODULE)->base_data;                          \
        if (!((coll_comm->cached_kmtree) && (coll_comm->cached_kmtree_root == (ROOT))        \
            ...
            coll_comm->cached_kmtree = ompi_coll_base_topo_build_kmtree((OMPI_COMM), (ROOT), \
                                                                        (RADIX));            \
...
#define COLL_BASE_UPDATE_CHAIN(OMPI_COMM, BASE_MODULE, ROOT, FANOUT)                         \
    do {                                                                                     \
        ...
        if (!((coll_comm->cached_chain) && (coll_comm->cached_chain_root == (ROOT))          \
            ...
            coll_comm->cached_chain = ompi_coll_base_topo_build_chain((FANOUT), (OMPI_COMM), \
                                                                      (ROOT));               \
...
#define COLL_BASE_UPDATE_IN_ORDER_BINTREE(OMPI_COMM, BASE_MODULE)                            \
    do {                                                                                     \
        ...
        if (!(coll_comm->cached_in_order_bintree)) {                                         \
            ...
            coll_comm->cached_in_order_bintree = ompi_coll_base_topo_build_in_order_bintree( \
                (OMPI_COMM));                                                                \
        }                                                                                    \
    } while (0)
 ...
 */
#define COLL_BASE_COMPUTE_BLOCKCOUNT(COUNT, NUM_BLOCKS, SPLIT_INDEX, EARLY_BLOCK_COUNT, \
                                     LATE_BLOCK_COUNT)                                  \
