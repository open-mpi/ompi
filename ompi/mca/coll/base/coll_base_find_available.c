...
int mca_coll_base_find_available(bool enable_progress_threads, bool enable_mpi_threads)
{
    ...
    OPAL_LIST_FOREACH_SAFE (cli, next, &ompi_coll_base_framework.framework_components,
        ...
        if (OMPI_SUCCESS != init_query(component, enable_progress_threads, enable_mpi_threads)) {
    ...
    if (opal_list_get_size(&ompi_coll_base_framework.framework_components) == 0) {
        ...
        opal_show_help("help-mca-base.txt", "find-available:not-valid", true, "coll");
        return OMPI_ERROR;
    }
 ...
 */
static inline int init_query_2_4_0(const mca_base_component_t *component,
                                   bool enable_progress_threads, bool enable_mpi_threads)
{
    mca_coll_base_component_2_4_0_t *coll = (mca_coll_base_component_2_4_0_t *) component;

    return coll->collm_init_query(enable_progress_threads, enable_mpi_threads);
}
/*
                      ...
                      bool enable_mpi_threads)
{
    ...
    if (2 == component->mca_type_major_version && 4 == component->mca_type_minor_version
        ...
        ret = init_query_2_4_0(component, enable_progress_threads, enable_mpi_threads);
    } else {
    ...
    opal_output_verbose(10, ompi_coll_base_framework.framework_output,
                        ...
                        component->mca_component_name, (OMPI_SUCCESS == ret) ? "" : "not ");
