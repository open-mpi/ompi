...
OBJ_CLASS_INSTANCE(adapt_topology_cache_item_t, opal_list_item_t, NULL, &destruct_topology_cache);

static ompi_coll_tree_t *create_topology(ompi_coll_adapt_algorithm_t algorithm, int root,
...
ompi_coll_tree_t *adapt_module_cached_topology(mca_coll_base_module_t *module,
                                               struct ompi_communicator_t *comm, int root,
