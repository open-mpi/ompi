...
OMPI_MODULE_DECLSPEC extern const mca_coll_base_component_2_4_0_t mca_coll_ftagree_component;
...
mca_coll_base_module_t *mca_coll_ftagree_comm_query(struct ompi_communicator_t *comm,
                                                    int *priority);
 ...
 * Utility functions
 */
static inline void mca_coll_ftagree_free_reqs(ompi_request_t **reqs, int count)
{
    int i;
    for (i = 0; i < count; ++i) {
