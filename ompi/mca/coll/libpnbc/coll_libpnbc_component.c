                  ...
                  int *priority)
{
    ...
    *priority = libpnbc_priority;
    ...
    if (OMPI_COMM_IS_INTER(comm)) {
        module->super.coll_iallgather = ompi_coll_libpnbc_iallgather_inter;
        module->super.coll_iallgatherv = ompi_coll_libpnbc_iallgatherv_inter;
        module->super.coll_iallreduce = ompi_coll_libpnbc_iallreduce_inter;
        module->super.coll_ialltoall = ompi_coll_libpnbc_ialltoall_inter;
        module->super.coll_ialltoallv = ompi_coll_libpnbc_ialltoallv_inter;
        module->super.coll_ialltoallw = ompi_coll_libpnbc_ialltoallw_inter;
        module->super.coll_ibarrier = ompi_coll_libpnbc_ibarrier_inter;
        module->super.coll_ibcast = ompi_coll_libpnbc_ibcast_inter;
        module->super.coll_iexscan = NULL;
        module->super.coll_igather = ompi_coll_libpnbc_igather_inter;
        module->super.coll_igatherv = ompi_coll_libpnbc_igatherv_inter;
        module->super.coll_ireduce = ompi_coll_libpnbc_ireduce_inter;
        module->super.coll_ireduce_scatter = ompi_coll_libpnbc_ireduce_scatter_inter;
        module->super.coll_ireduce_scatter_block = ompi_coll_libpnbc_ireduce_scatter_block_inter;
        module->super.coll_iscan = NULL;
        module->super.coll_iscatter = ompi_coll_libpnbc_iscatter_inter;
        module->super.coll_iscatterv = ompi_coll_libpnbc_iscatterv_inter;
    } else {
        module->super.coll_iallgather = ompi_coll_libpnbc_iallgather;
        module->super.coll_iallgatherv = ompi_coll_libpnbc_iallgatherv;
        module->super.coll_iallreduce = ompi_coll_libpnbc_iallreduce;
        module->super.coll_ialltoall = ompi_coll_libpnbc_ialltoall;
        module->super.coll_ialltoallv = ompi_coll_libpnbc_ialltoallv;
        module->super.coll_ialltoallw = ompi_coll_libpnbc_ialltoallw;
        module->super.coll_ibarrier = ompi_coll_libpnbc_ibarrier;
        module->super.coll_ibcast = ompi_coll_libpnbc_ibcast;
        module->super.coll_iexscan = ompi_coll_libpnbc_iexscan;
        module->super.coll_igather = ompi_coll_libpnbc_igather;
        module->super.coll_igatherv = ompi_coll_libpnbc_igatherv;
        module->super.coll_ireduce = ompi_coll_libpnbc_ireduce;
        module->super.coll_ireduce_scatter = ompi_coll_libpnbc_ireduce_scatter;
        module->super.coll_ireduce_scatter_block = ompi_coll_libpnbc_ireduce_scatter_block;
        module->super.coll_iscan = ompi_coll_libpnbc_iscan;
        module->super.coll_iscatter = ompi_coll_libpnbc_iscatter;
        module->super.coll_iscatterv = ompi_coll_libpnbc_iscatterv;

        module->super.coll_ineighbor_allgather = ompi_coll_libpnbc_ineighbor_allgather;
        module->super.coll_ineighbor_allgatherv = ompi_coll_libpnbc_ineighbor_allgatherv;
        module->super.coll_ineighbor_alltoall = ompi_coll_libpnbc_ineighbor_alltoall;
        module->super.coll_ineighbor_alltoallv = ompi_coll_libpnbc_ineighbor_alltoallv;
        module->super.coll_ineighbor_alltoallw = ompi_coll_libpnbc_ineighbor_alltoallw;
    }
...
{
    ompi_coll_libpnbc_request_t *request =
        (ompi_coll_libpnbc_request_t*) *ompi_req;
