...
/* select a component */
OMPI_DECLSPEC int mca_vprotocol_base_select(bool enable_progress_threads, bool enable_mpi_threads);
 ...
 */
#define MCA_VPROTOCOL_BASE_VERSION_2_0_0 OMPI_MCA_BASE_VERSION_2_1_0("vprotocol", 2, 0, 0)
