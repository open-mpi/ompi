...
int mca_vprotocol_example_probe(int src, int tag, struct ompi_communicator_t *comm,
...
int mca_vprotocol_example_iprobe(int src, int tag, struct ompi_communicator_t *comm, int *matched,
                                 ompi_status_public_t *status)
{
