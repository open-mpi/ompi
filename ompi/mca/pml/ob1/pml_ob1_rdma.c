...
size_t mca_pml_ob1_rdma_btls(mca_bml_base_endpoint_t *bml_endpoint, unsigned char *base,
                             size_t size, mca_pml_ob1_com_btl_t *rdma_btls)
{
    ...
    for (int n = 0; n < num_btls && num_btls_used < mca_pml_ob1.max_rdma_per_request; n++) {
        ...
        for (int i = 0; i < num_eager_btls && ignore; ++i) {
            mca_bml_base_btl_t *eager_btl = mca_bml_base_btl_array_get_index(&bml_endpoint
                                                                                  ->btl_eager,
                                                                             i);
        ...
        if (btl->btl_register_mem) {
            ...
            reg_handle = btl->btl_register_mem(btl, bml_btl->btl_endpoint, base, size,
...
size_t mca_pml_ob1_rdma_pipeline_btls(mca_bml_base_endpoint_t *bml_endpoint, size_t size,
