...
int mca_pml_ob1_iprobe(int src, int tag, struct ompi_communicator_t *comm, int *matched,
...
int mca_pml_ob1_probe(int src, int tag, struct ompi_communicator_t *comm,
                      ompi_status_public_t *status)
{
    int rc = OMPI_SUCCESS;
    mca_pml_ob1_recv_request_t recvreq;
...
int mca_pml_ob1_improbe(int src, int tag, struct ompi_communicator_t *comm, int *matched,
...
int mca_pml_ob1_mprobe(int src, int tag, struct ompi_communicator_t *comm,
                       struct ompi_message_t **message, ompi_status_public_t *status)
{
    int rc = OMPI_SUCCESS;
    mca_pml_ob1_recv_request_t *recvreq;
