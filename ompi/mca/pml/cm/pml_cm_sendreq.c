 ...
 */
static int mca_pml_cm_send_request_free(struct ompi_request_t **request)
{
...
void mca_pml_cm_send_request_completion(struct mca_mtl_request_t *mtl_request)
{
    mca_pml_cm_send_request_t *base_request = (mca_pml_cm_send_request_t *) mtl_request->ompi_req;
    if (MCA_PML_CM_REQUEST_SEND_THIN == base_request->req_base.req_pml_type) {
        MCA_PML_CM_THIN_SEND_REQUEST_PML_COMPLETE(
...
OBJ_CLASS_INSTANCE(mca_pml_cm_send_request_t, mca_pml_cm_request_t, NULL, NULL);

OBJ_CLASS_INSTANCE(mca_pml_cm_thin_send_request_t, mca_pml_cm_send_request_t,
                   mca_pml_cm_send_request_construct, NULL);

OBJ_CLASS_INSTANCE(mca_pml_cm_hvy_send_request_t, mca_pml_cm_send_request_t,
                   mca_pml_cm_send_request_construct, NULL);
