...
static int mca_pml_cm_recv_request_free(struct ompi_request_t **request)
{
...
{
    mca_pml_cm_request_t *base_request = (mca_pml_cm_request_t *) mtl_request->ompi_req;
    if (MCA_PML_CM_REQUEST_RECV_THIN == base_request->req_pml_type) {
        MCA_PML_CM_THIN_RECV_REQUEST_PML_COMPLETE(
...
static void mca_pml_cm_recv_request_construct(mca_pml_cm_thin_recv_request_t *recvreq)
{
...
OBJ_CLASS_INSTANCE(mca_pml_cm_thin_recv_request_t, mca_pml_cm_request_t,
                   mca_pml_cm_recv_request_construct, NULL);

OBJ_CLASS_INSTANCE(mca_pml_cm_hvy_recv_request_t, mca_pml_cm_request_t,
                   mca_pml_cm_recv_request_construct, NULL);
