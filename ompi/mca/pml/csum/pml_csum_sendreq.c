...
static inline void
mca_pml_csum_match_fast_completion_free( struct mca_btl_base_module_t* btl,  
                                        ...
                                        struct mca_btl_base_descriptor_t* des )
{
     ...
     */
    MCA_PML_CSUM_SEND_REQUEST_MPI_COMPLETE(sendreq, false);
                                         ...
                                         size_t size )
{
    ...
    OPAL_OUTPUT_VERBOSE((1, mca_pml_base_output,
                         ...
                         ORTE_NAME_PRINT(ORTE_PROC_MY_NAME), hdr->hdr_match.hdr_csum, hdr->hdr_common.hdr_csum, (unsigned long)max_data));
