 ...
 */
opal_mutex_t mca_io_romio332_mutex = {{0}};


/*
 * Public string showing this component's version number
 */
const char *mca_io_romio332_component_version_string =
"OMPI/MPI ROMIO io MCA component version " OMPI_VERSION ", " ROMIO_VERSION_STRING;


mca_io_base_component_2_0_0_t mca_io_romio332_component = {
    /* First, the mca_base_component_t struct containing meta information
       about the component itself */

    .io_version = {
        MCA_IO_BASE_VERSION_2_0_0,
        .mca_component_name = "romio332",
...
static char *ompi_io_romio332_version = ROMIO_VERSION_STRING;
static char *ompi_io_romio332_user_configure_params = MCA_io_romio332_USER_CONFIGURE_FLAGS;
static char *ompi_io_romio332_complete_configure_params = MCA_io_romio332_COMPLETE_CONFIGURE_FLAGS;

static int register_component(void)
{
    /* Use a low priority, but allow other components to be lower */
    priority_param = 10;
    (void) mca_base_component_var_register(&mca_io_romio332_component.io_version,
    ...
    (void) mca_base_component_var_register(&mca_io_romio332_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio332_version);
    (void) mca_base_component_var_register(&mca_io_romio332_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio332_user_configure_params);
    (void) mca_base_component_var_register(&mca_io_romio332_component.io_version,
                                           ...
                                           MCA_BASE_VAR_FLAG_DEFAULT_ONLY,
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio332_complete_configure_params);
...
{
    /* Create the mutex */
    OBJ_CONSTRUCT(&mca_io_romio332_mutex, opal_mutex_t);
...
static int close_component(void)
{
    OBJ_DESTRUCT(&mca_io_romio332_mutex);
           ...
           int *priority)
{
    ...
    *priority = priority_param;
    ...
    data = malloc(sizeof(mca_io_romio332_data_t));
    if (NULL == data) {
        return NULL;
    }
    data->romio_fh = NULL;
