 ...
 */
int MPIR_Status_set_bytes(ompi_status_public_t *status, struct ompi_datatype_t *datatype,
                          MPI_Count size);
...
mca_io_base_module_2_0_0_t mca_io_romio321_module = {
    ...
    mca_io_romio321_file_open, mca_io_romio321_file_close,

    mca_io_romio321_file_set_size, mca_io_romio321_file_preallocate, mca_io_romio321_file_get_size,
    mca_io_romio321_file_get_amode, mca_io_romio321_file_set_info, mca_io_romio321_file_get_info,
    mca_io_romio321_file_set_view, mca_io_romio321_file_get_view,

    /* Index IO operations */
    mca_io_romio321_file_read_at, mca_io_romio321_file_read_at_all, mca_io_romio321_file_write_at,
    mca_io_romio321_file_write_at_all, mca_io_romio321_file_iread_at,
    mca_io_romio321_file_iwrite_at, mca_io_romio321_file_iread_at_all,
    mca_io_romio321_file_iwrite_at_all,

    /* non-indexed IO operations */
    mca_io_romio321_file_read, mca_io_romio321_file_read_all, mca_io_romio321_file_write,
    mca_io_romio321_file_write_all, mca_io_romio321_file_iread, mca_io_romio321_file_iwrite,
    mca_io_romio321_file_iread_all, mca_io_romio321_file_iwrite_all,

    mca_io_romio321_file_seek, mca_io_romio321_file_get_position,
    mca_io_romio321_file_get_byte_offset,

    mca_io_romio321_file_read_shared, mca_io_romio321_file_write_shared,
    mca_io_romio321_file_iread_shared, mca_io_romio321_file_iwrite_shared,
    mca_io_romio321_file_read_ordered, mca_io_romio321_file_write_ordered,
    mca_io_romio321_file_seek_shared, mca_io_romio321_file_get_position_shared,
    ...
    mca_io_romio321_file_write_all_begin, mca_io_romio321_file_write_all_end,
    mca_io_romio321_file_read_ordered_begin, mca_io_romio321_file_read_ordered_end,
    mca_io_romio321_file_write_ordered_begin, mca_io_romio321_file_write_ordered_end,

    mca_io_romio321_file_get_type_extent,

    /* Sync/atomic IO operations */
    mca_io_romio321_file_set_atomicity, mca_io_romio321_file_get_atomicity,
