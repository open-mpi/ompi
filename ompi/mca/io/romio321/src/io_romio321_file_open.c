...
int mca_io_romio321_file_open(ompi_communicator_t *comm, const char *filename, int amode,
                              opal_info_t *info, ompi_file_t *fh)
{
    int ret;
    ...
    ret = ROMIO_PREFIX(MPI_File_open)(comm, filename, amode, ompi_info, &data->romio_fh);
...
int mca_io_romio321_file_close(ompi_file_t *fh)
{
    int ret;
    mca_io_romio321_data_t *data;
    int finalized;
...
int mca_io_romio321_file_set_size(ompi_file_t *fh, MPI_Offset size)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_preallocate(ompi_file_t *fh, MPI_Offset size)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_size(ompi_file_t *fh, MPI_Offset *size)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_amode(ompi_file_t *fh, int *amode)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_set_info(ompi_file_t *fh, ompi_info_t *info)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_info(ompi_file_t *fh, ompi_info_t **info_used)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_set_view(ompi_file_t *fh, MPI_Offset disp, struct ompi_datatype_t *etype,
                                  ...
                                  opal_info_t *info)
{
    ...
    data = (mca_io_romio321_data_t *) fh->f_io_selected_data;
    OPAL_THREAD_LOCK(&mca_io_romio321_mutex);
    ret = ROMIO_PREFIX(MPI_File_set_view)(data->romio_fh, disp, etype, filetype, datarep,
                                          ompi_info);
    OPAL_THREAD_UNLOCK(&mca_io_romio321_mutex);
...
int mca_io_romio321_file_get_view(ompi_file_t *fh, MPI_Offset *disp, struct ompi_datatype_t **etype,
                                  struct ompi_datatype_t **filetype, char *datarep)
{
    ...
    data = (mca_io_romio321_data_t *) fh->f_io_selected_data;
    OPAL_THREAD_LOCK(&mca_io_romio321_mutex);
    ret = ROMIO_PREFIX(MPI_File_get_view)(data->romio_fh, disp, etype, filetype, datarep);
    OPAL_THREAD_UNLOCK(&mca_io_romio321_mutex);

    return ret;
}

int mca_io_romio321_file_get_type_extent(ompi_file_t *fh, struct ompi_datatype_t *datatype,
                                         MPI_Aint *extent)
{
    int ret;
    mca_io_romio321_data_t *data;
    ...
    data = (mca_io_romio321_data_t *) fh->f_io_selected_data;
    OPAL_THREAD_LOCK(&mca_io_romio321_mutex);
    ret = ROMIO_PREFIX(MPI_File_get_type_extent)(data->romio_fh, datatype, extent);
    OPAL_THREAD_UNLOCK(&mca_io_romio321_mutex);

    return ret;
}

int mca_io_romio321_file_set_atomicity(ompi_file_t *fh, int flag)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_atomicity(ompi_file_t *fh, int *flag)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_sync(ompi_file_t *fh)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_seek_shared(ompi_file_t *fh, MPI_Offset offset, int whence)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_position_shared(ompi_file_t *fh, MPI_Offset *offset)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_seek(ompi_file_t *fh, MPI_Offset offset, int whence)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_position(ompi_file_t *fh, MPI_Offset *offset)
{
    int ret;
    mca_io_romio321_data_t *data;
...
int mca_io_romio321_file_get_byte_offset(ompi_file_t *fh, MPI_Offset offset, MPI_Offset *disp)
{
    int ret;
    mca_io_romio321_data_t *data;
