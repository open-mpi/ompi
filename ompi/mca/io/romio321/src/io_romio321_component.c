...
static int register_component(void)
{
    ...
    priority_param = 10;
    (void) mca_base_component_var_register(&mca_io_romio321_component.io_version, "priority",
                                           "Priority of the io romio component",
                                           MCA_BASE_VAR_TYPE_INT, NULL, 0, 0, OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &priority_param);
    delete_priority_param = 10;
    (void) mca_base_component_var_register(&mca_io_romio321_component.io_version, "delete_priority",
                                           "Delete priority of the io romio component",
                                           MCA_BASE_VAR_TYPE_INT, NULL, 0, 0, OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &delete_priority_param);
    (void) mca_base_component_var_register(&mca_io_romio321_component.io_version, "version",
    ...
    (void) mca_base_component_var_register(
        &mca_io_romio321_component.io_version, "user_configure_params",
    ...
    (void) mca_base_component_var_register(
        &mca_io_romio321_component.io_version, "complete_configure_params",
