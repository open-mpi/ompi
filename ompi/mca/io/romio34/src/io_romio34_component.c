...
#define ROMIO_VERSION_STRING "from MPICH v3.4"
...
static char *ompi_io_romio34_version = ROMIO_VERSION_STRING;
static char *ompi_io_romio34_user_configure_params = MCA_io_romio34_USER_CONFIGURE_FLAGS;
static char *ompi_io_romio34_complete_configure_params = MCA_io_romio34_COMPLETE_CONFIGURE_FLAGS;

static int register_component(void)
{
    /* Use a low priority, but allow other components to be lower */
    priority_param = 10;
    (void) mca_base_component_var_register(&mca_io_romio34_component.io_version,
    ...
    (void) mca_base_component_var_register(&mca_io_romio34_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio34_version);
    (void) mca_base_component_var_register(&mca_io_romio34_component.io_version,
                                           ...
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio34_user_configure_params);
    (void) mca_base_component_var_register(&mca_io_romio34_component.io_version,
                                           ...
                                           MCA_BASE_VAR_FLAG_DEFAULT_ONLY,
                                           OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &ompi_io_romio34_complete_configure_params);
...
{
    /* Create the mutex */
    OBJ_CONSTRUCT(&mca_io_romio34_mutex, opal_mutex_t);
...
static int close_component(void)
{
    OBJ_DESTRUCT(&mca_io_romio34_mutex);
           ...
           int *priority)
{
    ...
    *priority = priority_param;
    ...
    data = malloc(sizeof(mca_io_romio34_data_t));
    if (NULL == data) {
        return NULL;
    }
    data->romio_fh = NULL;
