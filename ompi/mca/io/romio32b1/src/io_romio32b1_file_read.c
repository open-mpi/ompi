...
int
mca_io_romio32b1_file_read_at (ompi_file_t *fh,
                           MPI_Offset offset,
                           void *buf,
                           int count,
...
{
    int         ret;
    mca_io_romio32b1_data_t *data;

    data = (mca_io_romio32b1_data_t *) fh->f_io_selected_data;
    OPAL_THREAD_LOCK (&mca_io_romio32b1_mutex);
    ret =
        ROMIO_PREFIX(MPI_File_read_at) (data->romio_fh, offset, buf, count,
                                       datatype, status);
    OPAL_THREAD_UNLOCK (&mca_io_romio32b1_mutex);
...
int
mca_io_romio32b1_file_read_at_all (ompi_file_t *fh,
                               MPI_Offset offset,
                               void *buf,
                               int count,
                               struct ompi_datatype_t *datatype,
...
int
mca_io_romio32b1_file_iread_at (ompi_file_t *fh,
                            MPI_Offset offset,
                            void *buf,
                            int count,
                            struct ompi_datatype_t *datatype,
...
int
mca_io_romio32b1_file_iread_at_all (ompi_file_t *fh,
                                   MPI_Offset offset,
                                   void *buf,
                                   int count,
                                   struct ompi_datatype_t *datatype,
...
int
mca_io_romio32b1_file_read (ompi_file_t *fh,
                        void *buf,
                        int count,
                        struct ompi_datatype_t *datatype,
                        ompi_status_public_t * status)
...
int
mca_io_romio32b1_file_read_all (ompi_file_t *fh,
                            void *buf,
                            int count,
                            struct ompi_datatype_t *datatype,
                            ompi_status_public_t * status)
...
int
mca_io_romio32b1_file_iread (ompi_file_t *fh,
                         void *buf,
                         int count,
                         struct ompi_datatype_t *datatype,
                         ompi_request_t **request)
...
int
mca_io_romio32b1_file_iread_all (ompi_file_t *fh,
                                void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
                                ompi_request_t **request)
...
int
mca_io_romio32b1_file_read_shared (ompi_file_t *fh,
                               void *buf,
                               int count,
                               struct ompi_datatype_t *datatype,
                               ompi_status_public_t * status)
...
int
mca_io_romio32b1_file_iread_shared (ompi_file_t *fh,
                                void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
                                ompi_request_t **request)
...
int
mca_io_romio32b1_file_read_ordered (ompi_file_t *fh,
                                void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
                                ompi_status_public_t * status)
...
int
mca_io_romio32b1_file_read_at_all_begin (ompi_file_t *fh,
                                     MPI_Offset offset,
                                     void *buf,
                                     int count,
                                     struct ompi_datatype_t *datatype)
...
int
mca_io_romio32b1_file_read_at_all_end (ompi_file_t *fh,
                                   void *buf,
                                   ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio32b1_file_read_all_begin (ompi_file_t *fh,
                                  void *buf,
                                  int count,
                                  struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio32b1_file_read_all_end (ompi_file_t *fh,
                                void *buf,
                                ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio32b1_file_read_ordered_begin (ompi_file_t *fh,
                                      void *buf,
                                      int count,
                                      struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio32b1_file_read_ordered_end (ompi_file_t *fh,
                                    void *buf,
                                    ompi_status_public_t * status)
{
    int         ret;
