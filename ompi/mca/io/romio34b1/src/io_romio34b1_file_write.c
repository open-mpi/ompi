...
int
mca_io_romio34b1_file_write_at (ompi_file_t *fh,
                            MPI_Offset offset,
                            const void *buf,
                            int count,
...
{
    int         ret;
    mca_io_romio34b1_data_t *data;

    data = (mca_io_romio34b1_data_t *) fh->f_io_selected_data;
    OPAL_THREAD_LOCK (&mca_io_romio34b1_mutex);
    ret =
        ROMIO_PREFIX(MPI_File_write_at) (data->romio_fh, offset, buf, count,
                                        datatype, status);
    OPAL_THREAD_UNLOCK (&mca_io_romio34b1_mutex);
...
int
mca_io_romio34b1_file_write_at_all (ompi_file_t *fh,
                                MPI_Offset offset,
                                const void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
...
int
mca_io_romio34b1_file_iwrite_at (ompi_file_t *fh,
                             MPI_Offset offset,
                             const void *buf,
                             int count,
                             struct ompi_datatype_t *datatype,
...
int
mca_io_romio34b1_file_iwrite_at_all (ompi_file_t *fh,
                                    MPI_Offset offset,
                                    const void *buf,
                                    int count,
                                    struct ompi_datatype_t *datatype,
...
int
mca_io_romio34b1_file_write (ompi_file_t *fh,
                         const void *buf,
                         int count,
                         struct ompi_datatype_t *datatype,
                         ompi_status_public_t * status)
...
int
mca_io_romio34b1_file_write_all (ompi_file_t *fh,
                             const void *buf,
                             int count,
                             struct ompi_datatype_t *datatype,
                             ompi_status_public_t * status)
...
int
mca_io_romio34b1_file_iwrite (ompi_file_t *fh,
                          const void *buf,
                          int count,
                          struct ompi_datatype_t *datatype,
                          ompi_request_t **request)
...
int
mca_io_romio34b1_file_iwrite_all (ompi_file_t *fh,
                                const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_request_t **request)
...
int
mca_io_romio34b1_file_write_shared (ompi_file_t *fh,
                                const void *buf,
                                int count,
                                struct ompi_datatype_t *datatype,
                                ompi_status_public_t * status)
...
int
mca_io_romio34b1_file_iwrite_shared (ompi_file_t *fh,
                                 const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_request_t **request)
...
int
mca_io_romio34b1_file_write_ordered (ompi_file_t *fh,
                                 const void *buf,
                                 int count,
                                 struct ompi_datatype_t *datatype,
                                 ompi_status_public_t * status)
...
int
mca_io_romio34b1_file_write_at_all_begin (ompi_file_t *fh,
                                      MPI_Offset offset,
                                      const void *buf,
                                      int count,
                                      struct ompi_datatype_t *datatype)
...
int
mca_io_romio34b1_file_write_at_all_end (ompi_file_t *fh,
                                    const void *buf,
                                    ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio34b1_file_write_all_begin (ompi_file_t *fh,
                                   const void *buf,
                                   int count,
                                   struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio34b1_file_write_all_end (ompi_file_t *fh,
                                 const void *buf,
                                 ompi_status_public_t * status)
{
    int         ret;
...
int
mca_io_romio34b1_file_write_ordered_begin (ompi_file_t *fh,
                                       const void *buf,
                                       int count,
                                       struct ompi_datatype_t *datatype)
{
...
int
mca_io_romio34b1_file_write_ordered_end (ompi_file_t *fh,
                                     const void *buf,
                                     ompi_status_public_t * status)
{
    int         ret;
