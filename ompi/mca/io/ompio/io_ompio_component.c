...
{
    priority_param = 30;
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "priority",
                                           "Priority of the io ompio component",
                                           MCA_BASE_VAR_TYPE_INT, NULL, 0, 0, OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_READONLY, &priority_param);
    delete_priority_param = 30;
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "delete_priority",
    ...
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "coll_timing_info",
    ...
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "cycle_buffer_size",
    ...
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "bytes_per_agg",
    ...
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "num_aggregators",
    ...
    (void) mca_base_component_var_register(
        &mca_io_ompio_component.io_version, "grouping_option",
    ...
    (void) mca_base_component_var_register(
        &mca_io_ompio_component.io_version, "max_aggregators_ratio",
    ...
    (void) mca_base_component_var_register(
        &mca_io_ompio_component.io_version, "aggregators_cutoff_threshold",
    ...
    (void) mca_base_component_var_register(&mca_io_ompio_component.io_version, "overwrite_amode",
