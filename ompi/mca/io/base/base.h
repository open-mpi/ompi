 ...
 */
OMPI_DECLSPEC int mca_io_base_delete(const char *filename, struct opal_info_t *info);

OMPI_DECLSPEC int mca_io_base_register_datarep(const char *, MPI_Datarep_conversion_function *,
