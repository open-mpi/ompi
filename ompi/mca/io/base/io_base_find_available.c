...
static int init_query_2_0_0(const mca_base_component_t *ls, bool enable_progress_threads,
                            bool enable_mpi_threads);
 ...
 */
int mca_io_base_find_available(bool enable_progress_threads, bool enable_mpi_threads)
{
    ...
    OPAL_LIST_FOREACH_SAFE (cli, next, &ompi_io_base_framework.framework_components,
                      ...
                      bool enable_mpi_threads)
{
    ...
    opal_output_verbose(10, ompi_io_base_framework.framework_output,
                        "io:find_available: querying io component %s", m->mca_component_name);
...
static int init_query_2_0_0(const mca_base_component_t *component, bool enable_progress_threads,
                            bool enable_mpi_threads)
{
    mca_io_base_component_2_0_0_t *io = (mca_io_base_component_2_0_0_t *) component;

    return io->io_init_query(enable_progress_threads, enable_mpi_threads);
}
