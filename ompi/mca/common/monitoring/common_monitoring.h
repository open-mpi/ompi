...
#    define OPAL_MONITORING_PRINT_ERR(...) OPAL_MONITORING_VERBOSE(0, __VA_ARGS__)
#else /* if( ! OPAL_ENABLE_DEBUG ) */
#    define OPAL_MONITORING_PRINT_ERR(...) OPAL_MONITORING_VERBOSE(1, __VA_ARGS__)
#endif /* OPAL_ENABLE_DEBUG */

#define OPAL_MONITORING_PRINT_WARN(...) OPAL_MONITORING_VERBOSE(5, __VA_ARGS__)

#define OPAL_MONITORING_PRINT_INFO(...) OPAL_MONITORING_VERBOSE(10, __VA_ARGS__)
                                                       ...
                                                       int *world_rank)
{
     ...
     */
    int ret = opal_hash_table_get_value_uint64(common_monitoring_translation_ht, key,
                                               (void *) &rank);
