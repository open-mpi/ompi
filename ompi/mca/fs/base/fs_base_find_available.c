...
int mca_fs_base_find_available(bool enable_progress_threads, bool enable_mpi_threads)
{
    ...
    OPAL_LIST_FOREACH_SAFE (cli, next, &ompi_fs_base_framework.framework_components,
                      ...
                      bool enable_mpi_threads)
{
    ...
    opal_output_verbose(10, ompi_fs_base_framework.framework_output,
                        "fs:find_available: querying fs component %s", m->mca_component_name);
...
static int init_query_2_0_0(const mca_base_component_t *component, bool enable_progress_threads,
                            bool enable_mpi_threads)
{
    mca_fs_base_component_2_0_0_t *fs = (mca_fs_base_component_2_0_0_t *) component;

    return fs->fsm_init_query(enable_progress_threads, enable_mpi_threads);
}
