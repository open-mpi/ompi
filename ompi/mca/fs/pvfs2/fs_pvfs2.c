...
static mca_fs_base_module_1_0_0_t pvfs2
    = {mca_fs_pvfs2_module_init,     /* initalise after being selected */
       ...
       mca_fs_pvfs2_file_open,       mca_fs_pvfs2_file_close,    mca_fs_pvfs2_file_delete,
       mca_fs_pvfs2_file_set_size,   mca_fs_pvfs2_file_get_size, mca_fs_pvfs2_file_sync};
/*
 * *******************************************************************
 * ************************* structure ends **************************
 * *******************************************************************
                                                                     ...
                                                                     int *priority)
{
    ...
    *priority = mca_fs_pvfs2_priority;
    ...
    if (!tmp) {
        ...
        if (!strncmp(fh->f_filename, "pvfs2:", 6) || !strncmp(fh->f_filename, "PVFS2:", 6)) {
            fh->f_fstype = PVFS2;
        }
    }
