 ...
 *
 * A NULL return is final: no BTL claimed the peer, or allocation
 * failed. A peer that has not published its connection info yet is
 * waited for here, since an RMA operation cannot come back later.
 */
