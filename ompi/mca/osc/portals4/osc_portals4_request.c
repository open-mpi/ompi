...
{
    ompi_osc_portals4_request_t *request = (ompi_osc_portals4_request_t *) *ompi_req;
...
static void request_construct(ompi_osc_portals4_request_t *request)
{
...
OBJ_CLASS_INSTANCE(ompi_osc_portals4_request_t, ompi_request_t, request_construct, NULL);
