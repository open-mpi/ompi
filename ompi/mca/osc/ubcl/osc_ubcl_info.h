...
int osc_ubcl_sync_disp_unit(mca_osc_ubcl_module_t *module, ptrdiff_t disp_unit, bool need_synchro);
ptrdiff_t osc_ubcl_get_disp_unit(mca_osc_ubcl_module_t *module, int target);
