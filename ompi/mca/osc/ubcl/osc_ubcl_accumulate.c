...
int ompi_osc_ubcl_accumulate(const void *origin_addr, size_t origin_count,
...
int ompi_osc_ubcl_raccumulate(const void *origin_addr, size_t origin_count,
                              struct ompi_datatype_t *origin_dt, int target, ptrdiff_t target_disp,
                              size_t target_count, struct ompi_datatype_t *target_dt,
                              struct ompi_op_t *op, struct ompi_win_t *win,
...
int ompi_osc_ubcl_get_accumulate(const void *origin_addr, size_t origin_count,
                                 struct ompi_datatype_t *origin_dt, void *result_addr,
                                 size_t result_count, struct ompi_datatype_t *result_dt,
                                   ...
                                   struct iovec **aligned_iovecs, size_t aligned_iovec_count)
{
    ...
    for (size_t seg = 0; seg < aligned_iovec_count; seg++) {
        ...
        /* Consume size */
        for (int i = 0; i < iovecs_to_align; i++) {
            aligned_iovecs[i][seg].iov_base = (char *) iovecs[i][segment[i]].iov_base
                                              + consumed_size[i];
...
static int segmented_rget_build_aligned_iovecs(
    const void *origin_addr, size_t origin_count, struct ompi_datatype_t *origin_dt, void *result_addr,
    size_t result_count, struct ompi_datatype_t *result_dt, int target_rank, ptrdiff_t target_disp,
    size_t target_count, struct ompi_datatype_t *target_dt, struct ompi_op_t *op, ompi_proc_t *proc,
...
static int segmented_rget_accumulate(const void *origin_addr, size_t origin_count,
                                     struct ompi_datatype_t *origin_dt, void *result_addr,
                                     size_t result_count, struct ompi_datatype_t *result_dt,
                                     int target_rank, ptrdiff_t target_disp, size_t target_count,
                                     struct ompi_datatype_t *target_dt, struct ompi_op_t *op,
...
int ompi_osc_ubcl_rget_accumulate(const void *origin_addr, size_t origin_count,
                                  struct ompi_datatype_t *origin_dt, void *result_addr,
                                  size_t result_count, struct ompi_datatype_t *result_dt,
                                  int target_rank, ptrdiff_t target_disp, size_t target_count,
                                  struct ompi_datatype_t *target_dt, struct ompi_op_t *op,
