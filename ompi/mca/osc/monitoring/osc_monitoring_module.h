 ...
 */
#define OSC_MONITORING_SET_TEMPLATE_FCT_NAME(template) ompi_osc_monitoring_##template##_set_template
...
#define MCA_OSC_MONITORING_MODULE_TEMPLATE_GENERATE(template)                                \
     ...
     */                                                                                      \
    static inline ompi_osc_base_module_t *OSC_MONITORING_SET_TEMPLATE_FCT_NAME(template)(    \
    ...
    {                                                                                        \
        ...
        if (1 == opal_atomic_add_fetch_32(&init_done, 1)) {                                  \
             ...
             * ompi_osc_monitoring_module_## template ##_template                            \
             */                                                                              \
            memcpy(&OMPI_OSC_MONITORING_MODULE_VARIABLE(template), module,                   \
                   sizeof(ompi_osc_base_module_t));                                          \
        }                                                                                    \
        /* Replace the original functions with our generated ones */                         \
        memcpy(module, &module_specific_interception_layer, sizeof(ompi_osc_base_module_t)); \
        return module;                                                                       \
    }
