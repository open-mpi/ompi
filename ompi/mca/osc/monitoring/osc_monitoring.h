...
extern int ompi_osc_monitoring_set_info (struct ompi_win_t *win, struct ompi_info_t *info);

extern int ompi_osc_monitoring_get_info (struct ompi_win_t *win, struct ompi_info_t **info_used);
