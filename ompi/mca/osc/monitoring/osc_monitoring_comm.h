...
#define OSC_MONITORING_GENERATE_TEMPLATE_COMM(template)                                            \
                                                                                                   \
    static int ompi_osc_monitoring_##template##_put(const void *origin_addr, int origin_count,     \
    ...
    {                                                                                              \
        ...
        return OMPI_OSC_MONITORING_MODULE_VARIABLE(template).osc_put(origin_addr, origin_count,    \
                                                                     origin_datatype, target_rank, \
                                                                     target_disp, target_count,    \
                                                                     target_datatype, win);        \
    }                                                                                              \
                                                                                                   \
    static int ompi_osc_monitoring_##template##_rput(const void *origin_addr, int origin_count,    \
                                                     ompi_datatype_t *origin_datatype,             \
                                                     int target_rank, ptrdiff_t target_disp,       \
                                                     int target_count,                             \
                                                     ompi_datatype_t *target_datatype,             \
    ...
    {                                                                                              \
        ...
        return OMPI_OSC_MONITORING_MODULE_VARIABLE(template).osc_rput(origin_addr, origin_count,   \
                                                                      origin_datatype,             \
    ...
    static int ompi_osc_monitoring_##template##_get(void *origin_addr, int origin_count,           \
                                                    ompi_datatype_t *origin_datatype,              \
                                                    int source_rank, ptrdiff_t source_disp,        \
                                                    int source_count,                              \
    ...
    {                                                                                              \
         ...
         */                                                                                        \
        if (OPAL_SUCCESS                                                                           \
            == mca_common_monitoring_get_world_rank(source_rank, win->w_group, &world_rank)) {     \
            size_t type_size, data_size;                                                           \
            ompi_datatype_type_size(origin_datatype, &type_size);                                  \
            data_size = origin_count * type_size;                                                  \
        ...
        return OMPI_OSC_MONITORING_MODULE_VARIABLE(template).osc_get(origin_addr, origin_count,    \
                                                                     origin_datatype, source_rank, \
    ...
    {                                                                                              \
        ...
        return OMPI_OSC_MONITORING_MODULE_VARIABLE(template).osc_rget(origin_addr, origin_count,   \
                                                                      origin_datatype,             \
                                                                      source_rank, source_disp,    \
                                                                      source_count,                \
                                                                      source_datatype, win,        \
                                                                      request);                    \
    }
