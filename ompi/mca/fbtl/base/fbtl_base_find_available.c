...
int mca_fbtl_base_find_available(bool enable_progress_threads, bool enable_mpi_threads)
{
    ...
    OPAL_LIST_FOREACH_SAFE (cli, next, &ompi_fbtl_base_framework.framework_components,
                      ...
                      bool enable_mpi_threads)
{
    ...
    opal_output_verbose(10, ompi_fbtl_base_framework.framework_output,
                        "fbtl:find_available: querying fbtl component %s", m->mca_component_name);
...
static int init_query_2_0_0(const mca_base_component_t *component, bool enable_progress_threads,
                            bool enable_mpi_threads)
{
    mca_fbtl_base_component_2_0_0_t *fbtl = (mca_fbtl_base_component_2_0_0_t *) component;

    return fbtl->fbtlm_init_query(enable_progress_threads, enable_mpi_threads);
}
