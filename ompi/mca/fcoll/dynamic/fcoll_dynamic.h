...
int mca_fcoll_dynamic_component_init_query(bool enable_progress_threads, bool enable_mpi_threads);
struct mca_fcoll_base_module_1_0_0_t *mca_fcoll_dynamic_component_file_query(ompio_file_t *fh,
                                                                             int *priority);
...
int mca_fcoll_dynamic_file_read_all(ompio_file_t *fh, void *buf, int count,
