...
int mca_fcoll_individual_component_init_query(bool enable_progress_threads, bool enable_mpi_threads)
{
    /* Nothing to do */
...
mca_fcoll_base_module_1_0_0_t *mca_fcoll_individual_component_file_query(ompio_file_t *fh,
                                                                         int *priority)
{
