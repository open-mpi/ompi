...
int mca_sharedfp_lockedfile_iread(ompio_file_t *fh, void *buf, int count, ompi_datatype_t *datatype,
                                  MPI_Request *request)
{
...
int mca_sharedfp_lockedfile_read_ordered_begin(ompio_file_t *fh, void *buf, int count,
...
int mca_sharedfp_lockedfile_read_ordered_end(ompio_file_t *fh, void *buf,
