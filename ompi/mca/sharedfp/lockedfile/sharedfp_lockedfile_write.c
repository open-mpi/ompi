...
int mca_sharedfp_lockedfile_write(ompio_file_t *fh, const void *buf, int count,
...
int mca_sharedfp_lockedfile_write_ordered(ompio_file_t *fh, const void *buf, int count,
