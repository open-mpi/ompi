                                      ...
                                      int amode, struct opal_info_t *info, ompio_file_t *fh)
{
    ...
    if (NULL == sh) {
        opal_output(
            0, "mca_sharedfp_lockedfile_file_open: Error, unable to malloc f_sharedfp struct\n");
    ...
    module_data = (struct mca_sharedfp_lockedfile_data *) malloc(
        sizeof(struct mca_sharedfp_lockedfile_data));
    if (NULL == module_data) {
        opal_output(
