...
struct mca_sharedfp_base_module_1_0_0_t *mca_sharedfp_sm_component_file_query(ompio_file_t *file,
                                                                              int *priority);
...
int mca_sharedfp_sm_seek(ompio_file_t *fh, OMPI_MPI_OFFSET_TYPE offset, int whence);
...
int mca_sharedfp_sm_iread(ompio_file_t *fh, void *buf, int count, struct ompi_datatype_t *datatype,
...
int mca_sharedfp_sm_write_ordered(ompio_file_t *fh, const void *buf, int count,
                                  struct ompi_datatype_t *datatype, ompi_status_public_t *status);
int mca_sharedfp_sm_write_ordered_begin(ompio_file_t *fh, const void *buf, int count,
                                        struct ompi_datatype_t *datatype);
int mca_sharedfp_sm_write_ordered_end(ompio_file_t *fh, const void *buf,
                                      ompi_status_public_t *status);
int mca_sharedfp_sm_iwrite(ompio_file_t *fh, const void *buf, int count,
