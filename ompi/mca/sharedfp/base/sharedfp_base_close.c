...
int mca_sharedfp_base_close(void)
{
    ...
    */
    ...
    if (mca_sharedfp_base_components_opened_valid) {
        mca_base_components_close(mca_sharedfp_base_output,
                                  &mca_sharedfp_base_components_opened, NULL);
        OBJ_DESTRUCT(&mca_sharedfp_base_components_opened);
        mca_sharedfp_base_components_opened_valid = false;
    } else if (mca_sharedfp_base_components_available_valid) {
        mca_base_components_close(mca_sharedfp_base_output,
