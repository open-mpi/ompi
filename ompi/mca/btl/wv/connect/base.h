...
#ifndef BTL_WV_CONNECT_BASE_H
#define BTL_WV_CONNECT_BASE_H

#include "connect/connect.h"

#ifdef OMPI_HAVE_RDMAOE
#define BTL_WV_CONNECT_BASE_CHECK_IF_NOT_IB(btl)                       \
        (((IBV_TRANSPORT_IB != ((btl)->device->ib_dev->transport_type)) || \
        (IBV_LINK_LAYER_ETHERNET == ((btl)->ib_port_attr.link_layer))) ?   \
        true : false)
#else
#define BTL_WV_CONNECT_BASE_CHECK_IF_NOT_IB(btl)                       \
        ((WV_TRANSPORT_IB != ((btl)->device->ib_dev->transport_type)) ?   \
        true : false)
#endif
 ...
 */
int ompi_btl_wv_connect_base_select_for_local_port
    (mca_btl_wv_module_t *btl);
 ...
 * Select function
 */
int ompi_btl_wv_connect_base_find_match
    (mca_btl_wv_module_t *btl,
     struct mca_btl_wv_proc_modex_t *peer_port,
 ...
 */
int ompi_btl_wv_connect_base_get_cpc_index
    (ompi_btl_wv_connect_base_component_t *cpc);
 ...
 * Allocate a CTS frag
 */
int ompi_btl_wv_connect_base_alloc_cts(
        struct mca_btl_base_endpoint_t *endpoint);

/* 
 * Free a CTS frag
 */
int ompi_btl_wv_connect_base_free_cts(
        struct mca_btl_base_endpoint_t *endpoint);
