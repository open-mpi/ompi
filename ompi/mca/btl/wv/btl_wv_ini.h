 ...
 * file
 */
typedef struct ompi_btl_wv_ini_values_t {
    uint32_t mtu;
    bool mtu_set;
...
BEGIN_C_DECLS
     ...
     */
    int ompi_btl_wv_ini_query(uint32_t vendor_id,
     ...
     */
    int ompi_btl_wv_ini_intify(char *string);
    int ompi_btl_wv_ini_intify_list(char *str, uint32_t **values, int *len);
