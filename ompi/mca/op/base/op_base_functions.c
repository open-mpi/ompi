...
#define OP_FUNC_3BUF(name, type_name, type, op)                                               \
    static void                                                                               \
        ompi_op_base_3buff_##name##_##type_name(const void *restrict in1,                     \
                                                const void *restrict in2, void *restrict out, \
...
#if OMPI_HAVE_FORTRAN_REAL
#    define FLOATING_POINT_FORTRAN_REAL_PLAIN(name, ftype) \
        ompi_op_base_##ftype##_##name##_fortran_real
#else
...
#if OMPI_HAVE_FORTRAN_REAL16 && OMPI_REAL16_MATCHES_C
#    define FLOATING_POINT_FORTRAN_REAL16(name, ftype) \
        ompi_op_base_##ftype##_##name##_fortran_real16
#else
...
#define FLOATING_POINT(name, ftype)                                                              \
    ...
    [OMPI_OP_BASE_TYPE_DOUBLE] = DOUBLE(name, ftype), FLOATING_POINT_FORTRAN_REAL(name, ftype),  \
...
#define BYTE(name, ftype) [OMPI_OP_BASE_TYPE_BYTE] = ompi_op_base_##ftype##_##name##_byte
...
#endif
#if OMPI_HAVE_FORTRAN_DOUBLE_PRECISION
#    define TWOLOC_FORTRAN_2DOUBLE_PRECISION(name, ftype) \
        ompi_op_base_##ftype##_##name##_2double_precision
#else
