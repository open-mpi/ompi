...
static void
mca_part_persist_aggregated_precv_request_construct(mca_part_persist_aggregated_precv_request_t* recvreq)
{
...
OBJ_CLASS_INSTANCE(mca_part_persist_aggregated_precv_request_t,
                   mca_part_persist_aggregated_request_t,
                   mca_part_persist_aggregated_precv_request_construct,
                   NULL);
