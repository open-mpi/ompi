...
static void mca_part_persist_aggregated_psend_request_construct(mca_part_persist_aggregated_psend_request_t* sendreq)
{
...
OBJ_CLASS_INSTANCE(mca_part_persist_aggregated_psend_request_t,
                   mca_part_persist_aggregated_request_t,
                   mca_part_persist_aggregated_psend_request_construct,
                   NULL);
