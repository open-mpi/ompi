 ...
 *                         All rights reserved.
 * Copyright (c) 2012-2020 Sandia National Laboratories.  All rights reserved.
...
#ifndef PART_RMA_RECVREQ_H
#define PART_RMA_RECVREQ_H

#include "part_rma_request.h"
#include "ompi/mca/part/base/part_base_precvreq.h"

struct mca_part_rma_precv_request_t {
    mca_part_rma_request_t req_base;
};
typedef struct mca_part_rma_precv_request_t mca_part_rma_precv_request_t;
OBJ_CLASS_DECLARATION(mca_part_rma_precv_request_t);
 ...
 */
#define MCA_PART_RMA_PRECV_REQUEST_ALLOC(precvreq)                           \
do {                                                                         \
    precvreq = (mca_part_rma_precv_request_t*)                               \
      opal_free_list_get (&mca_part_base_precv_requests);                    \
    precvreq->req_base.req_type = MCA_PART_RMA_REQUEST_PRECV;            \
 } while (0)
 ...
 */
#define MCA_PART_RMA_PRECV_REQUEST_INIT( request,                     \
                                         ompi_proc,                   \
                                         comm,                        \
                                         tag,                         \
                                         src,                         \
 ...
 */
#define MCA_PART_RMA_PRECV_REQUEST_RETURN(recvreq)                      \
{                                                                       \
