...
static void mca_part_base_psend_request_construct(mca_part_base_psend_request_t* req);
static void mca_part_base_psend_request_destruct(mca_part_base_psend_request_t* req);
...
OBJ_CLASS_INSTANCE(
    ...
    mca_part_base_psend_request_destruct
);
