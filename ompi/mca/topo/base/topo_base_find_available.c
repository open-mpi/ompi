...
int mca_topo_base_find_available(bool enable_progress_threads, bool enable_mpi_threads)
{
                      ...
                      bool enable_progress_threads, bool enable_mpi_threads)
{
    ...
    opal_output_verbose(10, ompi_topo_base_framework.framework_output,
                        "topo:find_available: querying topo component %s", m->mca_component_name);
    ...
    if (2 == m->mca_type_major_version && 2 == m->mca_type_minor_version
        && 0 == m->mca_type_release_version) {
        ret = init_query_2_2_0(m, entry, enable_progress_threads, enable_mpi_threads);
    } else {
...
static int init_query_2_2_0(const mca_base_component_t *component,
                            ...
                            bool enable_mpi_threads)
{
    mca_topo_base_component_2_2_0_t *topo = (mca_topo_base_component_2_2_0_t *) component;

    return topo->topoc_init_query(enable_progress_threads, enable_mpi_threads);
}
