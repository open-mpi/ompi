...
__opal_attribute_weak__ int MPI_T_category_get_categories(int cat_index, int len, int indices[])
{
    return PMPI_T_category_get_categories(cat_index, len, indices);
}
#endif
