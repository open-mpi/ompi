                            ...
                            MPI_Request *request)
{
    ...
    err = comm->c_coll.neigh->coll_ineighbor_alltoallv((void *) sendbuf, (int *) sendcounts, (int *) sdispls,
                                                       sendtype, recvbuf, (int *) recvcounts, (int *) rdispls,
                                                       recvtype, comm, request, comm->c_coll.neigh->coll_ineighbor_alltoallv_module);
