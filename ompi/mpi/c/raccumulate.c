                    ...
                    MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request)
{
    ...
    MEMCHECKER(memchecker_datatype(origin_datatype); memchecker_datatype(target_datatype);
               memchecker_call(&opal_memchecker_base_isdefined, origin_addr, origin_count,
                               origin_datatype););
    ...
    rc = ompi_win->w_osc_module->osc_raccumulate(origin_addr, origin_count, origin_datatype,
