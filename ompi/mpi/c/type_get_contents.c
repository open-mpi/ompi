...
int MPI_Type_get_contents(MPI_Datatype mtype, int max_integers, int max_addresses,
                          ...
                          MPI_Datatype array_of_datatypes[])
{
    ...
    rc = ompi_datatype_get_args(mtype, 1, &max_integers, array_of_integers, &max_addresses,
                                array_of_addresses, &max_datatypes, array_of_datatypes, NULL);
    if (rc != MPI_SUCCESS) {
        OMPI_ERRHANDLER_NOHANDLE_RETURN(MPI_ERR_INTERN, MPI_ERR_INTERN, FUNC_NAME);
    }
