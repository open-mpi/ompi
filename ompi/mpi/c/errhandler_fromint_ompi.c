...
MPI_Errhandler MPI_Errhandler_fromint(int errhandler)
{
    ...
    return (MPI_Errhandler)opal_pointer_array_get_item(&ompi_errhandler_f_to_c_table, o_index);
}
...
__opal_attribute_weak__ MPI_Errhandler MPI_Errhandler_fromint(int errhandler)
{
