                             ...
                             MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request)
{
    ...
    MEMCHECKER(
        ...
        size = ompi_comm_size(comm); ompi_datatype_type_extent(recvtype, &ext);
    ...
    err = comm->c_coll->coll_ineighbor_allgatherv(sendbuf, sendcount, sendtype, recvbuf,
                                                  (int *) recvcounts, (int *) displs, recvtype,
                                                  comm, request,
