...
int MPI_Group_translate_ranks(MPI_Group group1, int n_ranks, const int ranks1[], MPI_Group group2,
                              int ranks2[])
{
    int err;
    ...
    err = ompi_group_translate_ranks(group1, n_ranks, ranks1, group2, ranks2);
