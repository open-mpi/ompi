...
int MPI_Dist_graph_neighbors_count(MPI_Comm comm, int *inneighbors, int *outneighbors,
                                   int *weighted)
{
    int err;
    ...
    if (MPI_PARAM_CHECK) {
        ...
        } else if (NULL == inneighbors || NULL == outneighbors || NULL == weighted) {
    ...
    err = comm->c_topo->topo.dist_graph.dist_graph_neighbors_count(comm, inneighbors, outneighbors,
                                                                   weighted);
