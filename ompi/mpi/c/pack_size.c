...
int MPI_Pack_size(int incount, MPI_Datatype datatype, MPI_Comm comm, int *size)
{
    ...
    MEMCHECKER(memchecker_datatype(datatype); memchecker_comm(comm););
    ...
    opal_convertor_copy_and_prepare_for_send(ompi_mpi_local_convertor, &(datatype->super), incount,
                                             NULL, 0, &local_convertor);
