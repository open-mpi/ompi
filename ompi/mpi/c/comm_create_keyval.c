                           ...
                           void *extra_state)
{
    ...
    if (MPI_PARAM_CHECK) {
        ...
        if ((NULL == comm_copy_attr_fn) || (NULL == comm_delete_attr_fn) || (NULL == comm_keyval)) {
    ...
    ret = ompi_attr_create_keyval(COMM_ATTR, copy_fn, del_fn, comm_keyval, extra_state, 0, NULL);
