...
#pragma weak MPI_Iallgatherv_init = PMPI_Iallgatherv_init
#endif
#define MPI_Iallgatherv_init PMPI_Iallgatherv_init
#endif

static const char FUNC_NAME[] = "MPI_Iallgatherv_init";


int MPI_Iallgatherv_init(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
