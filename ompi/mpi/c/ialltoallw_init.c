...
#pragma weak MPIX_Ialltoallw_init = PMPIX_Ialltoallw_init
#endif
#define MPIX_Ialltoallw_init PMPIX_Ialltoallw_init
#endif

static const char FUNC_NAME[] = "MPIX_Ialltoallw_init";
