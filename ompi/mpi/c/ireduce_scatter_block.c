                              ...
                              MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request)
{
    ...
    MEMCHECKER(
        ...
        } else { memchecker_call(&opal_memchecker_base_isdefined, sendbuf, recvcount, datatype); });
    ...
    err = comm->c_coll->coll_ireduce_scatter_block(sendbuf, recvbuf, recvcount, datatype, op, comm,
                                                   request,
