...
#pragma weak MPI_Iallreduce_init = PMPI_Iallreduce_init
#endif
#define MPI_Iallreduce_init PMPI_Iallreduce_init
#endif

static const char FUNC_NAME[] = "MPI_Iallreduce_init";
...
int MPI_Iallreduce_init(const void *sendbuf, void *recvbuf, int count,
    ...
    printf("Leaving Iallreduce_init...\n");
