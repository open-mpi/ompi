...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_POSITION_SHARED, pmpi_file_get_position_shared,
                           pmpi_file_get_position_shared_, pmpi_file_get_position_shared__,
                           pompi_file_get_position_shared_f,
                           (MPI_Fint * fh, MPI_Offset *offset, MPI_Fint *ierr), (fh, offset, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_POSITION_SHARED, mpi_file_get_position_shared,
                           mpi_file_get_position_shared_, mpi_file_get_position_shared__,
...
void ompi_file_get_position_shared_f(MPI_Fint *fh, MPI_Offset *offset, MPI_Fint *ierr)
{
    int c_ierr;
