...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_DIMS_CREATE, pmpi_dims_create, pmpi_dims_create_,
                           pmpi_dims_create__, pompi_dims_create_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_DIMS_CREATE, mpi_dims_create, mpi_dims_create_, mpi_dims_create__,
                           ompi_dims_create_f,
                           (MPI_Fint * nnodes, MPI_Fint *ndims, MPI_Fint *dims, MPI_Fint *ierr),
                           (nnodes, ndims, dims, ierr))
#    else
...
void ompi_dims_create_f(MPI_Fint *nnodes, MPI_Fint *ndims, MPI_Fint *dims, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Dims_create(OMPI_FINT_2_INT(*nnodes), OMPI_FINT_2_INT(*ndims),
