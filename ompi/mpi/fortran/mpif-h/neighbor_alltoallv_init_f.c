...
#pragma weak pmpi_neighbor_alltoallv_init__ = ompi_neighbor_alltoallv_init_f

#pragma weak PMPI_Neighbor_alltoallv_init_f = ompi_neighbor_alltoallv_init_f
#pragma weak PMPI_Neighbor_alltoallv_init_f08 = ompi_neighbor_alltoallv_init_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_NEIGHBOR_ALLTOALLV_INIT,
...
#pragma weak mpi_neighbor_alltoallv_init__ = ompi_neighbor_alltoallv_init_f
...
void ompi_neighbor_alltoallv_init_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls,
                                    ...
                                    MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Neighbor_alltoallv_init(sendbuf,
