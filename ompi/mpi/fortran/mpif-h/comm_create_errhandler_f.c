...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_CREATE_ERRHANDLER, pmpi_comm_create_errhandler,
...
{
    int c_ierr;
    MPI_Errhandler c_errhandler = ompi_errhandler_create(OMPI_ERRHANDLER_TYPE_COMM,
