...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GET_LIBRARY_VERSION, pmpi_get_library_version,
                           pmpi_get_library_version_, pmpi_get_library_version__,
                           pompi_get_library_version_f,
                           (char *version, MPI_Fint *resultlen, MPI_Fint *ierr,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GET_LIBRARY_VERSION, mpi_get_library_version,
                           mpi_get_library_version_, mpi_get_library_version__,
...
void ompi_get_library_version_f(char *version, MPI_Fint *resultlen, MPI_Fint *ierr,
                                MPI_Fint version_len)
{
    ...
    if (MPI_SUCCESS == c_ierr) {
        ompi_fortran_string_c2f(c_version, version, OMPI_FINT_2_INT(version_len));
