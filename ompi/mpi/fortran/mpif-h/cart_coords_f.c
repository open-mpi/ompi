...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_CART_COORDS, pmpi_cart_coords, pmpi_cart_coords_,
                           pmpi_cart_coords__, pompi_cart_coords_f,
                           (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *maxdims, MPI_Fint *coords,
                            MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_CART_COORDS, mpi_cart_coords, mpi_cart_coords_, mpi_cart_coords__,
                           ompi_cart_coords_f,
                           (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *maxdims, MPI_Fint *coords,
                            MPI_Fint *ierr),
                           (comm, rank, maxdims, coords, ierr))
...
void ompi_cart_coords_f(MPI_Fint *comm, MPI_Fint *rank, MPI_Fint *maxdims, MPI_Fint *coords,
                        MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
    ...
    c_ierr = PMPI_Cart_coords(c_comm, OMPI_FINT_2_INT(*rank), OMPI_FINT_2_INT(*maxdims),
