...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_DUP, pmpi_comm_dup, pmpi_comm_dup_, pmpi_comm_dup__,
                           pompi_comm_dup_f, (MPI_Fint * comm, MPI_Fint *newcomm, MPI_Fint *ierr),
                           (comm, newcomm, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_DUP, mpi_comm_dup, mpi_comm_dup_, mpi_comm_dup__,
                           ompi_comm_dup_f, (MPI_Fint * comm, MPI_Fint *newcomm, MPI_Fint *ierr),
                           (comm, newcomm, ierr))
#    else
