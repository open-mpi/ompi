...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_SET_SIZE, pmpi_file_set_size, pmpi_file_set_size_,
                           pmpi_file_set_size__, pompi_file_set_size_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_SET_SIZE, mpi_file_set_size, mpi_file_set_size_,
                           mpi_file_set_size__, ompi_file_set_size_f,
                           (MPI_Fint * fh, MPI_Offset *size, MPI_Fint *ierr), (fh, size, ierr))
#    else
