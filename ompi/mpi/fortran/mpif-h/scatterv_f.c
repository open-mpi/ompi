...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_SCATTERV, pmpi_scatterv, pmpi_scatterv_, pmpi_scatterv__, pompi_scatterv_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_SCATTERV, mpi_scatterv, mpi_scatterv_, mpi_scatterv__, ompi_scatterv_f,
    (char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *displs, MPI_Fint *sendtype, char *recvbuf,
     MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierr),
    (sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm, ierr))
#    else
...
void ompi_scatterv_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *displs, MPI_Fint *sendtype,
                     ...
                     MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Scatterv(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
