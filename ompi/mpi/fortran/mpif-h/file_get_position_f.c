...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_POSITION, pmpi_file_get_position, pmpi_file_get_position_,
                           pmpi_file_get_position__, pompi_file_get_position_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_POSITION, mpi_file_get_position, mpi_file_get_position_,
                           mpi_file_get_position__, ompi_file_get_position_f,
                           (MPI_Fint * fh, MPI_Offset *offset, MPI_Fint *ierr), (fh, offset, ierr))
#    else
