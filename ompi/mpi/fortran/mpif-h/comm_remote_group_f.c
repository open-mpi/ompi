...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_REMOTE_GROUP, pmpi_comm_remote_group, pmpi_comm_remote_group_,
                           pmpi_comm_remote_group__, pompi_comm_remote_group_f,
                           (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr), (comm, group, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_REMOTE_GROUP, mpi_comm_remote_group, mpi_comm_remote_group_,
                           mpi_comm_remote_group__, ompi_comm_remote_group_f,
                           (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr), (comm, group, ierr))
#    else
