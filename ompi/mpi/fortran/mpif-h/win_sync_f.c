...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_SYNC, pmpi_win_sync, pmpi_win_sync_, pmpi_win_sync__,
                           pompi_win_sync_f, (MPI_Fint * win, MPI_Fint *ierr), (win, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_SYNC, mpi_win_sync, mpi_win_sync_, mpi_win_sync__,
                           ompi_win_sync_f, (MPI_Fint * win, MPI_Fint *ierr), (win, ierr))
#    else
