...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_DETACH, pmpi_win_detach, pmpi_win_detach_, pmpi_win_detach__,
                           pompi_win_detach_f, (MPI_Fint * win, char *base, MPI_Fint *ierr),
                           (win, base, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_DETACH, mpi_win_detach, mpi_win_detach_, mpi_win_detach__,
                           ompi_win_detach_f, (MPI_Fint * win, char *base, MPI_Fint *ierr),
                           (win, base, ierr))
#    else
...
void ompi_win_detach_f(MPI_Fint *win, char *base, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Win c_win;
