...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_BUFFER_ATTACH, pmpi_buffer_attach, pmpi_buffer_attach_,
                           pmpi_buffer_attach__, pompi_buffer_attach_f,
                           (char *buffer, MPI_Fint *size, MPI_Fint *ierr), (buffer, size, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_BUFFER_ATTACH, mpi_buffer_attach, mpi_buffer_attach_,
                           mpi_buffer_attach__, ompi_buffer_attach_f,
                           (char *buffer, MPI_Fint *size, MPI_Fint *ierr), (buffer, size, ierr))
#    else
