...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_AMODE, pmpi_file_get_amode, pmpi_file_get_amode_,
                           pmpi_file_get_amode__, pompi_file_get_amode_f,
                           (MPI_Fint * fh, MPI_Fint *amode, MPI_Fint *ierr), (fh, amode, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_AMODE, mpi_file_get_amode, mpi_file_get_amode_,
                           mpi_file_get_amode__, ompi_file_get_amode_f,
                           (MPI_Fint * fh, MPI_Fint *amode, MPI_Fint *ierr), (fh, amode, ierr))
#    else
