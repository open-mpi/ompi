...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_PACK_EXTERNAL, pmpi_pack_external, pmpi_pack_external_,
                           pmpi_pack_external__, pompi_pack_external_f,
                           (char *datarep, char *inbuf, MPI_Fint *incount, MPI_Fint *datatype,
                            char *outbuf, MPI_Aint *outsize, MPI_Aint *position, MPI_Fint *ierr,
                            int datarep_len),
...
OMPI_GENERATE_F77_BINDINGS(MPI_PACK_EXTERNAL, mpi_pack_external, mpi_pack_external_,
                           mpi_pack_external__, ompi_pack_external_f,
                           (char *datarep, char *inbuf, MPI_Fint *incount, MPI_Fint *datatype,
                            char *outbuf, MPI_Aint *outsize, MPI_Aint *position, MPI_Fint *ierr,
                            int datarep_len),
                           (datarep, inbuf, incount, datatype, outbuf, outsize, position, ierr,
...
void ompi_pack_external_f(char *datarep, char *inbuf, MPI_Fint *incount, MPI_Fint *datatype,
                          char *outbuf, MPI_Aint *outsize, MPI_Aint *position, MPI_Fint *ierr,
                          int datarep_len)
{
    int ret, c_ierr;
    ...
    c_ierr = PMPI_Pack_external(c_datarep, OMPI_F2C_BOTTOM(inbuf), OMPI_FINT_2_INT(*incount), type,
