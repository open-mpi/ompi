...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_ALLGATHERV, pmpi_allgatherv, pmpi_allgatherv_, pmpi_allgatherv__, pompi_allgatherv_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_ALLGATHERV, mpi_allgatherv, mpi_allgatherv_, mpi_allgatherv__, ompi_allgatherv_f,
    (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf, MPI_Fint *recvcounts,
     MPI_Fint *displs, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierr),
    (sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, ierr))
#    else
...
void ompi_allgatherv_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                       ...
                       MPI_Fint *ierr)
{
    ...
    ierr_c = PMPI_Allgatherv(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
