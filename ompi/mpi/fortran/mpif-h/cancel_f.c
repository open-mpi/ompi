...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_CANCEL, pmpi_cancel, pmpi_cancel_, pmpi_cancel__, pompi_cancel_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_CANCEL, mpi_cancel, mpi_cancel_, mpi_cancel__, ompi_cancel_f,
                           (MPI_Fint * request, MPI_Fint *ierr), (request, ierr))
#    endif
