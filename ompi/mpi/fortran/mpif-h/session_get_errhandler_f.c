...
#pragma weak pmpi_session_get_errhandler__ = ompi_session_get_errhandler_f

#pragma weak PMPI_Session_get_errhandler_f = ompi_session_get_errhandler_f
#pragma weak PMPI_Session_get_errhandler_f08 = ompi_session_get_errhandler_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_SESSION_GET_ERRHANDLER,
...
#pragma weak mpi_session_get_errhandler__ = ompi_session_get_errhandler_f
...
void ompi_session_get_errhandler_f(MPI_Fint *session, MPI_Fint *errhandler,
                                MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Session_get_errhandler(c_session, &c_errhandler);
