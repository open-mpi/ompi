...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GET_ACCUMULATE, pmpi_get_accumulate, pmpi_get_accumulate_,
                           pmpi_get_accumulate__, pompi_get_accumulate_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GET_ACCUMULATE, mpi_get_accumulate, mpi_get_accumulate_,
                           mpi_get_accumulate__, ompi_get_accumulate_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *ierr),
...
void ompi_get_accumulate_f(char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                           char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype,
                           MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                           MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Get_accumulate(OMPI_F2C_BOTTOM(origin_addr), OMPI_FINT_2_INT(*origin_count),
                                 c_origin_datatype, OMPI_F2C_BOTTOM(result_addr),
                                 OMPI_FINT_2_INT(*result_count), c_result_datatype,
                                 OMPI_FINT_2_INT(*target_rank), *target_disp,
