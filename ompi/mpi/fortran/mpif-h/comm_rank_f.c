...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_RANK, pmpi_comm_rank, pmpi_comm_rank_, pmpi_comm_rank__,
                           pompi_comm_rank_f, (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *ierr),
                           (comm, rank, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_RANK, mpi_comm_rank, mpi_comm_rank_, mpi_comm_rank__,
                           ompi_comm_rank_f, (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *ierr),
                           (comm, rank, ierr))
#    else
