...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_IALLTOALL, pmpi_ialltoall, pmpi_ialltoall_, pmpi_ialltoall__, pompi_ialltoall_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_IALLTOALL, mpi_ialltoall, mpi_ialltoall_, mpi_ialltoall__, ompi_ialltoall_f,
    (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf, MPI_Fint *recvcount,
     MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr),
    (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, request, ierr))
#    else
...
void ompi_ialltoall_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                      ...
                      MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Ialltoall(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
