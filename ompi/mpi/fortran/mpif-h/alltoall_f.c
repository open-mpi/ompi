...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ALLTOALL, pmpi_alltoall, pmpi_alltoall_, pmpi_alltoall__,
                           pompi_alltoall_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ALLTOALL, mpi_alltoall, mpi_alltoall_, mpi_alltoall__,
                           ompi_alltoall_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm,
                            MPI_Fint *ierr),
...
void ompi_alltoall_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                     MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Alltoall(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
