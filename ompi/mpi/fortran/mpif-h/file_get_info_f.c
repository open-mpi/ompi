...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_INFO, pmpi_file_get_info, pmpi_file_get_info_,
                           pmpi_file_get_info__, pompi_file_get_info_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_INFO, mpi_file_get_info, mpi_file_get_info_,
                           mpi_file_get_info__, ompi_file_get_info_f,
                           (MPI_Fint * fh, MPI_Fint *info_used, MPI_Fint *ierr),
                           (fh, info_used, ierr))
#    else
