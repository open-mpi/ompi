...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_ALLTOALLW, pmpi_alltoallw, pmpi_alltoallw_, pmpi_alltoallw__, pompi_alltoallw_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_ALLTOALLW, mpi_alltoallw, mpi_alltoallw_, mpi_alltoallw__, ompi_alltoallw_f,
    (char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls, MPI_Fint *sendtypes, char *recvbuf,
     MPI_Fint *recvcounts, MPI_Fint *rdispls, MPI_Fint *recvtypes, MPI_Fint *comm, MPI_Fint *ierr),
    (sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm, ierr))
#    else
...
void ompi_alltoallw_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls, MPI_Fint *sendtypes,
                      ...
                      MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Alltoallw(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
