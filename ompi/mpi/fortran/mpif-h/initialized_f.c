...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_INITIALIZED, pmpi_initialized, pmpi_initialized_,
                           pmpi_initialized__, pompi_initialized_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_INITIALIZED, mpi_initialized, mpi_initialized_, mpi_initialized__,
                           ompi_initialized_f, (ompi_fortran_logical_t * flag, MPI_Fint *ierr),
                           (flag, ierr))
#    else
