...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GET, pmpi_get, pmpi_get_, pmpi_get__, pompi_get_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GET, mpi_get, mpi_get_, mpi_get__, ompi_get_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *win, MPI_Fint *ierr),
                           (origin_addr, origin_count, origin_datatype, target_rank, target_disp,
...
void ompi_get_f(char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                MPI_Fint *target_datatype, MPI_Fint *win, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Get(OMPI_F2C_BOTTOM(origin_addr), OMPI_FINT_2_INT(*origin_count),
