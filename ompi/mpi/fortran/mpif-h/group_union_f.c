...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GROUP_UNION, pmpi_group_union, pmpi_group_union_,
                           pmpi_group_union__, pompi_group_union_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GROUP_UNION, mpi_group_union, mpi_group_union_, mpi_group_union__,
                           ompi_group_union_f,
                           (MPI_Fint * group1, MPI_Fint *group2, MPI_Fint *newgroup,
                            MPI_Fint *ierr),
                           (group1, group2, newgroup, ierr))
