...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_CREATE_HINDEXED_BLOCK, pmpi_type_create_hindexed_block,
                           pmpi_type_create_hindexed_block_, pmpi_type_create_hindexed_block__,
                           pompi_type_create_hindexed_block_f,
                           (MPI_Fint * count, MPI_Fint *blocklength,
                            MPI_Aint *array_of_displacements, MPI_Fint *oldtype, MPI_Fint *newtype,
                            MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_CREATE_HINDEXED_BLOCK, mpi_type_create_hindexed_block,
                           mpi_type_create_hindexed_block_, mpi_type_create_hindexed_block__,
...
void ompi_type_create_hindexed_block_f(MPI_Fint *count, MPI_Fint *blocklength,
                                       MPI_Aint *array_of_displacements, MPI_Fint *oldtype,
                                       MPI_Fint *newtype, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Type_create_hindexed_block(OMPI_FINT_2_INT(*count), OMPI_FINT_2_INT(*blocklength),
