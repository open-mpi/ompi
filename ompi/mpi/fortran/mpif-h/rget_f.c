...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_RGET, pmpi_rget, pmpi_rget_, pmpi_rget__, pompi_rget_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_RGET, mpi_rget, mpi_rget_, mpi_rget__, ompi_rget_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *win, MPI_Fint *request,
                            MPI_Fint *ierr),
...
void ompi_rget_f(char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                 MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                 MPI_Fint *target_datatype, MPI_Fint *win, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Rget(OMPI_F2C_BOTTOM(origin_addr), OMPI_FINT_2_INT(*origin_count),
