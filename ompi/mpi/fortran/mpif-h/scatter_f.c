...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_SCATTER, pmpi_scatter, pmpi_scatter_, pmpi_scatter__, pompi_scatter_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_SCATTER, mpi_scatter, mpi_scatter_, mpi_scatter__, ompi_scatter_f,
...
void ompi_scatter_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                    MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                    MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Scatter(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
