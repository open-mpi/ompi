...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_CREATE_F90_INTEGER, pmpi_type_create_f90_integer,
                           pmpi_type_create_f90_integer_, pmpi_type_create_f90_integer__,
                           pompi_type_create_f90_integer_f,
                           (MPI_Fint * r, MPI_Fint *newtype, MPI_Fint *ierr), (r, newtype, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_CREATE_F90_INTEGER, mpi_type_create_f90_integer,
...
void ompi_type_create_f90_integer_f(MPI_Fint *r, MPI_Fint *newtype, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Datatype c_new;
