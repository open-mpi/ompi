...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_GET_TRUE_EXTENT, pmpi_type_get_true_extent,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_GET_TRUE_EXTENT, mpi_type_get_true_extent,
                           mpi_type_get_true_extent_, mpi_type_get_true_extent__,
...
void ompi_type_get_true_extent_f(MPI_Fint *datatype, MPI_Aint *true_lb, MPI_Aint *true_extent,
                                 MPI_Fint *ierr)
{
    int c_ierr;
