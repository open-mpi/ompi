...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_CLOSE_PORT, pmpi_close_port, pmpi_close_port_, pmpi_close_port__,
                           pompi_close_port_f, (char *port_name, MPI_Fint *ierr, int port_name_len),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_CLOSE_PORT, mpi_close_port, mpi_close_port_, mpi_close_port__,
                           ompi_close_port_f, (char *port_name, MPI_Fint *ierr, int port_name_len),
                           (port_name, ierr, port_name_len))
#    else
