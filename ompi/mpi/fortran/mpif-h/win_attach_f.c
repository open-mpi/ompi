...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_ATTACH, pmpi_win_attach, pmpi_win_attach_, pmpi_win_attach__,
                           pompi_win_attach_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_ATTACH, mpi_win_attach, mpi_win_attach_, mpi_win_attach__,
                           ompi_win_attach_f,
                           (MPI_Fint * win, char *base, MPI_Aint *size, MPI_Fint *ierr),
                           (win, base, size, ierr))
#    else
...
void ompi_win_attach_f(MPI_Fint *win, char *base, MPI_Aint *size, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Win c_win;
