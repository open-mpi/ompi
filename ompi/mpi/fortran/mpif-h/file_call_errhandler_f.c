...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_CALL_ERRHANDLER, pmpi_file_call_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_CALL_ERRHANDLER, mpi_file_call_errhandler,
                           mpi_file_call_errhandler_, mpi_file_call_errhandler__,
...
void ompi_file_call_errhandler_f(MPI_Fint *fh, MPI_Fint *errorcode, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_File c_fh;
