...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_BSEND, pmpi_bsend, pmpi_bsend_, pmpi_bsend__, pompi_bsend_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_BSEND, mpi_bsend, mpi_bsend_, mpi_bsend__, ompi_bsend_f,
                           (char *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest,
                            MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *ierr),
                           (buf, count, datatype, dest, tag, comm, ierr))
#    else
...
void ompi_bsend_f(char *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                  MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Bsend(OMPI_F2C_BOTTOM(buf), OMPI_FINT_2_INT(*count), c_type,
