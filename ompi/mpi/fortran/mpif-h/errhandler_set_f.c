...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ERRHANDLER_SET, pmpi_errhandler_set, pmpi_errhandler_set_,
                           pmpi_errhandler_set__, pompi_errhandler_set_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_ERRHANDLER_SET, mpi_errhandler_set, mpi_errhandler_set_,
                           mpi_errhandler_set__, ompi_errhandler_set_f,
                           (MPI_Fint * comm, MPI_Fint *errhandler, MPI_Fint *ierr),
                           (comm, errhandler, ierr))
#    else
