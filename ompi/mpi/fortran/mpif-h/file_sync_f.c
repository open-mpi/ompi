...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_SYNC, pmpi_file_sync, pmpi_file_sync_, pmpi_file_sync__,
                           pompi_file_sync_f, (MPI_Fint * fh, MPI_Fint *ierr), (fh, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_SYNC, mpi_file_sync, mpi_file_sync_, mpi_file_sync__,
                           ompi_file_sync_f, (MPI_Fint * fh, MPI_Fint *ierr), (fh, ierr))
#    else
