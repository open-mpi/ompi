...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_RGET_ACCUMULATE, pmpi_rget_accumulate, pmpi_rget_accumulate_,
                           pmpi_rget_accumulate__, pompi_rget_accumulate_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_RGET_ACCUMULATE, mpi_rget_accumulate, mpi_rget_accumulate_,
                           mpi_rget_accumulate__, ompi_rget_accumulate_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win,
...
void ompi_rget_accumulate_f(char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            char *result_addr, MPI_Fint *result_count, MPI_Fint *result_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win,
                            MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Rget_accumulate(OMPI_F2C_BOTTOM(origin_addr), OMPI_FINT_2_INT(*origin_count),
