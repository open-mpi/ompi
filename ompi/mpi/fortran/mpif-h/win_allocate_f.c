...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_ALLOCATE, pmpi_win_allocate, pmpi_win_allocate_,
                           pmpi_win_allocate__, pompi_win_allocate_f,
...
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_ALLOCATE_CPTR, pmpi_win_allocate_cptr, pmpi_win_allocate_cptr_,
                           pmpi_win_allocate_cptr__, pompi_win_allocate_cptr_f,
                           (MPI_Aint * size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                            char *baseptr, MPI_Fint *win, MPI_Fint *ierr),
                           (size, disp_unit, info, comm, baseptr, win, ierr))
#    endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_ALLOCATE, mpi_win_allocate, mpi_win_allocate_,
                           mpi_win_allocate__, ompi_win_allocate_f,
                           (MPI_Aint * size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                            char *baseptr, MPI_Fint *win, MPI_Fint *ierr),
                           (size, disp_unit, info, comm, baseptr, win, ierr))

OMPI_GENERATE_F77_BINDINGS(MPI_WIN_ALLOCATE_CPTR, mpi_win_allocate_cptr, mpi_win_allocate_cptr_,
                           mpi_win_allocate_cptr__, ompi_win_allocate_cptr_f,
                           (MPI_Aint * size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                            char *baseptr, MPI_Fint *win, MPI_Fint *ierr),
                           (size, disp_unit, info, comm, baseptr, win, ierr))
#    else
...
void ompi_win_allocate_f(MPI_Aint *size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                         char *baseptr, MPI_Fint *win, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Info c_info;
    ...
    c_ierr = PMPI_Win_allocate(*size, OMPI_FINT_2_INT(*disp_unit), c_info, c_comm, baseptr, &c_win);
 ...
 */
void ompi_win_allocate_cptr_f(MPI_Aint *size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                              char *baseptr, MPI_Fint *win, MPI_Fint *ierr)
{
    ompi_win_allocate_f(size, disp_unit, info, comm, baseptr, win, ierr);
}
