...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GREQUEST_START, pmpi_grequest_start, pmpi_grequest_start_,
                           pmpi_grequest_start__, pompi_grequest_start_f,
                           (MPI_F_Grequest_query_function * query_fn,
                            MPI_F_Grequest_free_function *free_fn,
                            MPI_F_Grequest_cancel_function *cancel_fn, MPI_Aint *extra_state,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GREQUEST_START, mpi_grequest_start, mpi_grequest_start_,
                           mpi_grequest_start__, ompi_grequest_start_f,
                           (MPI_F_Grequest_query_function * query_fn,
                            MPI_F_Grequest_free_function *free_fn,
                            MPI_F_Grequest_cancel_function *cancel_fn, MPI_Aint *extra_state,
                            MPI_Fint *request, MPI_Fint *ierr),
                           ...
                           MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Request c_req;
    c_ierr = PMPI_Grequest_start((MPI_Grequest_query_function *) query_fn,
                                 (MPI_Grequest_free_function *) free_fn,
                                 (MPI_Grequest_cancel_function *) cancel_fn, extra_state, &c_req);
    if (NULL != ierr)
