...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_ALLOCATE_SHARED, pmpi_win_allocate_shared,
                           pmpi_win_allocate_shared_, pmpi_win_allocate_shared__,
                           pompi_win_allocate_shared_f,
                           (MPI_Aint * size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                            char *baseptr, MPI_Fint *win, MPI_Fint *ierr),
                           (size, disp_unit, info, comm, baseptr, win, ierr))

OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_ALLOCATE_SHARED_CPTR, pmpi_win_allocate_shared_cptr,
                           pmpi_win_allocate_shared_cptr_, pmpi_win_allocate_shared_cptr__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_ALLOCATE_SHARED, mpi_win_allocate_shared,
...
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_ALLOCATE_SHARED_CPTR, mpi_win_allocate_shared_cptr,
                           mpi_win_allocate_shared_cptr_, mpi_win_allocate_shared_cptr__,
...
void ompi_win_allocate_shared_f(MPI_Aint *size, MPI_Fint *disp_unit, MPI_Fint *info, MPI_Fint *comm,
                                char *baseptr, MPI_Fint *win, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Info c_info;
    ...
    c_ierr = PMPI_Win_allocate_shared(*size, OMPI_FINT_2_INT(*disp_unit), c_info, c_comm, baseptr,
                                      &c_win);
 ...
 */
void ompi_win_allocate_shared_cptr_f(MPI_Aint *size, MPI_Fint *disp_unit, MPI_Fint *info,
                                     MPI_Fint *comm, char *baseptr, MPI_Fint *win, MPI_Fint *ierr)
{
    ompi_win_allocate_shared_f(size, disp_unit, info, comm, baseptr, win, ierr);
}
