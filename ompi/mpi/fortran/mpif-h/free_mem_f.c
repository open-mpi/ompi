...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FREE_MEM, pmpi_free_mem, pmpi_free_mem_, pmpi_free_mem__,
                           pompi_free_mem_f, (char *base, MPI_Fint *ierr), (base, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FREE_MEM, mpi_free_mem, mpi_free_mem_, mpi_free_mem__,
                           ompi_free_mem_f, (char *base, MPI_Fint *ierr), (base, ierr))
#    else
