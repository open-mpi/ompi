...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GRAPH_NEIGHBORS_COUNT, pmpi_graph_neighbors_count,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GRAPH_NEIGHBORS_COUNT, mpi_graph_neighbors_count,
                           mpi_graph_neighbors_count_, mpi_graph_neighbors_count__,
...
void ompi_graph_neighbors_count_f(MPI_Fint *comm, MPI_Fint *rank, MPI_Fint *nneighbors,
                                  MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
    ...
    c_ierr = PMPI_Graph_neighbors_count(c_comm, OMPI_FINT_2_INT(*rank),
