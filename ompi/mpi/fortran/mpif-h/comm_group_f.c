...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_GROUP, pmpi_comm_group, pmpi_comm_group_, pmpi_comm_group__,
                           pompi_comm_group_f, (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr),
                           (comm, group, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_GROUP, mpi_comm_group, mpi_comm_group_, mpi_comm_group__,
                           ompi_comm_group_f, (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr),
                           (comm, group, ierr))
#    else
