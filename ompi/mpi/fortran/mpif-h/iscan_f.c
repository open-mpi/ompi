...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ISCAN, pmpi_iscan, pmpi_iscan_, pmpi_iscan__, pompi_iscan_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ISCAN, mpi_iscan, mpi_iscan_, mpi_iscan__, ompi_iscan_f,
                           (char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Fint *op, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, recvbuf, count, datatype, op, comm, request, ierr))
#    else
...
void ompi_iscan_f(char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                  MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Iscan(sendbuf, recvbuf, OMPI_FINT_2_INT(*count), c_type, c_op, c_comm,
                        &c_request);
    if (NULL != ierr)
