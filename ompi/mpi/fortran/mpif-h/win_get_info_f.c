...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_GET_INFO, pmpi_win_get_info, pmpi_win_get_info_,
                           pmpi_win_get_info__, pompi_win_get_info_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_GET_INFO, mpi_win_get_info, mpi_win_get_info_,
                           mpi_win_get_info__, ompi_win_get_info_f,
                           (MPI_Fint * win, MPI_Fint *info, MPI_Fint *ierr), (win, info, ierr))
#    else
