...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_GATHERV, pmpi_gatherv, pmpi_gatherv_, pmpi_gatherv__, pompi_gatherv_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GATHERV, mpi_gatherv, mpi_gatherv_, mpi_gatherv__, ompi_gatherv_f,
...
void ompi_gatherv_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                    ...
                    MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Gatherv(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
                          OMPI_ARRAY_NAME_CONVERT(recvcounts), OMPI_ARRAY_NAME_CONVERT(displs),
                          c_recvtype, OMPI_FINT_2_INT(*root), c_comm);
    if (NULL != ierr)
