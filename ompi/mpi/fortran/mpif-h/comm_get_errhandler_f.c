...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_GET_ERRHANDLER, pmpi_comm_get_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_GET_ERRHANDLER, mpi_comm_get_errhandler,
                           mpi_comm_get_errhandler_, mpi_comm_get_errhandler__,
...
void ompi_comm_get_errhandler_f(MPI_Fint *comm, MPI_Fint *errhandler, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
