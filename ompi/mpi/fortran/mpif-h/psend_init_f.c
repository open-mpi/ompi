...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_PSEND_INIT, pmpi_psend_init, pmpi_psend_init_, pmpi_psend_init__,
                           pompi_psend_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_PSEND_INIT, mpi_psend_init, mpi_psend_init_, mpi_psend_init__,
                           ompi_psend_init_f,
                           (char *buf, MPI_Fint *partitions, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Fint *dest, MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *request,
                            MPI_Fint *ierr),
...
void ompi_psend_init_f(char *buf, MPI_Fint *partitions, MPI_Fint *count, MPI_Fint *datatype,
                       MPI_Fint *dest, MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *request,
                       MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Psend_init(OMPI_F2C_BOTTOM(buf), OMPI_FINT_2_INT(*partitions),
