...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_CALL_ERRHANDLER, pmpi_comm_call_errhandler,
...
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_CALL_ERRHANDLER, mpi_comm_call_errhandler,
                           mpi_comm_call_errhandler_, mpi_comm_call_errhandler__,
...
void ompi_comm_call_errhandler_f(MPI_Fint *comm, MPI_Fint *errorcode, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
