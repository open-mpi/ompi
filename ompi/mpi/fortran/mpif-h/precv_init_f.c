...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_PRECV_INIT, pmpi_precv_init, pmpi_precv_init_, pmpi_precv_init__,
                           pompi_precv_init_f,
                           (char *buf, MPI_Fint *partitions, MPI_Fint *count, MPI_Fint *datatype,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_PRECV_INIT, mpi_precv_init, mpi_precv_init_, mpi_precv_init__,
                           ompi_precv_init_f,
                           (char *buf, MPI_Fint *partitions, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Fint *dest, MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *request,
                            MPI_Fint *ierr),
...
void ompi_precv_init_f(char *buf, MPI_Fint *partitions, MPI_Fint *count, MPI_Fint *datatype,
                       MPI_Fint *dest, MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *request,
                       MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Precv_init(OMPI_F2C_BOTTOM(buf), OMPI_FINT_2_INT(*partitions),
                             OMPI_FINT_2_INT(*count), c_type, OMPI_FINT_2_INT(*dest),
