...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_STATUS_SET_ELEMENTS_X, pmpi_status_set_elements_x,
                           pmpi_status_set_elements_x_, pmpi_status_set_elements_x__,
                           pompi_status_set_elements_x_f,
                           (MPI_Fint * status, MPI_Fint *datatype, MPI_Count *count,
                            MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_STATUS_SET_ELEMENTS_X, mpi_status_set_elements_x,
                           mpi_status_set_elements_x_, mpi_status_set_elements_x__,
...
void ompi_status_set_elements_x_f(MPI_Fint *status, MPI_Fint *datatype, MPI_Count *count,
                                  MPI_Fint *ierr)
{
    int c_ierr;
