...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_IBARRIER, pmpi_ibarrier, pmpi_ibarrier_, pmpi_ibarrier__,
                           pompi_ibarrier_f, (MPI_Fint * comm, MPI_Fint *request, MPI_Fint *ierr),
                           (comm, request, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_IBARRIER, mpi_ibarrier, mpi_ibarrier_, mpi_ibarrier__,
                           ompi_ibarrier_f, (MPI_Fint * comm, MPI_Fint *request, MPI_Fint *ierr),
                           (comm, request, ierr))
#    else
