...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_SET_ERRHANDLER, pmpi_file_set_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_SET_ERRHANDLER, mpi_file_set_errhandler,
                           mpi_file_set_errhandler_, mpi_file_set_errhandler__,
...
void ompi_file_set_errhandler_f(MPI_Fint *fh, MPI_Fint *errhandler, MPI_Fint *ierr)
{
    int c_ierr;
