...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_CREATE_HVECTOR, pmpi_type_create_hvector,
                           pmpi_type_create_hvector_, pmpi_type_create_hvector__,
                           pompi_type_create_hvector_f,
                           (MPI_Fint * count, MPI_Fint *blocklength, MPI_Aint *stride,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_CREATE_HVECTOR, mpi_type_create_hvector,
                           mpi_type_create_hvector_, mpi_type_create_hvector__,
...
void ompi_type_create_hvector_f(MPI_Fint *count, MPI_Fint *blocklength, MPI_Aint *stride,
                                MPI_Fint *oldtype, MPI_Fint *newtype, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Type_create_hvector(OMPI_FINT_2_INT(*count), OMPI_FINT_2_INT(*blocklength),
                                      *stride, c_old, &c_new);
    if (NULL != ierr)
