...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_NEIGHBOR_ALLTOALL, pmpi_neighbor_alltoall, pmpi_neighbor_alltoall_,
                           pmpi_neighbor_alltoall__, pompi_neighbor_alltoall_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_NEIGHBOR_ALLTOALL, mpi_neighbor_alltoall, mpi_neighbor_alltoall_,
                           mpi_neighbor_alltoall__, ompi_neighbor_alltoall_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm,
                            MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, ierr))
...
void ompi_neighbor_alltoall_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                              MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm,
                              MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Neighbor_alltoall(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
                                    OMPI_FINT_2_INT(*recvcount), c_recvtype, c_comm);
    if (NULL != ierr)
