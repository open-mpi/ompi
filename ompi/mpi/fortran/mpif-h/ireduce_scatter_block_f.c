...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_IREDUCE_SCATTER_BLOCK, pmpi_ireduce_scatter_block,
                           pmpi_ireduce_scatter_block_, pmpi_ireduce_scatter_block__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_IREDUCE_SCATTER_BLOCK, mpi_ireduce_scatter_block,
                           mpi_ireduce_scatter_block_, mpi_ireduce_scatter_block__,
...
void ompi_ireduce_scatter_block_f(char *sendbuf, char *recvbuf, MPI_Fint *recvcount,
                                  ...
                                  MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Ireduce_scatter_block(sendbuf, recvbuf, OMPI_FINT_2_INT(*recvcount), c_type, c_op,
                                        c_comm, &c_request);
    if (NULL != ierr)
