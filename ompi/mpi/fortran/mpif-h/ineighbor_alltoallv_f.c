...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_INEIGHBOR_ALLTOALLV, pmpi_ineighbor_alltoallv,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_INEIGHBOR_ALLTOALLV, mpi_ineighbor_alltoallv,
                           mpi_ineighbor_alltoallv_, mpi_ineighbor_alltoallv__,
                                ...
                                MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Ineighbor_alltoallv(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
