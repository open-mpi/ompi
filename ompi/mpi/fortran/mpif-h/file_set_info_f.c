...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_SET_INFO, pmpi_file_set_info, pmpi_file_set_info_,
                           pmpi_file_set_info__, pompi_file_set_info_f,
                           (MPI_Fint * fh, MPI_Fint *info, MPI_Fint *ierr), (fh, info, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_SET_INFO, mpi_file_set_info, mpi_file_set_info_,
                           mpi_file_set_info__, ompi_file_set_info_f,
                           (MPI_Fint * fh, MPI_Fint *info, MPI_Fint *ierr), (fh, info, ierr))
#    else
