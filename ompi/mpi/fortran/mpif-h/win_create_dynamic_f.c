...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_CREATE_DYNAMIC, pmpi_win_create_dynamic,
                           pmpi_win_create_dynamic_, pmpi_win_create_dynamic__,
...
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_CREATE_DYNAMIC, mpi_win_create_dynamic, mpi_win_create_dynamic_,
                           mpi_win_create_dynamic__, ompi_win_create_dynamic_f,
                           (MPI_Fint * info, MPI_Fint *comm, MPI_Fint *win, MPI_Fint *ierr),
                           (info, comm, win, ierr))
#    else
...
void ompi_win_create_dynamic_f(MPI_Fint *info, MPI_Fint *comm, MPI_Fint *win, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Win c_win;
    MPI_Info c_info;
