...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_GET_ATTR, pmpi_comm_get_attr, pmpi_comm_get_attr_,
                           pmpi_comm_get_attr__, pompi_comm_get_attr_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_GET_ATTR, mpi_comm_get_attr, mpi_comm_get_attr_,
                           mpi_comm_get_attr__, ompi_comm_get_attr_f,
                           (MPI_Fint * comm, MPI_Fint *comm_keyval, MPI_Aint *attribute_val,
                            ompi_fortran_logical_t *flag, MPI_Fint *ierr),
                           (comm, comm_keyval, attribute_val, flag, ierr))
#    else
...
void ompi_comm_get_attr_f(MPI_Fint *comm, MPI_Fint *comm_keyval, MPI_Aint *attribute_val,
                          ompi_fortran_logical_t *flag, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = ompi_attr_get_aint(c_comm->c_keyhash, OMPI_FINT_2_INT(*comm_keyval), attribute_val,
