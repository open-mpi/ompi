...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_CALL_ERRHANDLER, pmpi_win_call_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_CALL_ERRHANDLER, mpi_win_call_errhandler,
                           mpi_win_call_errhandler_, mpi_win_call_errhandler__,
...
void ompi_win_call_errhandler_f(MPI_Fint *win, MPI_Fint *errorcode, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Win c_win;
