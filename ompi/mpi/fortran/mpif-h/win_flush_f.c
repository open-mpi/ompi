...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_FLUSH, pmpi_win_flush, pmpi_win_flush_, pmpi_win_flush__,
                           pompi_win_flush_f, (MPI_Fint * rank, MPI_Fint *win, MPI_Fint *ierr),
                           (rank, win, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_FLUSH, mpi_win_flush, mpi_win_flush_, mpi_win_flush__,
                           ompi_win_flush_f, (MPI_Fint * rank, MPI_Fint *win, MPI_Fint *ierr),
                           (rank, win, ierr))
#    else
