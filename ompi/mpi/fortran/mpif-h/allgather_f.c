...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ALLGATHER, pmpi_allgather, pmpi_allgather_, pmpi_allgather__,
                           pompi_allgather_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ALLGATHER, mpi_allgather, mpi_allgather_, mpi_allgather__,
                           ompi_allgather_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm,
                            MPI_Fint *ierr),
...
void ompi_allgather_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                      MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierr)
{
    ...
    ierr_c = PMPI_Allgather(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
