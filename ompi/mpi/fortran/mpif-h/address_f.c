...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ADDRESS, pmpi_address, pmpi_address_, pmpi_address__,
                           pompi_address_f, (char *location, MPI_Fint *address, MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ADDRESS, mpi_address, mpi_address_, mpi_address__, ompi_address_f,
