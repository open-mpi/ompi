...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_STARTALL, pmpi_startall, pmpi_startall_, pmpi_startall__,
                           pompi_startall_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_STARTALL, mpi_startall, mpi_startall_, mpi_startall__,
                           ompi_startall_f,
                           (MPI_Fint * count, MPI_Fint *array_of_requests, MPI_Fint *ierr),
                           (count, array_of_requests, ierr))
#    else
...
void ompi_startall_f(MPI_Fint *count, MPI_Fint *array_of_requests, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Request *c_req;
    int i;
