...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_KEYVAL_FREE, pmpi_keyval_free, pmpi_keyval_free_,
                           pmpi_keyval_free__, pompi_keyval_free_f,
                           (MPI_Fint * keyval, MPI_Fint *ierr), (keyval, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_KEYVAL_FREE, mpi_keyval_free, mpi_keyval_free_, mpi_keyval_free__,
                           ompi_keyval_free_f, (MPI_Fint * keyval, MPI_Fint *ierr), (keyval, ierr))
#    else
