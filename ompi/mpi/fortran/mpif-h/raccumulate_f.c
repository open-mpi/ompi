...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_RACCUMULATE, pmpi_raccumulate, pmpi_raccumulate_,
                           pmpi_raccumulate__, pompi_raccumulate_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_RACCUMULATE, mpi_raccumulate, mpi_raccumulate_, mpi_raccumulate__,
                           ompi_raccumulate_f,
                           (char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                            MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                            MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win,
...
void ompi_raccumulate_f(char *origin_addr, MPI_Fint *origin_count, MPI_Fint *origin_datatype,
                        MPI_Fint *target_rank, MPI_Aint *target_disp, MPI_Fint *target_count,
                        MPI_Fint *target_datatype, MPI_Fint *op, MPI_Fint *win, MPI_Fint *request,
                        MPI_Fint *ierr)
{
    int ierr_c;
    ...
    ierr_c = PMPI_Raccumulate(OMPI_F2C_BOTTOM(origin_addr), OMPI_FINT_2_INT(*origin_count),
