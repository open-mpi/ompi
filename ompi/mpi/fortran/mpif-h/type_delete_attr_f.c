...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_DELETE_ATTR, pmpi_type_delete_attr, pmpi_type_delete_attr_,
                           pmpi_type_delete_attr__, pompi_type_delete_attr_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_DELETE_ATTR, mpi_type_delete_attr, mpi_type_delete_attr_,
                           mpi_type_delete_attr__, ompi_type_delete_attr_f,
                           (MPI_Fint * type, MPI_Fint *type_keyval, MPI_Fint *ierr),
                           (type, type_keyval, ierr))
#    else
...
void ompi_type_delete_attr_f(MPI_Fint *type, MPI_Fint *type_keyval, MPI_Fint *ierr)
{
    int c_ierr;
