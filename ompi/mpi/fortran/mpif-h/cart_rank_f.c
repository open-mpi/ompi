...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_CART_RANK, pmpi_cart_rank, pmpi_cart_rank_, pmpi_cart_rank__,
                           pompi_cart_rank_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_CART_RANK, mpi_cart_rank, mpi_cart_rank_, mpi_cart_rank__,
                           ompi_cart_rank_f,
                           (MPI_Fint * comm, MPI_Fint *coords, MPI_Fint *rank, MPI_Fint *ierr),
                           (comm, coords, rank, ierr))
#    else
...
void ompi_cart_rank_f(MPI_Fint *comm, MPI_Fint *coords, MPI_Fint *rank, MPI_Fint *ierr)
{
    MPI_Comm c_comm;
    int ndims, c_ierr;
    ...
    c_ierr = PMPI_Cart_rank(c_comm, OMPI_ARRAY_NAME_CONVERT(coords),
