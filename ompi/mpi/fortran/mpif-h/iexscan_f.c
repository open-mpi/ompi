...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_IEXSCAN, pmpi_iexscan, pmpi_iexscan_, pmpi_iexscan__,
                           pompi_iexscan_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_IEXSCAN, mpi_iexscan, mpi_iexscan_, mpi_iexscan__, ompi_iexscan_f,
                           (char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Fint *op, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, recvbuf, count, datatype, op, comm, request, ierr))
#    else
...
void ompi_iexscan_f(char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *op,
                    MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Iexscan(sendbuf, recvbuf, OMPI_FINT_2_INT(*count), c_type, c_op, c_comm,
                          &c_request);
    if (NULL != ierr)
