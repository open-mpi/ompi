...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GET_ELEMENTS_X, pmpi_get_elements_x, pmpi_get_elements_x_,
                           pmpi_get_elements_x__, pompi_get_elements_x_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GET_ELEMENTS_X, mpi_get_elements_x, mpi_get_elements_x_,
                           mpi_get_elements_x__, ompi_get_elements_x_f,
                           (MPI_Fint * status, MPI_Fint *datatype, MPI_Count *count,
                            MPI_Fint *ierr),
                           (status, datatype, count, ierr))
#    else
