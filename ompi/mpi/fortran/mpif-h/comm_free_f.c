...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_FREE, pmpi_comm_free, pmpi_comm_free_, pmpi_comm_free__,
                           pompi_comm_free_f, (MPI_Fint * comm, MPI_Fint *ierr), (comm, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_FREE, mpi_comm_free, mpi_comm_free_, mpi_comm_free__,
                           ompi_comm_free_f, (MPI_Fint * comm, MPI_Fint *ierr), (comm, ierr))
#    else
