...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_PCONTROL, pmpi_pcontrol, pmpi_pcontrol_, pmpi_pcontrol__,
                           pompi_pcontrol_f, (MPI_Fint * level), (level))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_PCONTROL, mpi_pcontrol, mpi_pcontrol_, mpi_pcontrol__,
                           ompi_pcontrol_f, (MPI_Fint * level), (level))
#    else
