...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_DUP, pmpi_type_dup, pmpi_type_dup_, pmpi_type_dup__,
                           pompi_type_dup_f, (MPI_Fint * type, MPI_Fint *newtype, MPI_Fint *ierr),
                           (type, newtype, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_DUP, mpi_type_dup, mpi_type_dup_, mpi_type_dup__,
                           ompi_type_dup_f, (MPI_Fint * type, MPI_Fint *newtype, MPI_Fint *ierr),
                           (type, newtype, ierr))
#    else
