...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_SET_ERRHANDLER, pmpi_comm_set_errhandler,
...
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_SET_ERRHANDLER, mpi_comm_set_errhandler,
                           mpi_comm_set_errhandler_, mpi_comm_set_errhandler__,
...
void ompi_comm_set_errhandler_f(MPI_Fint *comm, MPI_Fint *errhandler, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
