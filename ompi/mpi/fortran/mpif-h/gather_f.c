...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GATHER, pmpi_gather, pmpi_gather_, pmpi_gather__, pompi_gather_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GATHER, mpi_gather, mpi_gather_, mpi_gather__, ompi_gather_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                            MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm,
...
void ompi_gather_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                   MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                   MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Gather(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
