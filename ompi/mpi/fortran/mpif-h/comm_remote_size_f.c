...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_REMOTE_SIZE, pmpi_comm_remote_size, pmpi_comm_remote_size_,
                           pmpi_comm_remote_size__, pompi_comm_remote_size_f,
                           (MPI_Fint * comm, MPI_Fint *size, MPI_Fint *ierr), (comm, size, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_REMOTE_SIZE, mpi_comm_remote_size, mpi_comm_remote_size_,
                           mpi_comm_remote_size__, ompi_comm_remote_size_f,
                           (MPI_Fint * comm, MPI_Fint *size, MPI_Fint *ierr), (comm, size, ierr))
#    else
