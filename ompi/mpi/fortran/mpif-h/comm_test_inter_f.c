...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_TEST_INTER, pmpi_comm_test_inter, pmpi_comm_test_inter_,
                           pmpi_comm_test_inter__, pompi_comm_test_inter_f,
...
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_TEST_INTER, mpi_comm_test_inter, mpi_comm_test_inter_,
                           mpi_comm_test_inter__, ompi_comm_test_inter_f,
                           (MPI_Fint * comm, ompi_fortran_logical_t *flag, MPI_Fint *ierr),
                           (comm, flag, ierr))
#    else
