...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_QUERY_THREAD, pmpi_query_thread, pmpi_query_thread_,
                           pmpi_query_thread__, pompi_query_thread_f,
                           (MPI_Fint * provided, MPI_Fint *ierr), (provided, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_QUERY_THREAD, mpi_query_thread, mpi_query_thread_,
                           mpi_query_thread__, ompi_query_thread_f,
                           (MPI_Fint * provided, MPI_Fint *ierr), (provided, ierr))
#    else
