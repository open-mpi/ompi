...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ISCATTERV, pmpi_iscatterv, pmpi_iscatterv_, pmpi_iscatterv__,
                           pompi_iscatterv_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ISCATTERV, mpi_iscatterv, mpi_iscatterv_, mpi_iscatterv__,
                           ompi_iscatterv_f,
                           (char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *displs,
                            MPI_Fint *sendtype, char *recvbuf, MPI_Fint *recvcount,
                            MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *request,
...
void ompi_iscatterv_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *displs, MPI_Fint *sendtype,
                      ...
                      MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Iscatterv(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
                            OMPI_ARRAY_NAME_CONVERT(displs), c_sendtype, recvbuf,
                            OMPI_FINT_2_INT(*recvcount), c_recvtype, OMPI_FINT_2_INT(*root), c_comm,
                            &c_request);
    if (NULL != ierr)
