...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_TYPE_EXTENT, pmpi_file_get_type_extent,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_TYPE_EXTENT, mpi_file_get_type_extent,
                           mpi_file_get_type_extent_, mpi_file_get_type_extent__,
...
void ompi_file_get_type_extent_f(MPI_Fint *fh, MPI_Fint *datatype, MPI_Aint *extent, MPI_Fint *ierr)
{
    int c_ierr;
