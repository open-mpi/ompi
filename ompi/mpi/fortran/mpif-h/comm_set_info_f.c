...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_SET_INFO, pmpi_comm_set_info, pmpi_comm_set_info_,
                           pmpi_comm_set_info__, pompi_comm_set_info_f,
                           (MPI_Fint * comm, MPI_Fint *info, MPI_Fint *ierr), (comm, info, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_SET_INFO, mpi_comm_set_info, mpi_comm_set_info_,
                           mpi_comm_set_info__, ompi_comm_set_info_f,
                           (MPI_Fint * comm, MPI_Fint *info, MPI_Fint *ierr), (comm, info, ierr))
#    else
