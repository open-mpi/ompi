...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GRAPH_NEIGHBORS, pmpi_graph_neighbors, pmpi_graph_neighbors_,
                           pmpi_graph_neighbors__, pompi_graph_neighbors_f,
                           (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *maxneighbors,
...
OMPI_GENERATE_F77_BINDINGS(MPI_GRAPH_NEIGHBORS, mpi_graph_neighbors, mpi_graph_neighbors_,
                           mpi_graph_neighbors__, ompi_graph_neighbors_f,
                           (MPI_Fint * comm, MPI_Fint *rank, MPI_Fint *maxneighbors,
                            MPI_Fint *neighbors, MPI_Fint *ierr),
                           (comm, rank, maxneighbors, neighbors, ierr))
#    else
...
void ompi_graph_neighbors_f(MPI_Fint *comm, MPI_Fint *rank, MPI_Fint *maxneighbors,
                            MPI_Fint *neighbors, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
    ...
    c_ierr = PMPI_Graph_neighbors(c_comm, OMPI_FINT_2_INT(*rank), OMPI_FINT_2_INT(*maxneighbors),
