...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_COMM_JOIN, pmpi_comm_join, pmpi_comm_join_, pmpi_comm_join__,
                           pompi_comm_join_f, (MPI_Fint * fd, MPI_Fint *intercomm, MPI_Fint *ierr),
                           (fd, intercomm, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_COMM_JOIN, mpi_comm_join, mpi_comm_join_, mpi_comm_join__,
                           ompi_comm_join_f, (MPI_Fint * fd, MPI_Fint *intercomm, MPI_Fint *ierr),
                           (fd, intercomm, ierr))
#    else
