...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_IBSEND, pmpi_ibsend, pmpi_ibsend_, pmpi_ibsend__, pompi_ibsend_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_IBSEND, mpi_ibsend, mpi_ibsend_, mpi_ibsend__, ompi_ibsend_f,
                           (char *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest,
                            MPI_Fint *tag, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr),
                           (buf, count, datatype, dest, tag, comm, request, ierr))
#    else
...
void ompi_ibsend_f(char *buf, MPI_Fint *count, MPI_Fint *datatype, MPI_Fint *dest, MPI_Fint *tag,
                   MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Ibsend(OMPI_F2C_BOTTOM(buf), OMPI_FINT_2_INT(*count), c_type,
