...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_ABORT, pmpi_abort, pmpi_abort_, pmpi_abort__, pompi_abort_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_ABORT, mpi_abort, mpi_abort_, mpi_abort__, ompi_abort_f,
                           (MPI_Fint * comm, MPI_Fint *errorcode, MPI_Fint *ierr),
                           (comm, errorcode, ierr))
#    else
