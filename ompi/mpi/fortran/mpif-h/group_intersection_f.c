...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_GROUP_INTERSECTION, pmpi_group_intersection,
                           pmpi_group_intersection_, pmpi_group_intersection__,
                           pompi_group_intersection_f,
                           (MPI_Fint * group1, MPI_Fint *group2, MPI_Fint *newgroup,
                            MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_GROUP_INTERSECTION, mpi_group_intersection, mpi_group_intersection_,
                           mpi_group_intersection__, ompi_group_intersection_f,
                           (MPI_Fint * group1, MPI_Fint *group2, MPI_Fint *newgroup,
                            MPI_Fint *ierr),
                           (group1, group2, newgroup, ierr))
#    else
...
void ompi_group_intersection_f(MPI_Fint *group1, MPI_Fint *group2, MPI_Fint *newgroup,
                               MPI_Fint *ierr)
{
    int c_ierr;
