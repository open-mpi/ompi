...
#pragma weak PMPI_REQUEST_GET_STATUS_SOME = ompi_request_get_status_some_f
#pragma weak pmpi_request_get_status_some = ompi_request_get_status_some_f
#pragma weak pmpi_request_get_status_some_ = ompi_request_get_status_some_f
#pragma weak pmpi_request_get_status_some__ = ompi_request_get_status_some_f

#pragma weak PMPI_Request_get_status_some_f = ompi_request_get_status_some_f
#pragma weak PMPI_Request_get_status_some_f08 = ompi_request_get_status_some_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_REQUEST_GET_STATUS_SOME,
...
#if OPAL_HAVE_WEAK_SYMBOLS
#pragma weak MPI_REQUEST_GET_STATUS_SOME = ompi_request_get_status_some_f
#pragma weak mpi_request_get_status_some = ompi_request_get_status_some_f
#pragma weak mpi_request_get_status_some_ = ompi_request_get_status_some_f
#pragma weak mpi_request_get_status_some__ = ompi_request_get_status_some_f
...
static const char FUNC_NAME[] = "MPI_REQUEST_GET_STATUS_SOME";


void ompi_request_get_status_some_f(MPI_Fint *incount, MPI_Fint *array_of_requests,
                    ...
                    MPI_Fint *array_of_statuses, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Request_get_status_some(OMPI_FINT_2_INT(*incount), c_req,
