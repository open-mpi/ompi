...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_IGATHER, pmpi_igather, pmpi_igather_, pmpi_igather__, pompi_igather_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_IGATHER, mpi_igather, mpi_igather_, mpi_igather__, ompi_igather_f,
...
void ompi_igather_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                    MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                    MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_Igather(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
