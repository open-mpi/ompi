...
#pragma weak pmpi_reduce_init__ = ompi_reduce_init_f

#pragma weak PMPI_Reduce_init_f = ompi_reduce_init_f
#pragma weak PMPI_Reduce_init_f08 = ompi_reduce_init_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_REDUCE_INIT,
                            pmpi_reduce_init,
                            pmpi_reduce_init_,
                            pmpi_reduce_init__,
                            pompi_reduce_init_f,
...
#pragma weak mpi_reduce_init__ = ompi_reduce_init_f
...
void ompi_reduce_init_f(char *sendbuf, char *recvbuf, MPI_Fint *count,
                        ...
                        MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Reduce_init(sendbuf, recvbuf,
