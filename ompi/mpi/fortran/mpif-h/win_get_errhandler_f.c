...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_GET_ERRHANDLER, pmpi_win_get_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_GET_ERRHANDLER, mpi_win_get_errhandler, mpi_win_get_errhandler_,
                           mpi_win_get_errhandler__, ompi_win_get_errhandler_f,
                           (MPI_Fint * win, MPI_Fint *errhandler, MPI_Fint *ierr),
                           (win, errhandler, ierr))
#    else
...
void ompi_win_get_errhandler_f(MPI_Fint *win, MPI_Fint *errhandler, MPI_Fint *ierr)
{
    int c_ierr;
