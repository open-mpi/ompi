...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_INDEXED, pmpi_type_indexed, pmpi_type_indexed_,
                           pmpi_type_indexed__, pompi_type_indexed_f,
...
OMPI_GENERATE_F77_BINDINGS(
    MPI_TYPE_INDEXED, mpi_type_indexed, mpi_type_indexed_, mpi_type_indexed__, ompi_type_indexed_f,
                         ...
                         MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Type_indexed(OMPI_FINT_2_INT(*count),
                               ...
                               OMPI_ARRAY_NAME_CONVERT(array_of_displacements), c_old, &c_new);
    if (NULL != ierr)
