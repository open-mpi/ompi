...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_GET_ERRHANDLER, pmpi_file_get_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_GET_ERRHANDLER, mpi_file_get_errhandler,
                           mpi_file_get_errhandler_, mpi_file_get_errhandler__,
