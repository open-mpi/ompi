...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_WIN_SET_ERRHANDLER, pmpi_win_set_errhandler,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_WIN_SET_ERRHANDLER, mpi_win_set_errhandler, mpi_win_set_errhandler_,
                           mpi_win_set_errhandler__, ompi_win_set_errhandler_f,
                           (MPI_Fint * win, MPI_Fint *errhandler, MPI_Fint *ierr),
                           (win, errhandler, ierr))
#    else
...
void ompi_win_set_errhandler_f(MPI_Fint *win, MPI_Fint *errhandler, MPI_Fint *ierr)
{
    int c_ierr;
