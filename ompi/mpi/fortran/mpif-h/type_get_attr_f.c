...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_TYPE_GET_ATTR, pmpi_type_get_attr, pmpi_type_get_attr_,
                           pmpi_type_get_attr__, pompi_type_get_attr_f,
                           (MPI_Fint * type, MPI_Fint *type_keyval, MPI_Aint *attribute_val,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_TYPE_GET_ATTR, mpi_type_get_attr, mpi_type_get_attr_,
                           mpi_type_get_attr__, ompi_type_get_attr_f,
                           (MPI_Fint * type, MPI_Fint *type_keyval, MPI_Aint *attribute_val,
                            ompi_fortran_logical_t *flag, MPI_Fint *ierr),
                           (type, type_keyval, attribute_val, flag, ierr))
#    else
...
void ompi_type_get_attr_f(MPI_Fint *type, MPI_Fint *type_keyval, MPI_Aint *attribute_val,
                          ompi_fortran_logical_t *flag, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = ompi_attr_get_aint(c_type->d_keyhash, OMPI_FINT_2_INT(*type_keyval), attribute_val,
