...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_CLOSE, pmpi_file_close, pmpi_file_close_, pmpi_file_close__,
                           pompi_file_close_f, (MPI_Fint * fh, MPI_Fint *ierr), (fh, ierr))
#    endif
#endif
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_CLOSE, mpi_file_close, mpi_file_close_, mpi_file_close__,
                           ompi_file_close_f, (MPI_Fint * fh, MPI_Fint *ierr), (fh, ierr))
#    else
