...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_PACK_SIZE, pmpi_pack_size, pmpi_pack_size_, pmpi_pack_size__,
                           pompi_pack_size_f,
                           (MPI_Fint * incount, MPI_Fint *datatype, MPI_Fint *comm, MPI_Fint *size,
                            MPI_Fint *ierr),
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_PACK_SIZE, mpi_pack_size, mpi_pack_size_, mpi_pack_size__,
                           ompi_pack_size_f,
                           (MPI_Fint * incount, MPI_Fint *datatype, MPI_Fint *comm, MPI_Fint *size,
                            MPI_Fint *ierr),
                           (incount, datatype, comm, size, ierr))
...
void ompi_pack_size_f(MPI_Fint *incount, MPI_Fint *datatype, MPI_Fint *comm, MPI_Fint *size,
                      MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Comm c_comm;
    ...
    c_ierr = PMPI_Pack_size(OMPI_FINT_2_INT(*incount), c_type, c_comm,
