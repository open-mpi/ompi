...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_WAITSOME, pmpi_waitsome, pmpi_waitsome_, pmpi_waitsome__, pompi_waitsome_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_WAITSOME, mpi_waitsome, mpi_waitsome_, mpi_waitsome__, ompi_waitsome_f,
    (MPI_Fint * incount, MPI_Fint *array_of_requests, MPI_Fint *outcount,
     MPI_Fint *array_of_indices, MPI_Fint *array_of_statuses, MPI_Fint *ierr),
    (incount, array_of_requests, outcount, array_of_indices, array_of_statuses, ierr))
#    else
...
void ompi_waitsome_f(MPI_Fint *incount, MPI_Fint *array_of_requests, MPI_Fint *outcount,
                     MPI_Fint *array_of_indices, MPI_Fint *array_of_statuses, MPI_Fint *ierr)
{
    int c_ierr;
    MPI_Request *c_req;
    ...
    c_ierr = PMPI_Waitsome(OMPI_FINT_2_INT(*incount), c_req, OMPI_SINGLE_NAME_CONVERT(outcount),
