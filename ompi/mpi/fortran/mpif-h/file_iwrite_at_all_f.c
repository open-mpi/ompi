...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPI_FILE_IWRITE_AT_ALL, pmpi_file_iwrite_at_all,
                           pmpi_file_iwrite_at_all_, pmpi_file_iwrite_at_all__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPI_FILE_IWRITE_AT_ALL, mpi_file_iwrite_at_all, mpi_file_iwrite_at_all_,
                           mpi_file_iwrite_at_all__, ompi_file_iwrite_at_all_f,
                           (MPI_Fint * fh, MPI_Offset *offset, char *buf, MPI_Fint *count,
                            MPI_Fint *datatype, MPI_Fint *request, MPI_Fint *ierr),
                           (fh, offset, buf, count, datatype, request, ierr))
#    else
...
void ompi_file_iwrite_at_all_f(MPI_Fint *fh, MPI_Offset *offset, char *buf, MPI_Fint *count,
                               MPI_Fint *datatype, MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPI_File_iwrite_at_all(c_fh, (MPI_Offset) *offset, OMPI_F2C_BOTTOM(buf),
