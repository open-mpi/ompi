...
OMPI_GENERATE_F77_BINDINGS(
    PMPI_ISCATTER, pmpi_iscatter, pmpi_iscatter_, pmpi_iscatter__, pompi_iscatter_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPI_ISCATTER, mpi_iscatter, mpi_iscatter_, mpi_iscatter__, ompi_iscatter_f,
    (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf, MPI_Fint *recvcount,
     MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *request, MPI_Fint *ierr),
    (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, request, ierr))
#    else
...
void ompi_iscatter_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                     ...
                     MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPI_Iscatter(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
