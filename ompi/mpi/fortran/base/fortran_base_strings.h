 ...
 */
OMPI_DECLSPEC int ompi_fortran_argv_blank_f2c(char *farray, int string_len, int advancex,
                                              char ***cargv);
 ...
 * array itself
 */
OMPI_DECLSPEC int ompi_fortran_multiple_argvs_f2c(int count, char *array, int len, char ****argv);
