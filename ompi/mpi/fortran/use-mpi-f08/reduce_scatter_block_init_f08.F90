...
subroutine MPI_Reduce_scatter_block_init_f08(sendbuf,recvbuf,recvcount,datatype,op,comm,info,request,ierror)
   use :: mpi_f08_types, only : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
   use :: ompi_mpifh_bindings, only : ompi_reduce_scatter_block_init_f
   implicit none
   ...
   call ompi_reduce_scatter_block_init_f(sendbuf,recvbuf,recvcount,&
