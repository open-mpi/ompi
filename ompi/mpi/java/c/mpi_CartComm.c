...
{
    ompi_java.CartParmsInit = (*env)->GetMethodID(env, ompi_java.CartParmsClass, "<init>",
                                                  "([I[Z[I)V");

    ompi_java.ShiftParmsInit = (*env)->GetMethodID(env, ompi_java.ShiftParmsClass, "<init>",
                                                   "(II)V");
}

JNIEXPORT jobject JNICALL Java_mpi_CartComm_getTopo(JNIEnv *env, jobject jthis, jlong comm)
{
    int maxdims;
    ...
    return (*env)->NewObject(env, ompi_java.CartParmsClass, ompi_java.CartParmsInit, dims, periods,
                             coords);
}

JNIEXPORT jobject JNICALL Java_mpi_CartComm_shift(JNIEnv *env, jobject jthis, jlong comm,
                                                  jint direction, jint disp)
{
    ...
    return (*env)->NewObject(env, ompi_java.ShiftParmsClass, ompi_java.ShiftParmsInit, sr, dr);
}

JNIEXPORT jintArray JNICALL Java_mpi_CartComm_getCoords(JNIEnv *env, jobject jthis, jlong comm,
                                                        jint rank)
{
    int maxdims;
    int rc = MPI_Cartdim_get((MPI_Comm) comm, &maxdims);
...
JNIEXPORT jint JNICALL Java_mpi_CartComm_map(JNIEnv *env, jobject jthis, jlong comm, jintArray dims,
...
JNIEXPORT jint JNICALL Java_mpi_CartComm_getRank(JNIEnv *env, jobject jthis, jlong comm,
                                                 jintArray coords)
{
    jint *jCoords;
    int *cCoords;
...
JNIEXPORT jlong JNICALL Java_mpi_CartComm_sub(JNIEnv *env, jobject jthis, jlong comm,
                                              jbooleanArray remainDims)
{
...
JNIEXPORT void JNICALL Java_mpi_CartComm_createDims_1jni(JNIEnv *env, jclass jthis, jint nNodes,
                                                         jintArray dims)
{
    int nDims = (*env)->GetArrayLength(env, dims);
    jint *jDims;
