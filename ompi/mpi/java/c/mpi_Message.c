...
JNIEXPORT jlong JNICALL Java_mpi_Message_mProbe(JNIEnv *env, jobject jthis, jint source, jint tag,
                                                jlong jComm, jlongArray jStatus)
{
...
JNIEXPORT jobject JNICALL Java_mpi_Message_imProbe(JNIEnv *env, jobject jthis, jint source,
                                                   jint tag, jlong jComm)
{
    MPI_Comm comm = (MPI_Comm) jComm;
    MPI_Message message;
    MPI_Status status;
...
JNIEXPORT jlong JNICALL Java_mpi_Message_mRecv(JNIEnv *env, jobject jthis, jlong jMessage,
                                               jobject buf, jboolean db, jint off, jint count,
                                               jlong jType, jint bType, jlongArray jStatus)
{
...
JNIEXPORT jlong JNICALL Java_mpi_Message_imRecv(JNIEnv *env, jobject jthis, jlong jMessage,
