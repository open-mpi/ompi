...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_split(JNIEnv *env, jobject jthis, jlong comm,
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_splitType(JNIEnv *env, jobject jthis, jlong comm,
                                                     jint splitType, jint key, jlong info)
{
    MPI_Comm newcomm;
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_create(JNIEnv *env, jobject jthis, jlong comm,
                                                  jlong group)
{
    MPI_Comm newcomm;
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_createGroup(JNIEnv *env, jobject jthis, jlong comm,
                                                       jlong group, int tag)
{
    MPI_Comm newcomm;
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_createCart(JNIEnv *env, jobject jthis, jlong comm,
                                                      ...
                                                      jboolean reorder)
{
    ...
    int rc = MPI_Cart_create((MPI_Comm) comm, ndims, cDims, cPeriods, reorder, &cart);
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_createGraph(JNIEnv *env, jobject jthis, jlong comm,
                                                       ...
                                                       jboolean reorder)
{
    ...
    int rc = MPI_Graph_create((MPI_Comm) comm, nnodes, cIndex, cEdges, reorder, &graph);
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_createDistGraph(JNIEnv *env, jobject jthis, jlong comm,
                                                           jintArray sources, jintArray degrees,
                                                           jintArray destins, jintArray weights,
                                                           jlong info, jboolean reorder,
                                                           jboolean weighted)
{
    MPI_Comm graph;
    ...
    int rc = MPI_Dist_graph_create((MPI_Comm) comm, nnodes, cSources, cDegrees, cDestins, cWeights,
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_createDistGraphAdjacent(
    JNIEnv *env, jobject jthis, jlong comm, jintArray sources, jintArray srcWeights,
    jintArray destins, jintArray desWeights, jlong info, jboolean reorder, jboolean weighted)
{
    MPI_Comm graph;
    ...
    int rc = MPI_Dist_graph_create_adjacent((MPI_Comm) comm, inDegree, cSources, cSrcWeights,
                                            outDegree, cDestins, cDesWeights, (MPI_Info) info,
                                            reorder, &graph);
...
JNIEXPORT void JNICALL Java_mpi_Intracomm_scan(JNIEnv *env, jobject jthis, jlong jComm,
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_iScan(JNIEnv *env, jobject jthis, jlong comm,
                                                 ...
                                                 jlong type, int baseType, jobject jOp, jlong hOp)
{
    ...
    int rc = MPI_Iscan(sPtr, rPtr, count, (MPI_Datatype) type,
                       ompi_java_op_getHandle(env, jOp, hOp, baseType), (MPI_Comm) comm, &request);

    ompi_java_exceptionCheck(env, rc);
    return (jlong) request;
}

JNIEXPORT void JNICALL Java_mpi_Intracomm_exScan(JNIEnv *env, jobject jthis, jlong jComm,
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_iExScan(JNIEnv *env, jobject jthis, jlong comm,
                                                   jobject sendBuf, jobject recvBuf, jint count,
                                                   jlong type, int bType, jobject jOp, jlong hOp)
{
    ...
    int rc = MPI_Iexscan(sPtr, rPtr, count, (MPI_Datatype) type,
                         ompi_java_op_getHandle(env, jOp, hOp, bType), (MPI_Comm) comm, &request);

    ompi_java_exceptionCheck(env, rc);
    return (jlong) request;
}

JNIEXPORT jstring JNICALL Java_mpi_Intracomm_openPort(JNIEnv *env, jclass clazz, jlong info)
{
    char port[MPI_MAX_PORT_NAME + 1];
    int rc = MPI_Open_port((MPI_Info) info, port);

    return ompi_java_exceptionCheck(env, rc) ? NULL : (*env)->NewStringUTF(env, port);
}

JNIEXPORT void JNICALL Java_mpi_Intracomm_closePort_1jni(JNIEnv *env, jclass clazz, jstring jport)
{
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_accept(JNIEnv *env, jobject jthis, jlong comm,
                                                  jstring jport, jlong info, jint root)
{
    const char *port = jport == NULL ? NULL : (*env)->GetStringUTFChars(env, jport, NULL);
    MPI_Comm newComm;

    int rc = MPI_Comm_accept((char *) port, (MPI_Info) info, root, (MPI_Comm) comm, &newComm);
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_connect(JNIEnv *env, jobject jthis, jlong comm,
                                                   jstring jport, jlong info, jint root)
{
    const char *port = jport == NULL ? NULL : (*env)->GetStringUTFChars(env, jport, NULL);
    MPI_Comm newComm;

    int rc = MPI_Comm_connect((char *) port, (MPI_Info) info, root, (MPI_Comm) comm, &newComm);
...
JNIEXPORT void JNICALL Java_mpi_Intracomm_publishName(JNIEnv *env, jclass clazz, jstring jservice,
                                                      jlong info, jstring jport)
{
...
JNIEXPORT void JNICALL Java_mpi_Intracomm_unpublishName(JNIEnv *env, jclass clazz, jstring jservice,
                                                        jlong info, jstring jport)
{
    const char *service = (*env)->GetStringUTFChars(env, jservice, NULL),
               *port = (*env)->GetStringUTFChars(env, jport, NULL);
...
JNIEXPORT jstring JNICALL Java_mpi_Intracomm_lookupName(JNIEnv *env, jclass clazz, jstring jservice,
                                                        jlong info)
{
    char port[MPI_MAX_PORT_NAME + 1];
    const char *service = (*env)->GetStringUTFChars(env, jservice, NULL);
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_spawn(JNIEnv *env, jobject jthis, jlong comm,
                                                 jstring jCommand, jobjectArray jArgv,
                                                 jint maxprocs, jlong info, jint root,
                                                 jintArray errCodes)
{
    int i, rc;
    MPI_Comm intercomm;
    ...
    rc = MPI_Comm_spawn((char *) command, argv, maxprocs, (MPI_Info) info, root, (MPI_Comm) comm,
                        &intercomm, cErrCodes);
...
JNIEXPORT jlong JNICALL Java_mpi_Intracomm_spawnMultiple(JNIEnv *env, jobject jthis, jlong comm,
                                                         jobjectArray jCommands, jobjectArray jArgv,
                                                         jintArray maxProcs, jlongArray info,
                                                         jint root, jintArray errCodes)
{
    ...
    char **commands = calloc(commandsLength, sizeof(char *)), ***argv = MPI_ARGVS_NULL;
    ...
    rc = MPI_Comm_spawn_multiple(commandsLength, commands, argv, cMaxProcs, cInfo, root,
                                 (MPI_Comm) comm, &intercomm, cErrCodes);
