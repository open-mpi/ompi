...
{
    jobjectArray array = (*env)->NewObjectArray(env, count, ompi_java.StatusClass, NULL);
    int i;
    for (i = 0; i < count; i++) {
...
static jobjectArray newStatusesIndices(JNIEnv *env, MPI_Status *statuses, int *indices, int count)
{
    if (count < 0)
        return NULL;
...
JNIEXPORT void JNICALL Java_mpi_Request_cancel(JNIEnv *env, jobject jthis, jlong handle)
{
...
JNIEXPORT jlong JNICALL Java_mpi_Request_free(JNIEnv *env, jobject jthis, jlong handle)
{
    MPI_Request req = (MPI_Request) handle;
...
JNIEXPORT jlong JNICALL Java_mpi_Request_waitStatus(JNIEnv *env, jobject jthis, jlong handle,
                                                    jlongArray stat)
{
    MPI_Request req = (MPI_Request) handle;
    MPI_Status status;
...
JNIEXPORT jlong JNICALL Java_mpi_Request_waitFor(JNIEnv *env, jobject jthis, jlong handle)
{
    MPI_Request req = (MPI_Request) handle;
...
JNIEXPORT jobject JNICALL Java_mpi_Request_testStatus(JNIEnv *env, jobject jthis, jlong handle)
{
    MPI_Request req = (MPI_Request) handle;
    int flag;
    MPI_Status status;
...
JNIEXPORT jobject JNICALL Java_mpi_Request_getStatus(JNIEnv *env, jobject jthis, jlong handle)
{
    MPI_Request req = (MPI_Request) handle;
    int flag;
    MPI_Status status;
...
JNIEXPORT jboolean JNICALL Java_mpi_Request_test(JNIEnv *env, jobject jthis, jlong handle)
{
    MPI_Request req = (MPI_Request) handle;
    int flag;
...
JNIEXPORT void JNICALL Java_mpi_Request_waitAnyStatus(JNIEnv *env, jclass clazz,
                                                      jlongArray requests, jobject stat)
{
    jboolean exception;
...
JNIEXPORT jint JNICALL Java_mpi_Request_waitAny(JNIEnv *env, jclass clazz, jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
    MPI_Request *cReq;
...
JNIEXPORT jobject JNICALL Java_mpi_Request_testAnyStatus(JNIEnv *env, jclass clazz,
                                                         jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
...
JNIEXPORT jint JNICALL Java_mpi_Request_testAny(JNIEnv *env, jclass clazz, jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
    MPI_Request *cReq;
...
JNIEXPORT jobjectArray JNICALL Java_mpi_Request_waitAllStatus(JNIEnv *env, jclass clazz,
                                                              jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
...
JNIEXPORT void JNICALL Java_mpi_Request_waitAll(JNIEnv *env, jclass jthis, jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
    MPI_Request *cReq;
...
JNIEXPORT jobjectArray JNICALL Java_mpi_Request_testAllStatus(JNIEnv *env, jclass clazz,
                                                              jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
...
JNIEXPORT jboolean JNICALL Java_mpi_Request_testAll(JNIEnv *env, jclass jthis, jlongArray requests)
{
    int count = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
    MPI_Request *cReq;
...
JNIEXPORT jobjectArray JNICALL Java_mpi_Request_waitSomeStatus(JNIEnv *env, jclass clazz,
                                                               jlongArray requests)
{
...
JNIEXPORT jintArray JNICALL Java_mpi_Request_waitSome(JNIEnv *env, jclass clazz,
                                                      jlongArray requests)
{
    jboolean exception;
    int incount = (*env)->GetArrayLength(env, requests);
...
JNIEXPORT jobjectArray JNICALL Java_mpi_Request_testSomeStatus(JNIEnv *env, jclass clazz,
                                                               jlongArray requests)
{
    int incount = (*env)->GetArrayLength(env, requests);
    jlong *jReq;
...
JNIEXPORT jintArray JNICALL Java_mpi_Request_testSome(JNIEnv *env, jclass clazz,
                                                      jlongArray requests)
{
    jboolean exception;
    int incount = (*env)->GetArrayLength(env, requests);
