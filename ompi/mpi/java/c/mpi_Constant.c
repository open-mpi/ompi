...
JNIEXPORT void JNICALL Java_mpi_Constant_setConstant(JNIEnv *env, jobject obj)
{
    ...
    ompi_java_setIntField(env, c, obj, "ERR_UNSUPPORTED_DATAREP", MPI_ERR_UNSUPPORTED_DATAREP);

    ompi_java_setIntField(env, c, obj, "ERR_UNSUPPORTED_OPERATION", MPI_ERR_UNSUPPORTED_OPERATION);
