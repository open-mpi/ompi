...
{
    ompi_java_setStaticLongField(env, clazz, "nullHandle", (jlong) MPI_GROUP_NULL);
...
JNIEXPORT jint JNICALL Java_mpi_Group_getSize(JNIEnv *env, jobject jthis, jlong group)
{
    int size, rc;
...
JNIEXPORT jint JNICALL Java_mpi_Group_getRank(JNIEnv *env, jobject jthis, jlong group)
{
    int rank, rc;
...
JNIEXPORT jlong JNICALL Java_mpi_Group_free(JNIEnv *env, jobject jthis, jlong handle)
{
...
JNIEXPORT jintArray JNICALL Java_mpi_Group_translateRanks(JNIEnv *env, jclass jthis, jlong group1,
                                                          jintArray ranks1, jlong group2)
{
    ...
    int rc = MPI_Group_translate_ranks((MPI_Group) group1, n, cRanks1, (MPI_Group) group2, cRanks2);
    ompi_java_exceptionCheck(env, rc);
...
JNIEXPORT jint JNICALL Java_mpi_Group_compare(JNIEnv *env, jclass jthis, jlong group1, jlong group2)
{
    int result, rc;
...
JNIEXPORT jlong JNICALL Java_mpi_Group_union(JNIEnv *env, jclass jthis, jlong group1, jlong group2)
{
    MPI_Group newGroup;
...
JNIEXPORT jlong JNICALL Java_mpi_Group_intersection(JNIEnv *env, jclass jthis, jlong group1,
                                                    jlong group2)
{
    MPI_Group newGroup;

    int rc = MPI_Group_intersection((MPI_Group) group1, (MPI_Group) group2, &newGroup);

    ompi_java_exceptionCheck(env, rc);
    return (jlong) newGroup;
}

JNIEXPORT jlong JNICALL Java_mpi_Group_difference(JNIEnv *env, jclass jthis, jlong group1,
                                                  jlong group2)
{
    MPI_Group newGroup;

    int rc = MPI_Group_difference((MPI_Group) group1, (MPI_Group) group2, &newGroup);

    ompi_java_exceptionCheck(env, rc);
    return (jlong) newGroup;
}

JNIEXPORT jlong JNICALL Java_mpi_Group_incl(JNIEnv *env, jobject jthis, jlong group,
                                            jintArray ranks)
{
...
JNIEXPORT jlong JNICALL Java_mpi_Group_excl(JNIEnv *env, jobject jthis, jlong group,
                                            jintArray ranks)
{
    jsize n = (*env)->GetArrayLength(env, ranks);
    jint *jRanks;
...
JNIEXPORT jlong JNICALL Java_mpi_Group_rangeIncl(JNIEnv *env, jobject jthis, jlong group,
                                                 jobjectArray ranges)
{
    int i;
    MPI_Group newGroup;
...
JNIEXPORT jlong JNICALL Java_mpi_Group_rangeExcl(JNIEnv *env, jobject jthis, jlong group,
                                                 jobjectArray ranges)
{
    int i;
    MPI_Group newGroup;
