...
def main():
    ...
    parser_converters = subparsers_c.add_parser('converters', help='generate converter header file or source file')
    parser_converters.add_argument('--type', choices=('include_file', 'source_file'),
