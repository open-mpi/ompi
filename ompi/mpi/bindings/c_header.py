...
# ============================= Constants / Globals ============================
# Shared with the main binding generator via consts, so that the two cannot
# drift apart.  Applied here by pattern substitution (rather than through
# util.abi_internal_name()) because this generator mangles names inside
# already-rendered pympistandard text.
ABI_INTERNAL = consts.ABI_INTERNAL_SUFFIX
...
# The MPI Forum has deprecated or removed these, so they are absent from the
# MPI Forum ABI and are pruned from the generated header (see the comment near
# their use, below).  Shared with the main binding generator via consts so that
# the two cannot drift apart.
DEPRECATED_FUNCTIONS = consts.DEPRECATED_FUNCTIONS
