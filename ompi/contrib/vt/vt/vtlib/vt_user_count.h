...
#define VT_COUNT_TYPE_REAL       13
  ...
  __VT_EXTERN_DECL unsigned int VT_User_count_def__(const char* cname, const char* cunit, int ctype,
                                                    unsigned int gid);
  __VT_EXTERN_DECL void VT_User_count_signed_val__(unsigned int cid, long long val);
  __VT_EXTERN_DECL void VT_User_count_unsigned_val__(unsigned int cid, unsigned long long val);
  __VT_EXTERN_DECL void VT_User_count_float_val__(unsigned int cid, float val);
  __VT_EXTERN_DECL void VT_User_count_double_val__(unsigned int cid, double val);
