...
def handleDefFunction_Stage_1( fha, stream, func, name, group, source ):
...
def handleDefFunctionGroup_Stage_1( fha, stream, group, name ):
...
def handleDefFunction_Stage_2( fha, stream, func, name, group, source ):
...
def handleDefFunctionGroup_Stage_2( fha, stream, group, name ):
