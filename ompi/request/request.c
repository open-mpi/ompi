...
OBJ_CLASS_INSTANCE(ompi_request_t, opal_free_list_item_t, ompi_request_construct,
...
int ompi_request_init(void)
{
    ...
    if (OPAL_SUCCESS
        != opal_pointer_array_init(&ompi_request_f_to_c_table, 0, OMPI_FORTRAN_HANDLE_MAX, 32)) {
        return OMPI_ERROR;
    }
    ...
    ompi_request_null.request.req_f_to_c_index = opal_pointer_array_add(&ompi_request_f_to_c_table,
                                                                        &ompi_request_null);
    ...
    ompi_request_empty.req_f_to_c_index = opal_pointer_array_add(&ompi_request_f_to_c_table,
                                                                 &ompi_request_empty);
