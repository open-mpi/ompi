...
OBJ_CLASS_INSTANCE(ompi_errcode_intern_t, opal_object_t, ompi_errcode_intern_construct,
...
int ompi_errcode_intern_init(void)
{
    ...
    if (OPAL_SUCCESS
        != opal_pointer_array_init(&ompi_errcodes_intern, 0, OMPI_FORTRAN_HANDLE_MAX, 64)) {
        return OMPI_ERROR;
    }
    ...
    opal_string_copy(ompi_success_intern.errstring, "OMPI_SUCCESS", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_error_intern.errstring, "OMPI_ERROR", OMPI_MAX_ERROR_STRING);
    opal_pointer_array_set_item(&ompi_errcodes_intern, ompi_error_intern.index, &ompi_error_intern);
    ...
    opal_string_copy(ompi_err_out_of_resource_intern.errstring, "OMPI_ERR_OUT_OF_RESOURCE",
    ...
    opal_string_copy(ompi_err_resource_busy_intern.errstring, "OMPI_ERR_RESOURCE_BUSY",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_bad_param_intern.errstring, "OMPI_ERR_BAD_PARAM",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_fatal_intern.errstring, "OMPI_ERR_FATAL", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_not_implemented_intern.errstring, "OMPI_ERR_NOT_IMPLEMENTED",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_not_supported_intern.errstring, "OMPI_ERR_NOT_SUPPORTED",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_interupted_intern.errstring, "OMPI_ERR_INTERUPTED",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_would_block_intern.errstring, "OMPI_ERR_WOULD_BLOCK",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_in_errno_intern.errstring, "OMPI_ERR_IN_ERRNO",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_unreach_intern.errstring, "OMPI_ERR_UNREACH", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_not_found_intern.errstring, "OMPI_ERR_NOT_FOUND",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_buffer_intern.errstring, "OMPI_ERR_BUFFER", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_request_intern.errstring, "OMPI_ERR_REQUEST", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_sync_intern.errstring, "OMPI_ERR_RMA_SYNC",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_shared_intern.errstring, "OMPI_ERR_RMA_SHARED",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_attach_intern.errstring, "OMPI_ERR_RMA_ATTACH",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_range_intern.errstring, "OMPI_ERR_RMA_RANGE",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_conflict_intern.errstring, "OMPI_ERR_RMA_CONFLICT",
                     OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_win_intern.errstring, "OMPI_ERR_WIN", OMPI_MAX_ERROR_STRING);
    ...
    opal_string_copy(ompi_err_rma_flavor_intern.errstring, "OMPI_ERR_RMA_FLAVOR",
                     OMPI_MAX_ERROR_STRING);
