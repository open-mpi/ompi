...
/*
 * Self-contained test harness for the OMPI unit tests under ompi/test/.
 * Deliberately a sibling of test/support/support.h so that the OMPI unit
 * tests build and run entirely within the ompi/ subtree (e.g. "make check"
 * run solely inside ompi/) without depending on the top-level test/ tree.
 * The API is intentionally identical to test/support/support.h.
 */

#ifndef OMPI_TEST_SUPPORT_H
#define OMPI_TEST_SUPPORT_H
