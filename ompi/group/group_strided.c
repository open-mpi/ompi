...
int ompi_group_translate_ranks_strided(ompi_group_t *parent_group, int n_ranks, const int *ranks1,
...
int ompi_group_translate_ranks_strided_reverse(ompi_group_t *child_group, int n_ranks,
...
int ompi_group_incl_strided(ompi_group_t *group, int n, const int *ranks, ompi_group_t **new_group)
{
    /* local variables */
