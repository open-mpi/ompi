...
static const ompi_spc_event_t ompi_spc_events_desc[OMPI_SPC_NUM_COUNTERS] = {
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_RPUT_NOTIFY, "The number of times MPI_Rput_notify was called.", false, false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_RGET_NOTIFY, "The number of times MPI_Rget_notify was called.", false, false),
