...
#    define SET_COUNTER_ARRAY(NAME, DESC, HWM, ITE) \
        [NAME] = {.counter_name = #NAME,            \
                  .counter_description = DESC,      \
                  .is_high_watermark = HWM,         \
                  .is_timer_event = ITE}
...
static const ompi_spc_event_t ompi_spc_events_desc[OMPI_SPC_NUM_COUNTERS] = {
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_SENDRECV, "The number of times MPI_Sendrecv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_SENDRECV_REPLACE,
                      "The number of times MPI_Sendrecv_replace was called.", false, false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_BCAST_INIT, "The number of times MPIX_Bcast_init was called.", false,
                      false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_REDUCE_SCATTER, "The number of times MPI_Reduce_scatter was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_REDUCE_SCATTER_BLOCK,
                      "The number of times MPI_Reduce_scatter_block was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_IREDUCE, "The number of times MPI_Ireduce was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IREDUCE_SCATTER,
                      "The number of times MPI_Ireduce_scatter was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_IREDUCE_SCATTER_BLOCK,
                      "The number of times MPI_Ireduce_scatter_block was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_REDUCE_INIT, "The number of times MPIX_Reduce_init was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_REDUCE_SCATTER_INIT,
                      "The number of times MPIX_Reduce_scatter_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_REDUCE_SCATTER_BLOCK_INIT,
                      "The number of times MPIX_Reduce_scatter_block_init was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLREDUCE, "The number of times MPI_Allreduce was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLREDUCE, "The number of times MPI_Iallreduce was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLREDUCE_INIT,
                      "The number of times MPIX_Allreduce_init was called.", false, false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_IEXSCAN, "The number of times MPI_Iexscan was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_SCAN_INIT, "The number of times MPIX_Scan_init was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_EXSCAN_INIT, "The number of times MPIX_Exscan_init was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_SCATTER, "The number of times MPI_Scatter was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_SCATTERV, "The number of times MPI_Scatterv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ISCATTER, "The number of times MPI_Iscatter was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ISCATTERV, "The number of times MPI_Iscatterv was called.", false,
                      false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_GATHERV, "The number of times MPI_Gatherv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IGATHER, "The number of times MPI_Igather was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IGATHERV, "The number of times MPI_Igatherv was called.", false,
                      false),
    ...
    SET_COUNTER_ARRAY(OMPI_SPC_GATHERV_INIT, "The number of times MPIX_Gatherv_init was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALL, "The number of times MPI_Alltoall was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALLV, "The number of times MPI_Alltoallv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALLW, "The number of times MPI_Alltoallw was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLTOALL, "The number of times MPI_Ialltoall was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLTOALLV, "The number of times MPI_Ialltoallv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLTOALLW, "The number of times MPI_Ialltoallw was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALL_INIT, "The number of times MPIX_Alltoall_init was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALLV_INIT,
                      "The number of times MPIX_Alltoallv_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLTOALLW_INIT,
                      "The number of times MPIX_Alltoallw_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALL,
                      "The number of times MPI_Neighbor_alltoall was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALLV,
                      "The number of times MPI_Neighbor_alltoallv was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALLW,
                      "The number of times MPI_Neighbor_alltoallw was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_INEIGHBOR_ALLTOALL,
                      "The number of times MPI_Ineighbor_alltoall was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_INEIGHBOR_ALLTOALLV,
                      "The number of times MPI_Ineighbor_alltoallv was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_INEIGHBOR_ALLTOALLW,
                      "The number of times MPI_Ineighbor_alltoallw was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALL_INIT,
                      "The number of times MPIX_Neighbor_alltoall_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALLV_INIT,
                      "The number of times MPIX_Neighbor_alltoallv_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLTOALLW_INIT,
                      "The number of times MPIX_Neighbor_alltoallw_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLGATHER, "The number of times MPI_Allgather was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLGATHERV, "The number of times MPI_Allgatherv was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLGATHER, "The number of times MPI_Iallgather was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IALLGATHERV, "The number of times MPI_Iallgatherv was called.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLGATHER_INIT,
                      "The number of times MPIX_Allgather_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_ALLGATHERV_INIT,
                      "The number of times MPIX_Allgatherv_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLGATHER,
                      "The number of times MPI_Neighbor_allgather was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLGATHERV,
                      "The number of times MPI_Neighbor_allgatherv was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_INEIGHBOR_ALLGATHER,
                      "The number of times MPI_Ineighbor_allgather was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_INEIGHBOR_ALLGATHERV,
                      "The number of times MPI_Ineighbor_allgatherv was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLGATHER_INIT,
                      "The number of times MPIX_Neighbor_allgather_init was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_NEIGHBOR_ALLGATHERV_INIT,
                      "The number of times MPIX_Neighbor_allgatherv_init was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_TEST, "The number of times MPI_Test was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_TESTALL, "The number of times MPI_Testall was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_TESTANY, "The number of times MPI_Testany was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_TESTSOME, "The number of times MPI_Testsome was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_WAIT, "The number of times MPI_Wait was called.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_WAITALL, "The number of times MPI_Waitall was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_WAITANY, "The number of times MPI_Waitany was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_WAITSOME, "The number of times MPI_Waitsome was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_BARRIER, "The number of times MPI_Barrier was called.", false,
                      false),
    SET_COUNTER_ARRAY(OMPI_SPC_IBARRIER, "The number of times MPI_Ibarrier was called.", false,
                      false),
    ...
    SET_COUNTER_ARRAY(
        ...
        "The number of bytes received by the user through point-to-point communications. Note: "
        "Includes bytes transferred using internal RMA operations.",
        false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_BYTES_RECEIVED_MPI,
                      "The number of bytes received by MPI through collective, control, or other "
                      "internal communications.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_BYTES_SENT_USER,
                      "The number of bytes sent by the user through point-to-point communications. "
                      " Note: Includes bytes transferred using internal RMA operations.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_BYTES_SENT_MPI,
                      "The number of bytes sent by MPI through collective, control, or other "
                      "internal communications.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_BYTES_PUT,
                      "The number of bytes sent/received using RMA Put operations both through "
                      "user-level Put functions and internal Put functions.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_BYTES_GET,
                      "The number of bytes sent/received using RMA Get operations both through "
                      "user-level Get functions and internal Get functions.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_UNEXPECTED,
                      "The number of messages that arrived as unexpected messages.", false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_OUT_OF_SEQUENCE,
                      "The number of messages that arrived out of the proper sequence.", false,
                      false),
    SET_COUNTER_ARRAY(
        OMPI_SPC_MATCH_TIME,
        "The number of microseconds spent matching unexpected messages.  Note: The timer used on "
        "the back end is in cycles, which could potentially be problematic on a system where the "
        "clock frequency can change.  On such a system, this counter could be inaccurate since we "
        "assume a fixed clock rate.",
        false, true),
    SET_COUNTER_ARRAY(OMPI_SPC_UNEXPECTED_IN_QUEUE,
                      "The number of messages that are currently in the unexpected message "
                      "queue(s) of an MPI process.",
                      false, false),
    SET_COUNTER_ARRAY(OMPI_SPC_OOS_IN_QUEUE,
                      "The number of messages that are currently in the out of sequence message "
                      "queue(s) of an MPI process.",
                      false, false),
    SET_COUNTER_ARRAY(
        OMPI_SPC_MAX_UNEXPECTED_IN_QUEUE,
        "The maximum number of messages that the unexpected message queue(s) within an MPI process "
        "contained at once since the last reset of this counter. Note: This counter is reset each "
        "time it is read.",
        true, false),
    SET_COUNTER_ARRAY(OMPI_SPC_MAX_OOS_IN_QUEUE,
                      "The maximum number of messages that the out of sequence message queue(s) "
                      "within an MPI process "
                      "contained at once since the last reset of this counter. Note: This counter "
                      "is reset each time it is read.",
                      true, false)};
...
static int ompi_spc_notify(mca_base_pvar_t *pvar, mca_base_pvar_event_t event, void *obj_handle,
                           int *count)
{
    int index;
...
void ompi_spc_init(void)
{
    ...
    for (i = 0; i < OMPI_SPC_NUM_COUNTERS; i++) {
        ...
        /* Registers the current counter as an MPI_T pvar regardless of whether it's been turned on
         * or not */
        ret = mca_base_pvar_register("ompi", "runtime", "spc", ompi_spc_events_desc[i].counter_name,
                                     ompi_spc_events_desc[i].counter_description, OPAL_INFO_LVL_4,
                                     MPI_T_PVAR_CLASS_SIZE, MCA_BASE_VAR_TYPE_UNSIGNED_LONG_LONG,
                                     NULL, MPI_T_BIND_NO_OBJECT, MCA_BASE_PVAR_FLAG_READONLY,
                                     ompi_spc_get_count, NULL, ompi_spc_notify,
                                     (void *) (uintptr_t) i);
        if (ret < 0) {
            mpi_t_enabled = false;
...
static void ompi_spc_dump(void)
{
    ...
    if (NULL == send_buffer) {
        opal_show_help("help-mpi-runtime.txt", "lib-call-fail", true, "malloc", __FILE__, __LINE__);
        return;
    }
    for (i = 0; i < OMPI_SPC_NUM_COUNTERS; i++) {
    ...
    if (0 == rank) {
        ...
        if (NULL == recv_buffer) {
            opal_show_help("help-mpi-runtime.txt", "lib-call-fail", true, "malloc", __FILE__,
                           __LINE__);
            return;
        }
    }
    ...
    /* Once rank 0 has all of the information, print the aggregated counter values for each rank in
     * order */
    if (rank == 0) {
        ...
        for (j = 0; j < world_size; j++) {
            ...
            for (i = 0; i < OMPI_SPC_NUM_COUNTERS; i++) {
                ...
                opal_output(0, "%s -> %lld\n", ompi_spc_events_desc[i].counter_name,
 ...
 */
static inline ompi_spc_value_t ompi_spc_cycles_to_usecs_internal(opal_timer_t cycles)
{
