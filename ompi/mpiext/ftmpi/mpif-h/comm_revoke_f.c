...
OMPI_GENERATE_F77_BINDINGS(PMPIX_COMM_REVOKE, pmpix_comm_revoke, pmpix_comm_revoke_,
                           pmpix_comm_revoke__, ompix_comm_revoke_f,
                           (MPI_Fint * comm, MPI_Fint *ierr), (comm, ierr))

OMPI_GENERATE_F77_BINDINGS(MPIX_COMM_REVOKE, mpix_comm_revoke, mpix_comm_revoke_,
                           mpix_comm_revoke__, ompix_comm_revoke_f,
                           (MPI_Fint * comm, MPI_Fint *ierr), (comm, ierr))
#endif
