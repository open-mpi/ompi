...
OMPI_GENERATE_F77_BINDINGS(PMPIX_COMM_FAILURE_GET_ACKED, pmpix_comm_failure_get_acked,
                           pmpix_comm_failure_get_acked_, pmpix_comm_failure_get_acked__,
                           ompix_comm_failure_get_acked_f,
                           (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr), (comm, group, ierr))

OMPI_GENERATE_F77_BINDINGS(MPIX_COMM_FAILURE_GET_ACKED, mpix_comm_failure_get_acked,
                           mpix_comm_failure_get_acked_, mpix_comm_failure_get_acked__,
                           ompix_comm_failure_get_acked_f,
                           (MPI_Fint * comm, MPI_Fint *group, MPI_Fint *ierr), (comm, group, ierr))
#endif
...
void ompix_comm_failure_get_acked_f(MPI_Fint *comm, MPI_Fint *group, MPI_Fint *ierr)
{
    ...
    *ierr = OMPI_INT_2_FINT(PMPIX_Comm_failure_get_acked(c_comm, &c_group));
