...
int MPIX_Bcast_init(void *buffer, int count, MPI_Datatype datatype, int root, MPI_Comm comm,
                    MPI_Info info, MPI_Request *request)
{
    ...
    err = comm->c_coll->coll_bcast_init(buffer, count, datatype, root, comm, info, request,
