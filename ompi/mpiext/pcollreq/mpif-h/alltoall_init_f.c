...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_ALLTOALL_INIT, pmpix_alltoall_init, pmpix_alltoall_init_,
                           pmpix_alltoall_init__, pompix_alltoall_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_ALLTOALL_INIT, mpix_alltoall_init, mpix_alltoall_init_,
                           mpix_alltoall_init__, ompix_alltoall_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
                            MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info,
...
void ompix_alltoall_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                           MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
                           MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPIX_Alltoall_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
                                 OMPI_FINT_2_INT(*recvcount), c_recvtype, c_comm, c_info, &c_req);
    if (NULL != ierr)
