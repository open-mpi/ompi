...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_ALLGATHER_INIT, pmpix_allgather_init, pmpix_allgather_init_,
                           pmpix_allgather_init__, pompix_allgather_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_ALLGATHER_INIT, mpix_allgather_init, mpix_allgather_init_,
                           mpix_allgather_init__, ompix_allgather_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
                            MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info,
...
void ompix_allgather_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
                            MPI_Fint *request, MPI_Fint *ierr)
{
    int ierr_c;
    ...
    ierr_c = PMPIX_Allgather_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
