...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_GATHER_INIT, pmpix_gather_init, pmpix_gather_init_,
                           pmpix_gather_init__, pompix_gather_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_GATHER_INIT, mpix_gather_init, mpix_gather_init_,
                           mpix_gather_init__, ompix_gather_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                            MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm,
...
void ompix_gather_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                         MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                         MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPIX_Gather_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
