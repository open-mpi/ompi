...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_EXSCAN_INIT, pmpix_exscan_init, pmpix_exscan_init_,
                           pmpix_exscan_init__, pompix_exscan_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_EXSCAN_INIT, mpix_exscan_init, mpix_exscan_init_,
                           mpix_exscan_init__, ompix_exscan_init_f,
                           (char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype,
                            MPI_Fint *op, MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request,
                            MPI_Fint *ierr),
                           (sendbuf, recvbuf, count, datatype, op, comm, info, request, ierr))
...
void ompix_exscan_init_f(char *sendbuf, char *recvbuf, MPI_Fint *count, MPI_Fint *datatype,
                         MPI_Fint *op, MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request,
                         MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPIX_Exscan_init(sendbuf, recvbuf, OMPI_FINT_2_INT(*count), c_type, c_op, c_comm,
                               c_info, &c_request);
    if (NULL != ierr)
