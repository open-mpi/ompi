...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_NEIGHBOR_ALLTOALLW_INIT, pmpix_neighbor_alltoallw_init,
                           pmpix_neighbor_alltoallw_init_, pmpix_neighbor_alltoallw_init__,
                           pompix_neighbor_alltoallw_init_f,
                           (char *sendbuf, MPI_Fint *sendcounts, MPI_Aint *sdispls,
                            MPI_Fint *sendtypes, char *recvbuf, MPI_Fint *recvcounts,
                            MPI_Aint *rdispls, MPI_Fint *recvtypes, MPI_Fint *comm, MPI_Fint *info,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_NEIGHBOR_ALLTOALLW_INIT, mpix_neighbor_alltoallw_init,
                           mpix_neighbor_alltoallw_init_, mpix_neighbor_alltoallw_init__,
...
void ompix_neighbor_alltoallw_init_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Aint *sdispls,
                                     MPI_Fint *sendtypes, char *recvbuf, MPI_Fint *recvcounts,
                                     ...
                                     MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPIX_Neighbor_alltoallw_init(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts), sdispls,
                                           c_sendtypes, recvbuf,
                                           OMPI_ARRAY_NAME_CONVERT(recvcounts), rdispls,
