...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_ALLGATHERV_INIT, pmpix_allgatherv_init, pmpix_allgatherv_init_,
                           pmpix_allgatherv_init__, pompix_allgatherv_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcounts, MPI_Fint *displs, MPI_Fint *recvtype,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_ALLGATHERV_INIT, mpix_allgatherv_init, mpix_allgatherv_init_,
                           mpix_allgatherv_init__, ompix_allgatherv_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcounts, MPI_Fint *displs, MPI_Fint *recvtype,
                            MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
...
void ompix_allgatherv_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                             MPI_Fint *recvcounts, MPI_Fint *displs, MPI_Fint *recvtype,
                             MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    MPI_Comm c_comm;
    ...
    ierr_c = PMPIX_Allgatherv_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
                                   OMPI_ARRAY_NAME_CONVERT(recvcounts),
                                   OMPI_ARRAY_NAME_CONVERT(displs), c_recvtype, c_comm, c_info,
                                   &c_request);
