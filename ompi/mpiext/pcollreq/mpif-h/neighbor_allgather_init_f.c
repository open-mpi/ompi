...
OMPI_GENERATE_F77_BINDINGS(
    PMPIX_NEIGHBOR_ALLGATHER_INIT, pmpix_neighbor_allgather_init, pmpix_neighbor_allgather_init_,
    pmpix_neighbor_allgather_init__, pompix_neighbor_allgather_init_f,
...
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(
    MPIX_NEIGHBOR_ALLGATHER_INIT, mpix_neighbor_allgather_init, mpix_neighbor_allgather_init_,
                                     ...
                                     MPI_Fint *ierr)
{
    ...
    ierr_c = PMPIX_Neighbor_allgather_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype,
                                           recvbuf, OMPI_FINT_2_INT(*recvcount), c_recvtype, c_comm,
                                           c_info, &c_req);
