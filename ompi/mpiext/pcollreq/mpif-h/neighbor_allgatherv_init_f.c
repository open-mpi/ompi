...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_NEIGHBOR_ALLGATHERV_INIT, pmpix_neighbor_allgatherv_init,
                           pmpix_neighbor_allgatherv_init_, pmpix_neighbor_allgatherv_init__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_NEIGHBOR_ALLGATHERV_INIT, mpix_neighbor_allgatherv_init,
                           mpix_neighbor_allgatherv_init_, mpix_neighbor_allgatherv_init__,
...
void ompix_neighbor_allgatherv_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype,
                                      ...
                                      MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *info,
                                      MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    ierr_c = PMPIX_Neighbor_allgatherv_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype,
                                            recvbuf, OMPI_ARRAY_NAME_CONVERT(recvcounts),
