...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_REDUCE_SCATTER_INIT, pmpix_reduce_scatter_init,
                           pmpix_reduce_scatter_init_, pmpix_reduce_scatter_init__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_REDUCE_SCATTER_INIT, mpix_reduce_scatter_init,
                           mpix_reduce_scatter_init_, mpix_reduce_scatter_init__,
...
void ompix_reduce_scatter_init_f(char *sendbuf, char *recvbuf, MPI_Fint *recvcounts,
                                 MPI_Fint *datatype, MPI_Fint *op, MPI_Fint *comm, MPI_Fint *info,
                                 MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPIX_Reduce_scatter_init(sendbuf, recvbuf, OMPI_ARRAY_NAME_CONVERT(recvcounts),
