...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_ALLTOALLW_INIT, pmpix_alltoallw_init, pmpix_alltoallw_init_,
                           pmpix_alltoallw_init__, pompix_alltoallw_init_f,
                           (char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls,
                            MPI_Fint *sendtypes, char *recvbuf, MPI_Fint *recvcounts,
                            MPI_Fint *rdispls, MPI_Fint *recvtypes, MPI_Fint *comm, MPI_Fint *info,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_ALLTOALLW_INIT, mpix_alltoallw_init, mpix_alltoallw_init_,
                           mpix_alltoallw_init__, ompix_alltoallw_init_f,
                           (char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls,
                            MPI_Fint *sendtypes, char *recvbuf, MPI_Fint *recvcounts,
                            MPI_Fint *rdispls, MPI_Fint *recvtypes, MPI_Fint *comm, MPI_Fint *info,
                            MPI_Fint *request, MPI_Fint *ierr),
...
void ompix_alltoallw_init_f(char *sendbuf, MPI_Fint *sendcounts, MPI_Fint *sdispls,
                            MPI_Fint *sendtypes, char *recvbuf, MPI_Fint *recvcounts,
                            MPI_Fint *rdispls, MPI_Fint *recvtypes, MPI_Fint *comm, MPI_Fint *info,
                            MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPIX_Alltoallw_init(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
                                  OMPI_ARRAY_NAME_CONVERT(sdispls), c_sendtypes, recvbuf,
                                  OMPI_ARRAY_NAME_CONVERT(recvcounts),
                                  OMPI_ARRAY_NAME_CONVERT(rdispls), c_recvtypes, c_comm, c_info,
                                  &c_request);
    if (NULL != ierr)
