...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_GATHERV_INIT, pmpix_gatherv_init, pmpix_gatherv_init_,
                           pmpix_gatherv_init__, pompix_gatherv_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_GATHERV_INIT, mpix_gatherv_init, mpix_gatherv_init_,
                           mpix_gatherv_init__, ompix_gatherv_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcounts, MPI_Fint *displs, MPI_Fint *recvtype,
                            MPI_Fint *root, MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request,
                            MPI_Fint *ierr),
...
void ompix_gatherv_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                          MPI_Fint *recvcounts, MPI_Fint *displs, MPI_Fint *recvtype,
                          MPI_Fint *root, MPI_Fint *comm, MPI_Fint *info, MPI_Fint *request,
                          MPI_Fint *ierr)
{
    ...
    c_ierr = PMPIX_Gatherv_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
                                OMPI_ARRAY_NAME_CONVERT(recvcounts),
                                OMPI_ARRAY_NAME_CONVERT(displs), c_recvtype, OMPI_FINT_2_INT(*root),
