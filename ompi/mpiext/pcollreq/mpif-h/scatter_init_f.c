...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_SCATTER_INIT, pmpix_scatter_init, pmpix_scatter_init_,
                           pmpix_scatter_init__, pompix_scatter_init_f,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_SCATTER_INIT, mpix_scatter_init, mpix_scatter_init_,
                           mpix_scatter_init__, ompix_scatter_init_f,
                           (char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                            MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                            MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr),
                           (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm,
...
void ompix_scatter_init_f(char *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, char *recvbuf,
                          MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm,
                          MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    int c_ierr;
    ...
    c_ierr = PMPIX_Scatter_init(sendbuf, OMPI_FINT_2_INT(*sendcount), c_sendtype, recvbuf,
