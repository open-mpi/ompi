...
#    else
OMPI_GENERATE_F77_BINDINGS(PMPIX_NEIGHBOR_ALLTOALLV_INIT, pmpix_neighbor_alltoallv_init,
                           pmpix_neighbor_alltoallv_init_, pmpix_neighbor_alltoallv_init__,
...
#else
#    if !OMPI_BUILD_MPI_PROFILING
OMPI_GENERATE_F77_BINDINGS(MPIX_NEIGHBOR_ALLTOALLV_INIT, mpix_neighbor_alltoallv_init,
                           mpix_neighbor_alltoallv_init_, mpix_neighbor_alltoallv_init__,
                                     ...
                                     MPI_Fint *info, MPI_Fint *request, MPI_Fint *ierr)
{
    ...
    c_ierr = PMPIX_Neighbor_alltoallv_init(sendbuf, OMPI_ARRAY_NAME_CONVERT(sendcounts),
