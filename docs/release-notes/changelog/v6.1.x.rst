...
- The documentation now publishes machine-readable, LLM-friendly
  ...
  corpora, per-symbol Markdown pages, curated examples and an interface
  guide, and a manifest, all indexed from ``llms.txt``. See the
  "LLM-friendly documentation artifacts" page in the developer
  documentation.
