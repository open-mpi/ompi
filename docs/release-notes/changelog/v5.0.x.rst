...
Open MPI Version v5.0.10rc1
------------------------------
:Date: 20 January 2026

- Internal PMIx and PRRTe versions:
  - PMIx (v5.0.10). Repo: ``https://github.com/openpmix/openpmix``. Commit hash: ``d8b5823ebbce7edf819570ea30c77ce2f66c4b79``.
  - PRRTE (v3.0.13). Repo: ``https://github.com/openpmix/prrte``. Commit hash: ``912c62c67f7f2ce84fbe8f7e6a71c1773d1b63d2``.
