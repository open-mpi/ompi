...
Can I use limit the time spent on establishing TCP connections?
---------------------------------------------------------------
...
aka. the exchange of valid magic string and process guid. These two
...
The default values are 250000 usec for the ``tcp_recv_timeout`` and 1000000
usec for the ``tcp_handshake_timeout``.
