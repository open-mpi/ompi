 ...
 * @file
 * 
 * NONE STEMS component
 *
 * Simple, braindead implementation.
 */

#ifndef MCA_STEMS_NONE_EXPORT_H
#define MCA_STEMS_NONE_EXPORT_H
 ...
 */
struct orca_stems_none_component_t {
    orca_stems_base_component_t super;  /** Base STEMS component */
};
typedef struct orca_stems_none_component_t orca_stems_none_component_t;
ORCA_MODULE_DECLSPEC extern orca_stems_none_component_t mca_stems_none_component;
...
int orca_stems_none_name_to_string(char **output,
                                        const orca_process_name_t* name);
int orca_stems_none_name_from_string(orca_process_name_t* name,
                                          char *output);
