...
int
mca_io_romio_File_open (MPI_Comm comm,
                        char *filename,
                        int amode,
                        MPI_Info info,
                        MPI_File * fh)
{
    ...
    ret =
        mca_io_romio_MPI_File_open (comm, filename, amode, info,
                                    &romio_fh);
...
int
mca_io_romio_File_close (MPI_File * fh)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
    mca_io_romio_file_t *mca_romio_fh;
...
int
mca_io_romio_File_set_size (MPI_File fh,
                            MPI_Offset size)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_preallocate (MPI_File fh,
                               MPI_Offset size)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_get_size (MPI_File fh,
                            MPI_Offset * size)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_get_group (MPI_File fh,
                             MPI_Group * group)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_set_info (MPI_File fh,
                            MPI_Info info)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_get_info (MPI_File fh,
                            MPI_Info * info_used)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_set_view (MPI_File fh,
                            MPI_Offset disp,
                            MPI_Datatype etype,
                            ...
                            MPI_Info info)
{
    ...
    OMPI_THREAD_LOCK (&mca_io_romio_mutex);
    ret =
        mca_io_romio_MPI_File_set_view (romio_fh, disp, etype, filetype,
                                        datarep, info);
    OMPI_THREAD_UNLOCK (&mca_io_romio_mutex);
...
int
mca_io_romio_File_get_view (MPI_File fh,
                            MPI_Offset * disp,
                            MPI_Datatype * etype,
                            MPI_Datatype * filetype,
                            char *datarep)
{
    ...
    OMPI_THREAD_LOCK (&mca_io_romio_mutex);
    ret =
        mca_io_romio_MPI_File_get_view (romio_fh, disp, etype, filetype,
                                        datarep);
    OMPI_THREAD_UNLOCK (&mca_io_romio_mutex);
...
int
mca_io_romio_File_get_type_extent (MPI_File fh,
                                   ...
                                   MPI_Aint * extent)
{
    ...
    OMPI_THREAD_LOCK (&mca_io_romio_mutex);
    ret =
        mca_io_romio_MPI_File_get_type_extent (romio_fh, datatype, extent);
    OMPI_THREAD_UNLOCK (&mca_io_romio_mutex);
...
int
mca_io_romio_File_set_atomicity (MPI_File fh,
                                 int flag)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_get_atomicity (MPI_File fh,
                                 int *flag)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_sync (MPI_File fh)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
    mca_io_romio_file_t *mca_romio_fh;
...
int
mca_io_romio_File_seek_shared (MPI_File fh,
                               MPI_Offset offset,
                               int whence)
{
    int         ret;
...
int
mca_io_romio_File_get_position_shared (MPI_File fh,
                                       MPI_Offset * offset)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_seek (MPI_File fh,
                        MPI_Offset offset,
                        int whence)
{
    int         ret;
...
int
mca_io_romio_File_get_position (MPI_File fh,
                                MPI_Offset * offset)
{
    int         ret;
    mca_io_romio_MPI_File romio_fh;
...
int
mca_io_romio_File_get_byte_offset (MPI_File fh,
                                   MPI_Offset offset,
                                   MPI_Offset * disp)
{
    int         ret;
