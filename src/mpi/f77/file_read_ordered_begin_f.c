...
#pragma weak PMPI_FILE_READ_ORDERED_BEGIN = mpi_file_read_ordered_begin_f
#pragma weak pmpi_file_read_ordered_begin = mpi_file_read_ordered_begin_f
#pragma weak pmpi_file_read_ordered_begin_ = mpi_file_read_ordered_begin_f
#pragma weak pmpi_file_read_ordered_begin__ = mpi_file_read_ordered_begin_f
#elif LAM_PROFILE_LAYER
LAM_GENERATE_F77_BINDINGS (PMPI_FILE_READ_ORDERED_BEGIN,
...
#pragma weak mpi_file_read_ordered_begin = mpi_file_read_ordered_begin_f
#pragma weak mpi_file_read_ordered_begin_ = mpi_file_read_ordered_begin_f
#pragma weak mpi_file_read_ordered_begin__ = mpi_file_read_ordered_begin_f
#endif

#if ! LAM_HAVE_WEAK_SYMBOLS && ! LAM_PROFILE_LAYER
LAM_GENERATE_F77_BINDINGS (MPI_FILE_READ_ORDERED_BEGIN,
