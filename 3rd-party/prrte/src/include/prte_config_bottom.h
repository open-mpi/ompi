 ...
 * $HEADER$
 *
 * This file is included at the bottom of prte_config.h, and is
...
#if PRTE_HAVE_ATTRIBUTE_ALWAYS_INLINE
#    define __prte_attribute_always_inline__ __attribute__((__always_inline__))
#else
...
#if PRTE_HAVE_ATTRIBUTE_VISIBILITY
#    define __prte_attribute_visibility__(a) __attribute__((__visibility__(a)))
#else
#    define __prte_attribute_visibility__(a)
#endif

#if PRTE_HAVE_ATTRIBUTE_WARN_UNUSED_RESULT
#    define __prte_attribute_warn_unused_result__ __attribute__((__warn_unused_result__))
#else
#    define __prte_attribute_warn_unused_result__
#endif

#if PRTE_HAVE_ATTRIBUTE_WEAK_ALIAS
#    define __prte_attribute_weak_alias__(a) __attribute__((__weak__, __alias__(a)))
#else
