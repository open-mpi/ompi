...
static int dvm_component_query(pmix_mca_base_module_t **module, int *priority);
...
prte_errmgr_base_component_t prte_mca_errmgr_dvm_component = {
    ...
    .base_version = {
        ...
        .pmix_mca_open_component = dvm_open,
        .pmix_mca_close_component = dvm_close,
        .pmix_mca_query_component = dvm_component_query,
...
static int dvm_component_query(pmix_mca_base_module_t **module, int *priority)
{
    ...
    if (PRTE_PROC_IS_MASTER) {
        ...
        *module = (pmix_mca_base_module_t *) &prte_errmgr_dvm_module;
        return PRTE_SUCCESS;
    }
