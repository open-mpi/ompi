...
# ********************************************************************
#
# Internal macros - do not call from outside PRTE_CONFIG_POSIX_THREADS
#
# ********************************************************************


AC_DEFUN([PRTE_INTL_PTHREAD_TRY_LINK], [
...
#
# ********************************************************************
AC_DEFUN([PRTE_INTL_POSIX_THREADS_PLAIN_C], [
#
# C compiler
#
if test "$prte_pthread_c_success" = "0"; then
  ...
  AC_LANG_PUSH(C)
  PRTE_INTL_PTHREAD_TRY_LINK(prte_pthread_c_success=1,
...
AC_DEFUN([PRTE_INTL_POSIX_THREADS_PLAIN], [
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [PRTE_INTL_POSIX_THREADS_PLAIN_C],
...
#
# ********************************************************************
AC_DEFUN([PRTE_INTL_POSIX_THREADS_SPECIAL_FLAGS_C], [
#
# C compiler
#
if test "$prte_pthread_c_success" = "0"; then
...
AC_DEFUN([PRTE_INTL_POSIX_THREADS_SPECIAL_FLAGS],[
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [PRTE_INTL_POSIX_THREADS_SPECIAL_FLAGS_C],
                  [prte_pthread_c_success=1])
...
#
# ********************************************************************
AC_DEFUN([PRTE_INTL_POSIX_THREADS_LIBS_C],[
#
# C compiler
#
if test "$prte_pthread_c_success" = "0"; then
...
AC_DEFUN([PRTE_INTL_POSIX_THREADS_LIBS],[
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [PRTE_INTL_POSIX_THREADS_LIBS_C],
                  [prte_pthread_c_success=1])
...
#
#********************************************************************
AC_DEFUN([PRTE_CONFIG_POSIX_THREADS],[
...
PRTE_INTL_POSIX_THREADS_PLAIN

# Try the super-special compiler flags.
PRTE_INTL_POSIX_THREADS_SPECIAL_FLAGS

# Try the normal linking methods (that's no fun)
PRTE_INTL_POSIX_THREADS_LIBS
...
AC_DEFINE_UNQUOTED([PRTE_HAVE_PTHREAD_MUTEX_ERRORCHECK_NP], [$defval],
...
AC_LINK_IFELSE(
    ...
    [result="yes" defval=1], [result="no" defval=0])
AC_MSG_RESULT([$result])
AC_DEFINE_UNQUOTED([PRTE_HAVE_PTHREAD_MUTEX_ERRORCHECK], [$defval],
