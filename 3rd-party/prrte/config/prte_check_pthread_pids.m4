...
AC_DEFUN([PRTE_CHECK_PTHREAD_PIDS],[
#
# Arguments: none
#
# Dependencies: None
...
PRTE_VAR_SCOPE_PUSH([tpids_CFLAGS_save tpids_CPPFLAGS_save tpids_LDFLAGS_save tpids_LIBS_save tpids_MSG])
...
[tpids_MSG=yes PRTE_THREADS_HAVE_DIFFERENT_PIDS=1],
[
...
AS_IF([test "x$PRTE_THREADS_HAVE_DIFFERENT_PIDS" = "x"],
...
AS_IF([test "$PRTE_THREADS_HAVE_DIFFERENT_PIDS" = "1"],
