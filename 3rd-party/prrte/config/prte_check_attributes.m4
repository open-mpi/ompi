...
#   Sun C++: skip
#
AC_DEFUN([_PRTE_ATTRIBUTE_FAIL_SEARCH],[
...
#
AC_DEFUN([_PRTE_CHECK_SPECIFIC_ATTRIBUTE], [
    AC_MSG_CHECKING([for __attribute__([$1])])
    AC_CACHE_VAL(prte_cv___attribute__[$1], [
        #
        ...
        AC_COMPILE_IFELSE([AC_LANG_SOURCE([$2])],
                       [
                        ...
                        #
                        prte_cv___attribute__[$1]=1
                        _PRTE_ATTRIBUTE_FAIL_SEARCH([$1])
                       ],
                       [prte_cv___attribute__[$1]=0])
    ])

    if test "$prte_cv___attribute__[$1]" = "1" ; then
        AC_MSG_RESULT([yes])
    else
        AC_MSG_RESULT([no])
    fi
...
# of _PRTE_CHECK_SPECIFIC_ATTRIBUTE for the support of
# particular attributes. Compilers, that do not support an
# attribute most often fail with a warning (when the warning
# level is set).
# The compilers output is parsed in _PRTE_ATTRIBUTE_FAIL_SEARCH
#
# To add a new attributes __NAME__ add the
#   prte_cv___attribute__NAME
# add a new check with _PRTE_CHECK_SPECIFIC_ATTRIBUTE (possibly with a cross-check)
#   _PRTE_CHECK_SPECIFIC_ATTRIBUTE([name], [int foo (int arg) __attribute__ ((__name__));], [], [])
# and define the corresponding
#   AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NAME, [$prte_cv___attribute__NAME],
#                      [Whether your compiler has __attribute__ NAME or not])
# and decide on a correct macro (in prte/include/prte_config_bottom.h):
#  #  define __prte_attribute_NAME(x)  __attribute__(__NAME__)
#
...
AC_DEFUN([PRTE_CHECK_ATTRIBUTES], [
  AC_LANG(C)
  AC_MSG_CHECKING(for __attribute__)

  AC_CACHE_VAL(prte_cv___attribute__, [
    AC_COMPILE_IFELSE([AC_LANG_PROGRAM([#include <stdlib.h>],
      ...
      [prte_cv___attribute__=0])])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE, [$prte_cv___attribute__],
...
#
  if test "$prte_cv___attribute__" = "0" ; then
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([aligned],
    ...
    #
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([always_inline],
        [int foo (int arg) __attribute__ ((__always_inline__));],
        [],
        [])

    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([cold],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([const],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([format],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([format_funcptr],
        [
         int (*this_printf)(void *my_object, const char *my_format, ...) __attribute__ ((__format__ (__printf__, 2, 3)));
        ],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([hot],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([malloc],
        [
#ifdef HAVE_STDLIB_H
#  include <stdlib.h>
#endif
    ...
    #
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([may_alias],
        [int * p_value __attribute__ ((__may_alias__));],
        [],
        [])


    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([no_instrument_function],
        [int * foo(int arg1) __attribute__ ((__no_instrument_function__));],
        [],
        [])


    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([noinline],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([nonnull],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([noreturn],
        [
#ifdef HAVE_UNISTD_H
#  include <unistd.h>
#endif
...
#  include <stdlib.h>
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([noreturn_funcptr],
        [
#ifdef HAVE_UNISTD_H
#  include <unistd.h>
#endif
...
#  include <stdlib.h>
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([packed],
        [
         struct foo {
             char a;
             int x[2] __attribute__ ((__packed__));
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([pure],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([sentinel],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([unused],
        [
    ...
    #
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([visibility],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([warn_unused_result],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([weak_alias],
        [
         int foo(int arg);
         int foo(int arg) { return arg + 3; }
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([destructor],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([optnone],
        [
    ...
    _PRTE_CHECK_SPECIFIC_ATTRIBUTE([extension],
        [
  ...
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_ALIGNED, [$prte_cv___attribute__aligned],
                     [Whether your compiler has __attribute__ aligned or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_ALWAYS_INLINE, [$prte_cv___attribute__always_inline],
                     [Whether your compiler has __attribute__ always_inline or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_COLD, [$prte_cv___attribute__cold],
                     [Whether your compiler has __attribute__ cold or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_CONST, [$prte_cv___attribute__const],
  ...
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_HOT, [$prte_cv___attribute__hot],
                     [Whether your compiler has __attribute__ hot or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_MALLOC, [$prte_cv___attribute__malloc],
                     [Whether your compiler has __attribute__ malloc or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_MAY_ALIAS, [$prte_cv___attribute__may_alias],
                     [Whether your compiler has __attribute__ may_alias or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NO_INSTRUMENT_FUNCTION, [$prte_cv___attribute__no_instrument_function],
                     [Whether your compiler has __attribute__ no_instrument_function or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NOINLINE, [$prte_cv___attribute__noinline],
                     [Whether your compiler has __attribute__ noinline or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NONNULL, [$prte_cv___attribute__nonnull],
                     [Whether your compiler has __attribute__ nonnull or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NORETURN, [$prte_cv___attribute__noreturn],
                     [Whether your compiler has __attribute__ noreturn or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_NORETURN_FUNCPTR, [$prte_cv___attribute__noreturn_funcptr],
                     [Whether your compiler has __attribute__ noreturn and it works on function pointers])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_PACKED, [$prte_cv___attribute__packed],
                     [Whether your compiler has __attribute__ packed or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_PURE, [$prte_cv___attribute__pure],
                     [Whether your compiler has __attribute__ pure or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_SENTINEL, [$prte_cv___attribute__sentinel],
                     [Whether your compiler has __attribute__ sentinel or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_UNUSED, [$prte_cv___attribute__unused],
                     [Whether your compiler has __attribute__ unused or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_VISIBILITY, [$prte_cv___attribute__visibility],
                     [Whether your compiler has __attribute__ visibility or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_WARN_UNUSED_RESULT, [$prte_cv___attribute__warn_unused_result],
                     [Whether your compiler has __attribute__ warn unused result or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_WEAK_ALIAS, [$prte_cv___attribute__weak_alias],
                     [Whether your compiler has __attribute__ weak alias or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_DESTRUCTOR, [$prte_cv___attribute__destructor],
                     [Whether your compiler has __attribute__ destructor or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_OPTNONE, [$prte_cv___attribute__optnone],
                     [Whether your compiler has __attribute__ optnone or not])
  AC_DEFINE_UNQUOTED(PRTE_HAVE_ATTRIBUTE_EXTENSION, [$prte_cv___attribute__extension],
