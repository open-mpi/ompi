...
struct oshmem_request_t {
    ...
    bool req_persistent; /* TODO: NOT Required */                       /**< flag indicating if this is a persistent request *//* TODO: Verify if required */
    int req_f_to_c_index;                         /**< Index in Fortran <-> C translation array *//* TODO: Verify if required */
    oshmem_request_free_fn_t req_free;            /**< Called by free */
    oshmem_request_cancel_fn_t req_cancel;        /* TODO: Not Required */        /**< Optional function to cancel the request */
