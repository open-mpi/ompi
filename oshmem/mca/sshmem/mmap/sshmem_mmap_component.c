...
static int mmap_register(void)
{
    ...
    mca_base_component_var_register(&mca_sshmem_mmap_component.super.base_version, "priority",
                                    "Priority for sshmem mmap "
    ...
    mca_base_component_var_register(&mca_sshmem_mmap_component.super.base_version, "anonymous",
                                    "Select whether anonymous sshmem is used for mmap "
                                    "component (default: 1)",
                                    MCA_BASE_VAR_TYPE_INT, NULL, 0, MCA_BASE_VAR_FLAG_SETTABLE,
    ...
    mca_base_component_var_register(&mca_sshmem_mmap_component.super.base_version, "fixed",
                                    "Select whether fixed start address is used for shmem "
                                    "(default: 1)",
                                    MCA_BASE_VAR_TYPE_INT, NULL, 0, MCA_BASE_VAR_FLAG_SETTABLE,
                                    OPAL_INFO_LVL_4, MCA_BASE_VAR_SCOPE_ALL_EQ,
