...
static size_t release_unused_segments(mstate m)
{
    ...
    /* Reset check counter */
    m->release_checks = ((nsegs > (int) MAX_RELEASE_CHECK_RATE) ? (size_t) nsegs
...
#    else  /* FOOTERS */
        ...
        // gm->least_addr, p, (unsigned)p->head, (int)chunksize(p),
...
#    endif /* FOOTERS */
        ...
        // (unsigned)mparams.magic, oldmem, (int)bytes);
