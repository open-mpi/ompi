...
static mca_memheap_base_module_t* mca_memheap_ptmalloc_component_init( memheap_context_t *, int * ); 
...
mca_memheap_base_module_t* mca_memheap_ptmalloc_component_init(memheap_context_t *context, int *priority) 
{
    int rc;
