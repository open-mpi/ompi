...
typedef sshmem_mkey_t *(*mca_memheap_base_module_get_local_mkey_fn_t)(void *va, int transport_id);
 ...
 */
#define MCA_MEMHEAP_BASE_VERSION_2_0_0 OSHMEM_MCA_BASE_VERSION_2_1_0("memheap", 2, 0, 0)
...
#    define MCA_MEMHEAP_CALL(a) \
        MCA_MEMHEAP_CALL_EXPANDER(MCA_oshmem_memheap_DIRECT_CALL_COMPONENT, a)
...
{
    return mca_memheap.memheap_is_symmetric_addr(dst_addr) && mca_memheap_base_mkey_is_shm(mkey);
}
