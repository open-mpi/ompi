 ...
 */
typedef int (*mca_spml_base_module_enable_fn_t)(
        bool enable
        );
 ...
 *
 */
typedef mca_spml_mkey_t * (*mca_spml_base_module_register_fn_t)(void *addr, size_t size, uint64_t shmid, int *count);
 ...
 */
typedef int (*mca_spml_base_module_oob_get_mkeys_fn_t)(int pe, uint32_t seg, mca_spml_mkey_t *mkeys);
 ...
 *
 */
typedef int (*mca_spml_base_module_add_procs_fn_t)(oshmem_proc_t** procs, size_t nprocs);
typedef int (*mca_spml_base_module_del_procs_fn_t)(oshmem_proc_t** procs, size_t nprocs);
 ...
 * @return         OSHMEM_SUCCESS or failure status.
 */
typedef int (*mca_spml_base_module_put_fn_t)(void *dst_addr, size_t size, void *src_addr, int dst);
 ...
 * @return         OSHMEM_SUCCESS or failure status.
 */
typedef int (*mca_spml_base_module_put_nb_fn_t)(void *dst_addr, size_t size, void *src_addr, int dst, void **handle);
 ...
 * @return         - OSHMEM_SUCCESS or failure status.
 */
typedef int (*mca_spml_base_module_get_fn_t)(void *dst_addr, size_t size, void *src_addr, int src);
 ...
 *  @return                 OSHMEM_SUCCESS or failure status.
 */
typedef int (*mca_spml_base_module_recv_fn_t)(
    void *buf,
    size_t count,
    int src
);
 ...
 *  @return                 OSHMEM_SUCCESS or failure status.
 */
typedef int (*mca_spml_base_module_send_fn_t)(
    void *buf,
    size_t count,
    int dst,
 ...
 */
/*TODO: Irit - change to MCA_oshmem_spml_DIRECT_CALL_HEADER*/
