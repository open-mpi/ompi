...
{
    mca_spml_yoda_put_request_t* putreq = *(mca_spml_yoda_put_request_t**)request;
...
static int mca_spml_yoda_put_request_cancel(struct oshmem_request_t* request, int complete)
{
...
static void mca_spml_yoda_put_request_construct(mca_spml_yoda_put_request_t* req)
{
    ...
    req->req_put.req_base.req_oshmem.req_cancel = mca_spml_yoda_put_request_cancel;
}
        ...
        int status )
{
    ...
    mca_spml_yoda_put_request_t* putreq = (mca_spml_yoda_put_request_t*)frag->rdma_req;
    ...
    if (!strcmp(bml_btl->btl->btl_component->btl_version.mca_component_name,"sm")){
        oshmem_request_cond.puts_counter_sm--;
    }
    else if (!strcmp(bml_btl->btl->btl_component->btl_version.mca_component_name,"openib")){
