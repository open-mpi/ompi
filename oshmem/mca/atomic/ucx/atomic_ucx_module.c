...
static inline
int mca_atomic_ucx_not_implemented(void *target,
                                   void *prev,
                                   const void *value,
                                   size_t nlong,
                                   int pe,
...
mca_atomic_ucx_query(int *priority)
{
    ...
    *priority = mca_atomic_ucx_component.priority;
    ...
    if (module) {
        ...
        module->super.atomic_fand  = mca_atomic_ucx_not_implemented;
        module->super.atomic_for   = mca_atomic_ucx_not_implemented;
        module->super.atomic_fxor  = mca_atomic_ucx_not_implemented;
