...
OBJ_CLASS_INSTANCE(mca_atomic_base_module_t, opal_object_t, atomic_base_module_construct, NULL);
...
static int mca_atomic_base_close(void)
{
    ...
    OPAL_LIST_FOREACH_SAFE (cli, next, &oshmem_atomic_base_framework.framework_components,
                            mca_base_component_list_item_t) {
        component = cli->cli_component;
        mca_atomic_base_component_t *atomic = (mca_atomic_base_component_t *) component;
...
static int mca_atomic_base_open(mca_base_open_flag_t flags)
{
    ...
    if (OPAL_SUCCESS != mca_base_framework_components_open(&oshmem_atomic_base_framework, flags)) {
        return OSHMEM_ERROR;
    }
...
MCA_BASE_FRAMEWORK_DECLARE(oshmem, atomic, "OSHMEM ATOMIC", mca_atomic_base_register,
                           mca_atomic_base_open, mca_atomic_base_close,
                           mca_atomic_base_static_components, MCA_BASE_FRAMEWORK_FLAG_DEFAULT);
