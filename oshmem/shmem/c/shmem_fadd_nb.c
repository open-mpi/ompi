...
/*
 * These routines perform a nonblocking fetch-and-add operation.
 ...
 */
#define DO_SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(ctx, type_name, type, fetch, target, value, pe, out_value) do { \
...
#define SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(type_name, type, prefix)            \
    void prefix##_ctx##type_name##_atomic_fetch_add_nbi(shmem_ctx_t ctx, type *fetch, type *target, type value, int pe) \
    {                                                                           \
        type out_value;                                                         \
        DO_SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(ctx, type_name, type, fetch, target, \
                                  value, pe, out_value);                        \
        return ;                                                                \
    }

#define SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(type_name, type, prefix)                \
    void prefix##type_name##_atomic_fetch_add_nbi(type *fetch, type *target, type value, int pe) \
    {                                                                           \
        type out_value;                                                         \
        DO_SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(oshmem_ctx_default, type_name,       \
                                  type, fetch, target, value, pe, out_value);   \
        return ;                                                                \
    }
...
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_int, int, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_long, long, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_longlong, long long, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_uint, unsigned int, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_ulong, unsigned long, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_ulonglong, unsigned long long, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_int32, int32_t, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_int64, int64_t, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_uint32, uint32_t, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_uint64, uint64_t, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_size, size_t, shmem)
SHMEM_CTX_TYPE_ATOMIC_FETCH_ADD_NBI(_ptrdiff, ptrdiff_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_int, int, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_long, long, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_longlong, long long, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_uint, unsigned int, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_ulong, unsigned long, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_ulonglong, unsigned long long, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_int32, int32_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_int64, int64_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_uint32, uint32_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_uint64, uint64_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_size, size_t, shmem)
SHMEM_TYPE_ATOMIC_FETCH_ADD_NBI(_ptrdiff, ptrdiff_t, shmem)
