 ...
 */
#define DO_SHMEM_TYPE_ATOMIC_FETCH_INC(ctx, type_name, type, target, pe, out_value)             \
    do {                                                                                        \
...
#define SHMEM_CTX_TYPE_ATOMIC_FETCH_INC(type_name, type, prefix)                           \
    ...
    {                                                                                      \
        type out_value;                                                                    \
        DO_SHMEM_TYPE_ATOMIC_FETCH_INC(ctx, type_name, type, target, pe, out_value);       \
        return out_value;                                                                  \
    }
...
#define SHMEM_TYPE_ATOMIC_FETCH_INC(type_name, type, prefix)                            \
    ...
    {                                                                                   \
        type out_value;                                                                 \
        DO_SHMEM_TYPE_ATOMIC_FETCH_INC(oshmem_ctx_default, type_name, type, target, pe, \
                                       out_value);                                      \
        return out_value;                                                               \
    }
