 ...
 */
#define DO_SHMEM_TYPE_ATOMIC_SWAP(ctx, type, target, value, pe, out_value)                    \
    do {                                                                                      \
        ...
        rc = MCA_ATOMIC_CALL(swap(ctx, (void *) target, (void *) &out_value,                  \
...
#define SHMEM_CTX_TYPE_ATOMIC_SWAP(type_name, type, prefix)                                       \
    ...
    {                                                                                             \
        type out_value;                                                                           \
        DO_SHMEM_TYPE_ATOMIC_SWAP(ctx, type, target, value, pe, out_value);                       \
        return out_value;                                                                         \
    }
...
#define SHMEM_TYPE_ATOMIC_SWAP(type_name, type, prefix)                                    \
    ...
    {                                                                                      \
        type out_value;                                                                    \
        DO_SHMEM_TYPE_ATOMIC_SWAP(oshmem_ctx_default, type, target, value, pe, out_value); \
        return out_value;                                                                  \
    }
