 ...
 */
#define DO_SHMEM_TYPE_ATOMIC_FETCH(ctx, type_name, type, target, pe, out_value)                 \
    do {                                                                                        \
...
#define SHMEM_CTX_TYPE_ATOMIC_FETCH(type_name, type, prefix)                                 \
    ...
    {                                                                                        \
        type out_value;                                                                      \
        DO_SHMEM_TYPE_ATOMIC_FETCH(ctx, type_name, type, target, pe, out_value);             \
        return out_value;                                                                    \
    }
...
#define SHMEM_TYPE_ATOMIC_FETCH(type_name, type, prefix)                                        \
    ...
    {                                                                                           \
        type out_value;                                                                         \
        DO_SHMEM_TYPE_ATOMIC_FETCH(oshmem_ctx_default, type_name, type, target, pe, out_value); \
                                                                                                \
        return out_value;                                                                       \
    }
