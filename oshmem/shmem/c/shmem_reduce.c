...
#define SHMEM_TYPE_REDUCE_OP(name, type_name, type, prefix)                                     \
    void prefix##type_name##_##name##_to_all(type *target, const type *source, int nreduce,     \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            ...
            rc = group->g_scoll.scoll_reduce(group, op, (void *) target, (const void *) source, \
                                             size, pSync, (void *) pWrk, SCOLL_DEFAULT_ALG);    \
                                                                                                \
