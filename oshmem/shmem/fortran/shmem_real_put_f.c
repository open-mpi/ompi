...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_REAL_PUT, shmem_real_put_, shmem_real_put__,
                                    shmem_real_put_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_real_put_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                      MPI_Fint *pe)
{
