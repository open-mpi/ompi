...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_REAL_IPUT, shmem_real_iput_, shmem_real_iput__,
                                    shmem_real_iput_f,
...
void shmem_real_iput_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
