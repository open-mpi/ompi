...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_INTEGER_IGET, shmem_integer_iget_,
                                    shmem_integer_iget__, shmem_integer_iget_f,
...
void shmem_integer_iget_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
