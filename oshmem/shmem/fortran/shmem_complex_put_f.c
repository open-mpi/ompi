...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_COMPLEX_PUT, shmem_complex_put_,
                                    shmem_complex_put__, shmem_complex_put_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_complex_put_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                         MPI_Fint *pe)
{
