...
SHMEM_GENERATE_WEAK_BINDINGS(SHMEM_INT4_FXOR, shmem_int4_fxor)
...
ompi_fortran_integer4_t shmem_int4_fxor_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T value, MPI_Fint *pe)
{
