...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_IGET32, shmem_iget32_, shmem_iget32__,
                                    shmem_iget32_f,
...
void shmem_iget32_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
