...
SHMEM_GENERATE_WEAK_BINDINGS(SHMEM_INT8_FAND, shmem_int8_fand)
...
ompi_fortran_integer8_t shmem_int8_fand_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T value, MPI_Fint *pe)
{
