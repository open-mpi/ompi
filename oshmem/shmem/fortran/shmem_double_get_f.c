...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_DOUBLE_GET, shmem_double_get_, shmem_double_get__,
                                    shmem_double_get_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *len, MPI_Fint *pe),
                                    (target, source, len, pe))

void shmem_double_get_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *len,
                        MPI_Fint *pe)
{
