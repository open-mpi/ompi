...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT2_PROD_TO_ALL, shmem_int2_prod_to_all_, shmem_int2_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT4_PROD_TO_ALL, shmem_int4_prod_to_all_, shmem_int4_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT8_PROD_TO_ALL, shmem_int8_prod_to_all_, shmem_int8_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_COMP4_PROD_TO_ALL, shmem_comp4_prod_to_all_, shmem_comp4_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_COMP8_PROD_TO_ALL, shmem_comp8_prod_to_all_, shmem_comp8_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_REAL4_PROD_TO_ALL, shmem_real4_prod_to_all_, shmem_real4_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_REAL8_PROD_TO_ALL, shmem_real8_prod_to_all_, shmem_real8_prod_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_REAL16_PROD_TO_ALL, shmem_real16_prod_to_all_, shmem_real16_prod_to_all__,
    shmem_real16_prod_to_all_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nreduce, MPI_Fint *PE_start,
     MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T *pWrk, FORTRAN_POINTER_T pSync),
    (target, source, nreduce, PE_start, logPE_stride, PE_size, pWrk, pSync))

#define SHMEM_PROD_TO_ALL(F_NAME, T_NAME)                                                       \
    void F_NAME(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nreduce,          \
                MPI_Fint *PE_start, MPI_Fint *logPE_stride, MPI_Fint *PE_size,                  \
                FORTRAN_POINTER_T *pWrk, FORTRAN_POINTER_T pSync)                               \
    {                                                                                           \
        int rc;                                                                                 \
        ...
        rc = group->g_scoll.scoll_reduce(group, op, FPTR_2_VOID_PTR(target),                    \
                                         FPTR_2_VOID_PTR(source), size, FPTR_2_VOID_PTR(pSync), \
