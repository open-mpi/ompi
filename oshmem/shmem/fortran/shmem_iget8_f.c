...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_IGET8, shmem_iget8_, shmem_iget8__, shmem_iget8_f,
...
void shmem_iget8_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst, MPI_Fint *sst,
