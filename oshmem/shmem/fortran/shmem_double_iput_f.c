...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_DOUBLE_IPUT, shmem_double_iput_,
                                    shmem_double_iput__, shmem_double_iput_f,
...
void shmem_double_iput_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
