...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_COMPLEX_IPUT, shmem_complex_iput_,
                                    shmem_complex_iput__, shmem_complex_iput_f,
...
void shmem_complex_iput_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
