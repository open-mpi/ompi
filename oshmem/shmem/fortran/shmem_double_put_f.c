...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_DOUBLE_PUT, shmem_double_put_, shmem_double_put__,
                                    shmem_double_put_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_double_put_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                        MPI_Fint *pe)
{
