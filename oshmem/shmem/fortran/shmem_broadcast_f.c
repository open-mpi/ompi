...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_BROADCAST4, shmem_broadcast4_, shmem_broadcast4__, shmem_broadcast4_f,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_BROADCAST8, shmem_broadcast8_, shmem_broadcast8__, shmem_broadcast8_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nlong, MPI_Fint *PE_root,
     MPI_Fint *PE_start, MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T pSync),
    (target, source, nlong, PE_root, PE_start, logPE_stride, PE_size, pSync))

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_BROADCAST32, shmem_broadcast32_, shmem_broadcast32__, shmem_broadcast32_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nlong, MPI_Fint *PE_root,
     MPI_Fint *PE_start, MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T pSync),
    (target, source, nlong, PE_root, PE_start, logPE_stride, PE_size, pSync))

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_BROADCAST64, shmem_broadcast64_, shmem_broadcast64__, shmem_broadcast64_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nlong, MPI_Fint *PE_root,
     MPI_Fint *PE_start, MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T pSync),
    (target, source, nlong, PE_root, PE_start, logPE_stride, PE_size, pSync))

#define SHMEM_BROADCAST(F_NAME, T_NAME)                                                           \
    void F_NAME(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nlong,              \
                MPI_Fint *PE_root, MPI_Fint *PE_start, MPI_Fint *logPE_stride, MPI_Fint *PE_size, \
    ...
    {                                                                                             \
        ...
        if ((0 <= OMPI_FINT_2_INT(*PE_root))                                                      \
            ...
            rc = group->g_scoll.scoll_broadcast(group, rel_PE_root, FPTR_2_VOID_PTR(target),      \
                                                FPTR_2_VOID_PTR(source),                          \
                                                OMPI_FINT_2_INT(*nlong) * op->dt_size,            \
                                                FPTR_2_VOID_PTR(pSync), true, SCOLL_DEFAULT_ALG); \
        out:                                                                                      \
