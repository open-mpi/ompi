...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_SET_CACHE_INV, shmem_set_cache_inv_,
                                    shmem_set_cache_inv__, shmem_set_cache_inv_f, (void), ())

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_SET_CACHE_LINE_INV, shmem_set_cache_line_inv_,
                                    shmem_set_cache_line_inv__, shmem_set_cache_line_inv_f,
                                    (FORTRAN_POINTER_T target), (target))

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_CLEAR_CACHE_INV, shmem_clear_cache_inv_,
                                    shmem_clear_cache_inv__, shmem_clear_cache_inv_f, (void), ())

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_CLEAR_CACHE_LINE_INV, shmem_clear_cache_line_inv_,
                                    shmem_clear_cache_line_inv__, shmem_clear_cache_line_inv_f,
                                    (FORTRAN_POINTER_T target), (target))

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_UDCFLUSH, shmem_udcflush_, shmem_udcflush__,
                                    shmem_udcflush_f, (void), ())

SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_UDCFLUSH_LINE, shmem_udcflush_line_,
                                    shmem_udcflush_line__, shmem_udcflush_line_f,
                                    (FORTRAN_POINTER_T target), (target))
