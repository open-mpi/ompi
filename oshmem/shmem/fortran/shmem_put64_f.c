...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_PUT64, shmem_put64_, shmem_put64__, shmem_put64_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_put64_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                   MPI_Fint *pe)
{
