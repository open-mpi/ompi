...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_COMPLEX_IGET, shmem_complex_iget_,
                                    shmem_complex_iget__, shmem_complex_iget_f,
...
void shmem_complex_iget_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
