...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_IPUT32, shmem_iput32_, shmem_iput32__,
                                    shmem_iput32_f,
...
void shmem_iput32_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
