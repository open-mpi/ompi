...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT2_XOR_TO_ALL, shmem_int2_xor_to_all_, shmem_int2_xor_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT4_XOR_TO_ALL, shmem_int4_xor_to_all_, shmem_int4_xor_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT8_XOR_TO_ALL, shmem_int8_xor_to_all_, shmem_int8_xor_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_COMP4_XOR_TO_ALL, shmem_comp4_xor_to_all_, shmem_comp4_xor_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_COMP8_XOR_TO_ALL, shmem_comp8_xor_to_all_, shmem_comp8_xor_to_all__,
    shmem_comp8_xor_to_all_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nreduce, MPI_Fint *PE_start,
     MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T *pWrk, FORTRAN_POINTER_T pSync),
    (target, source, nreduce, PE_start, logPE_stride, PE_size, pWrk, pSync))

#define SHMEM_XOR_TO_ALL(F_NAME, T_NAME)                                                        \
