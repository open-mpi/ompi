...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_REAL_GET, shmem_real_get_, shmem_real_get__,
                                    shmem_real_get_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *len, MPI_Fint *pe),
                                    (target, source, len, pe))

void shmem_real_get_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *len,
                      MPI_Fint *pe)
{
