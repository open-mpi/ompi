...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT2_AND_TO_ALL, shmem_int2_and_to_all_, shmem_int2_and_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT4_AND_TO_ALL, shmem_int4_and_to_all_, shmem_int4_and_to_all__,
...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(
    void, SHMEM_INT8_AND_TO_ALL, shmem_int8_and_to_all_, shmem_int8_and_to_all__,
    shmem_int8_and_to_all_f,
    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *nreduce, MPI_Fint *PE_start,
     MPI_Fint *logPE_stride, MPI_Fint *PE_size, FORTRAN_POINTER_T *pWrk, FORTRAN_POINTER_T pSync),
    (target, source, nreduce, PE_start, logPE_stride, PE_size, pWrk, pSync))

#define SHMEM_AND_TO_ALL(F_NAME, T_NAME)                                                        \
