...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_INTEGER_PUT, shmem_integer_put_,
                                    shmem_integer_put__, shmem_integer_put_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_integer_put_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                         MPI_Fint *pe)
{
