...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_CHARACTER_PUT, shmem_character_put_,
                                    shmem_character_put__, shmem_character_put_f,
                                    (FORTRAN_POINTER_T target, FORTRAN_POINTER_T source,
                                     MPI_Fint *length, MPI_Fint *pe),
                                    (target, source, length, pe))

void shmem_character_put_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *length,
                           MPI_Fint *pe)
{
