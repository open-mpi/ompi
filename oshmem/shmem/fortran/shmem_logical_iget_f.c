...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_LOGICAL_IGET, shmem_logical_iget_,
                                    shmem_logical_iget__, shmem_logical_iget_f,
...
void shmem_logical_iget_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
