...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_DOUBLE_IGET, shmem_double_iget_,
                                    shmem_double_iget__, shmem_double_iget_f,
...
void shmem_double_iget_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
