...
SHMEM_GENERATE_FORTRAN_BINDINGS_SUB(void, SHMEM_LOGICAL_IPUT, shmem_logical_iput_,
                                    shmem_logical_iput__, shmem_logical_iput_f,
...
void shmem_logical_iput_f(FORTRAN_POINTER_T target, FORTRAN_POINTER_T source, MPI_Fint *tst,
