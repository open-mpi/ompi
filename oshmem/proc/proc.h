 ...
 */
OSHMEM_DECLSPEC int oshmem_proc_pack(oshmem_proc_t **proclist, int proclistsize,
                                 opal_buffer_t *buf);
...
OSHMEM_DECLSPEC int oshmem_proc_unpack(opal_buffer_t *buf, 
                                   int proclistsize, oshmem_proc_t ***proclist,
                                   int *newproclistsize, oshmem_proc_t ***newproclist);
 ...
 * known universe, or NULL if there is an internal failure.
 */
OSHMEM_DECLSPEC oshmem_group_t* oshmem_proc_group_create(int pe_start, int pe_stride, size_t pe_size);
...
static inline oshmem_proc_t* oshmem_proc_group_find (oshmem_group_t* group, int pe)
{
    int i = 0;
