...
int oshmem_shmem_register_params(void)
{
    ...
    (void) mca_base_var_register(
        "oshmem", "oshmem", NULL, "lock_recursive",
        ...
        MCA_BASE_VAR_SCOPE_READONLY, &oshmem_shmem_lock_recursive);

    (void) mca_base_var_register("oshmem", "oshmem", NULL, "api_verbose",
                                 "Verbosity level of the shmem c functions (default = 0)",
                                 MCA_BASE_VAR_TYPE_INT, NULL, 0, MCA_BASE_VAR_FLAG_SETTABLE,
                                 OPAL_INFO_LVL_9, MCA_BASE_VAR_SCOPE_READONLY,
                                 &oshmem_shmem_api_verbose);

    (void) mca_base_var_register("oshmem", "oshmem", NULL, "preconnect_all",
