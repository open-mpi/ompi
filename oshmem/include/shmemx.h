...
/* Atomic Fetch&And */
OSHMEM_DECLSPEC int32_t shmemx_int32_fand(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC int64_t shmemx_int64_fand(int64_t *target, int64_t value, int pe);

/* Atomic Fetch&Or */
OSHMEM_DECLSPEC int32_t shmemx_int32_for(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC int64_t shmemx_int64_for(int64_t *target, int64_t value, int pe);

/* Atomic Fetch&Xor */
OSHMEM_DECLSPEC int32_t shmemx_int32_fxor(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC int64_t shmemx_int64_fxor(int64_t *target, int64_t value, int pe);
...
/* Atomic And */
OSHMEM_DECLSPEC void shmemx_int32_and(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC void shmemx_int64_and(int64_t *target, int64_t value, int pe);

/* Atomic Or */
OSHMEM_DECLSPEC void shmemx_int32_or(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC void shmemx_int64_or(int64_t *target, int64_t value, int pe);

/* Atomic Xor */
OSHMEM_DECLSPEC void shmemx_int32_xor(int32_t *target, int32_t value, int pe);
OSHMEM_DECLSPEC void shmemx_int64_xor(int64_t *target, int64_t value, int pe);
