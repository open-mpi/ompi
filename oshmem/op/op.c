 ...
 * Class instance
 */
OBJ_CLASS_INSTANCE(oshmem_op_t, opal_object_t, 
                   oshmem_op_construct, oshmem_op_destruct);
...
//oshmem_op_t* oshmem_op_xor_fcomp4 = NULL;
//oshmem_op_t* oshmem_op_xor_fcomp8 = NULL;
...
//FUNC_OP_CREATE(xor, fcomp4, ompi_fortran_complex4_t, __xor_op);
//FUNC_OP_CREATE(xor, fcomp8, ompi_fortran_complex8_t, __xor_op);
...
int oshmem_op_init(void)
{
    ...
    if( OPAL_SUCCESS != opal_pointer_array_init(&oshmem_op_array, 0,
...
//    OBJ_OP_CREATE(xor, fcomp4, ompi_fortran_comp4_t, OSHMEM_OP_XOR, OSHMEM_OP_TYPE_FCOMP4);
//    OBJ_OP_CREATE(xor, fcomp8, ompi_fortran_comp8_t, OSHMEM_OP_XOR, OSHMEM_OP_TYPE_FCOMP8);
