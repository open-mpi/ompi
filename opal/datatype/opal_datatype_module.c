...
int opal_datatype_register_params(void)
{
    ...
    ret = mca_base_var_register(
        ...
        "Reports are written to the default output stream (stderr).",
    ...
    static const struct {
        ...
        {"datatype_optimize_max_desc_growth",
         ...
         "Values above 1024 are clamped to 1024",
    ...
    if (OPAL_DATATYPE_OPTIMIZE_MAX_DESC_GROWTH_CAP < opal_datatype_config.optimize.max_desc_growth) {
        opal_datatype_config.optimize.max_desc_growth = OPAL_DATATYPE_OPTIMIZE_MAX_DESC_GROWTH_CAP;
    }
