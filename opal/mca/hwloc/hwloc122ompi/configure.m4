...
#
AC_DEFUN([MCA_hwloc_hwloc122ompi_COMPILE_MODE], [
...
# ---------------------------------
AC_DEFUN([MCA_hwloc_hwloc122ompi_POST_CONFIG],[
...
# --------------------------------------------------------------------
AC_DEFUN([MCA_hwloc_hwloc122ompi_CONFIG],[
    OMPI_VAR_SCOPE_PUSH([HWLOC_VERSION opal_hwloc_hwloc122ompi_save_CPPFLAGS opal_hwloc_hwloc122ompi_save_LDFLAGS opal_hwloc_hwloc122ompi_save_LIBS opal_hwloc_hwloc122ompi_save_cairo opal_hwloc_hwloc122ompi_save_xml opal_hwloc_hwloc122ompi_basedir opal_hwloc_hwloc122ompi_file])
