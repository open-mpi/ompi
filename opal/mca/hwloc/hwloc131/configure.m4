...
#
AC_DEFUN([MCA_hwloc_hwloc131_COMPILE_MODE], [
...
# ---------------------------------
AC_DEFUN([MCA_hwloc_hwloc131_POST_CONFIG],[
...
# --------------------------------------------------------------------
AC_DEFUN([MCA_hwloc_hwloc131_CONFIG],[
    OMPI_VAR_SCOPE_PUSH([HWLOC_VERSION opal_hwloc_hwloc131_save_CPPFLAGS opal_hwloc_hwloc131_save_LDFLAGS opal_hwloc_hwloc131_save_LIBS opal_hwloc_hwloc131_save_cairo opal_hwloc_hwloc131_save_xml opal_hwloc_hwloc131_basedir opal_hwloc_hwloc131_file opal_hwloc_hwloc131_save_enable_pci])
    ...
    if test "$with_hwloc" = "internal" -o "$with_hwloc" = "" -o "$with_hwloc" = "yes"; then
        ...
        # mojo).
        opal_hwloc_hwloc131_save_enable_pci=$enable_pci
        enable_pci=no
        ...
        enable_pci=$opal_hwloc_hwloc131_save_enable_pci
