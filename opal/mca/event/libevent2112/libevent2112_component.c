 ...
 */
const char *opal_event_libevent2112_component_version_string =
    "OPAL libevent2112 event MCA component version " OPAL_VERSION;
 ...
 * Local functions
 */
static int libevent2112_register (void);
static int libevent2112_open(void);
...
const opal_event_component_t mca_event_libevent2112_component = {
    ...
    .base_version = {
        ...
        .mca_component_name = "libevent2112",
        MCA_BASE_MAKE_VERSION(component, OPAL_MAJOR_VERSION, OPAL_MINOR_VERSION,
                              OPAL_RELEASE_VERSION),

        /* Component functions */
        .mca_open_component = libevent2112_open,
        .mca_register_component_params = libevent2112_register
    },
    .base_data = {
...
static int libevent2112_register (void)
{
    ...
    ret = mca_base_component_var_register (&mca_event_libevent2112_component.base_version,
