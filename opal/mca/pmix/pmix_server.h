...
typedef int (*opal_pmix_server_finalized_fn_t)(opal_process_name_t *proc, void* server_object,
...
typedef int (*opal_pmix_server_fencenb_fn_t)(opal_list_t *procs, char *data, size_t ndata,
...
typedef int (*opal_pmix_server_dmodex_req_fn_t)(opal_process_name_t *proc,
                                                opal_pmix_modex_cbfunc_t cbfunc, void *cbdata);
...
typedef int (*opal_pmix_server_spawn_fn_t)(opal_list_t *apps,
...
typedef int (*opal_pmix_server_connect_fn_t)(opal_list_t *procs,
                                             opal_pmix_op_cbfunc_t cbfunc, void *cbdata);
...
typedef int (*opal_pmix_server_disconnect_fn_t)(opal_list_t *procs,
                                                opal_pmix_op_cbfunc_t cbfunc, void *cbdata);
...
typedef struct opal_pmix_server_module_1_0_0_t {
    opal_pmix_server_finalized_fn_t        finalized;
