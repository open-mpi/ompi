...
typedef int (*opal_pmix_base_module_lookup_nb_fn_t)(opal_pmix_data_range_t scope, int wait, const char **keys,
...
typedef int (*opal_pmix_base_module_unpublish_fn_t)(opal_pmix_data_range_t scope, const char **keys);
 ...
 * for the keys parameter instructs the server to remove
 * _all_ data published by this process within the given scope  */
typedef int (*opal_pmix_base_module_unpublish_nb_fn_t)(opal_pmix_data_range_t scope, const char **keys,
                                                       opal_pmix_op_cbfunc_t cbfunc, void *cbdata);
 ...
 * code to the caller */
typedef int (*opal_pmix_base_module_spawn_fn_t)(opal_list_t *apps,
                                                opal_jobid_t *jobid);
...
typedef int (*opal_pmix_base_module_spawn_nb_fn_t)(opal_list_t *apps,
...
typedef const char* (*opal_pmix_base_module_get_rendezvous_address_fn_t)(void);
...
typedef struct {
    ...
    opal_pmix_base_module_get_rendezvous_address_fn_t server_get_addr;
