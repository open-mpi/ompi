...
static int posix_runtime_query(mca_base_module_t **module, int *priority, const char *hint);
...
opal_shmem_posix_component_t mca_shmem_posix_component = {
    .super =
        {
            .base_version = {OPAL_SHMEM_BASE_VERSION_2_0_0,
                             ...
                             .mca_open_component = posix_open, .mca_query_component = posix_query,
...
static int posix_runtime_query(mca_base_module_t **module, int *priority, const char *hint)
{
    ...
    *module = NULL;
    ...
    if (NULL != hint) {
         ...
         */
        if (0
            == strcasecmp(hint, mca_shmem_posix_component.super.base_version.mca_component_name)) {
    ...
    if (-1 != (fd = shmem_posix_shm_open(tmp_buff, OPAL_SHMEM_POSIX_FILE_LEN_MAX))) {
