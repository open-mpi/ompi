...
AC_DEFUN([_OPAL_COMMON_LIBFABRIC_WITH_FLAGS],[
    ...
    OMPI_CHECK_WITHDIR([libfabric], [$with_libfabric],
                       [include/rdma/fabric.h])
    OMPI_CHECK_WITHDIR([libfabric-libdir], [$with_libfabric_libdir],
                       [libfabric.*])
...
AC_DEFUN([_OPAL_COMMON_LIBFABRIC_SETUP_LIBFABRIC_EMBEDDED],[
    ...
    AS_IF([test $opal_common_libfabric_happy -eq 1],
           [ # FOR THE v1.8 TREE:
            ...
            opal_common_libfabric_CPPFLAGS="-I$OMPI_TOP_SRCDIR/opal/mca/common/libfabric/libfabric -I$OMPI_TOP_SRCDIR/opal/mca/common/libfabric/libfabric/include"
            opal_common_libfabric_build_embedded=1
            opal_common_libfabric_LIBADD="\$(OMPI_TOP_BUILDDIR)/opal/mca/common/libfabric/lib${OPAL_LIB_PREFIX}mca_common_libfabric.la"
...
AC_DEFUN([_OPAL_COMMON_LIBFABRIC_SETUP_LIBFABRIC_EXTERNAL],[
    ...
    OMPI_CHECK_PACKAGE([opal_common_libfabric],
                       [rdma/fabric.h],
                       [fabric],
                       [fi_getinfo],
                       [],
...
#include <net/if.h>
    ...
    AS_IF([test $opal_common_libfabric_usnic_happy -eq 1],
          [opal_common_libfabric_CPPFLAGS="$opal_common_libfabric_CPPFLAGS $opal_common_libfabric_LIBNL_CPPFLAGS -I$OMPI_TOP_SRCDIR/opal/mca/common/libfabric/libfabric/prov/usnic/src -I$OMPI_TOP_SRCDIR/opal/mca/common/libfabric/libfabric/prov/usnic/src/usnic_direct -D__LIBUSNIC__ -DHAVE_LIBNL3=$HAVE_LIBNL3 -DWANT_DEBUG_MSGS=0"
...
AC_DEFUN([_OPAL_COMMON_LIBFABRIC_EMBEDDED_PROVIDER_PSM],[
    ...
    AS_IF([test $opal_common_libfabric_psm_happy -eq 1],
          [opal_common_libfabric_CPPFLAGS="$opal_common_libfabric_CPPFLAGS -I$OMPI_TOP_SRCDIR/opal/mca/common/libfabric/libfabric/prov/psm/src"
