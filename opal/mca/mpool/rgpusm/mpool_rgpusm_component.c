...
static int opal_mpool_rgpusm_verbose = 0;
...
static int rgpusm_open(void)
{
    ...
    opal_output_set_verbosity(mca_mpool_rgpusm_component.output, opal_mpool_rgpusm_verbose);
