 ...
 */
typedef void *(*mca_allocator_base_module_alloc_fn_t)(struct mca_allocator_base_module_t *,
                                                      size_t size, size_t align);

/**
 * The realloc function typedef
 */
typedef void *(*mca_allocator_base_module_realloc_fn_t)(struct mca_allocator_base_module_t *,
                                                        void *, size_t);
...
typedef void *(*mca_allocator_base_component_segment_alloc_fn_t)(void *ctx, size_t *size);
 ...
 * allocator framework.
 */
typedef void (*mca_allocator_base_component_segment_free_fn_t)(void *ctx, void *segment);
 ...
 */
#define MCA_ALLOCATOR_BASE_VERSION_2_0_0 OPAL_MCA_BASE_VERSION_2_1_0("allocator", 2, 0, 0)
