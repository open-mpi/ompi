...
mca_allocator_base_module_t *mca_allocator_basic_component_init(
    ...
    mca_allocator_base_component_segment_free_fn_t segment_free, void *ctx);
 ...
 */
void *mca_allocator_basic_alloc(mca_allocator_base_module_t *mem, size_t size, size_t align);
 ...
 *
 */
void *mca_allocator_basic_realloc(mca_allocator_base_module_t *mem, void *ptr, size_t size);
