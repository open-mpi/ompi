...
MCA_BASE_FRAMEWORK_DECLARE(opal, if, NULL, opal_if_base_register, opal_if_base_open,
                           opal_if_base_close, mca_if_base_static_components, 0);
...
static int opal_if_base_register(mca_base_register_flag_t flags)
{
    ...
    (void) mca_base_framework_var_register(&opal_if_base_framework, "do_not_resolve",
                                           ...
                                           MCA_BASE_VAR_SCOPE_ALL_EQ, &opal_if_do_not_resolve);
    ...
    (void) mca_base_framework_var_register(&opal_if_base_framework, "retain_loopback",
                                           ...
                                           MCA_BASE_VAR_TYPE_BOOL, NULL, 0,
                                           MCA_BASE_VAR_FLAG_SETTABLE, OPAL_INFO_LVL_9,
                                           MCA_BASE_VAR_SCOPE_ALL_EQ, &opal_if_retain_loopback);
