 ...
 * necessary */
mca_rcache_base_registration_t *sm_get_registation(struct mca_btl_base_endpoint_t *ep,
                                                   ...
                                                   void **local_ptr)
{
    ...
    rc = mca_rcache_base_vma_iterate(vma_module, (void *) base, bound - base, true, sm_check_reg,
                                     &check_ctx);
    if (2 == rc) {
