...
struct opal_btl_iwarp_connect_base_module_data_t;

/**
 * Data received from the modex.  For each iwarp BTL module/port in
 ...
 */
typedef struct mca_btl_iwarp_proc_modex_t {
    /** Information about the peer's port */
    mca_btl_iwarp_modex_message_t pm_port_info;

    /** Array of the peer's CPCs available on this port */
    opal_btl_iwarp_connect_base_module_data_t *pm_cpc_data;

    /** Length of the pm_cpc_data array */
    uint8_t pm_cpc_data_count;
} mca_btl_iwarp_proc_modex_t;
...
struct mca_btl_iwarp_proc_btlptr_t {
    opal_list_item_t super;
    mca_btl_iwarp_module_t* iwarp_btl;
};
typedef struct mca_btl_iwarp_proc_btlptr_t mca_btl_iwarp_proc_btlptr_t;

OBJ_CLASS_DECLARATION(mca_btl_iwarp_proc_btlptr_t);
...
struct mca_btl_iwarp_proc_t {
    ...
    mca_btl_iwarp_proc_modex_t *proc_ports;

    /** length of proc_ports array */
    uint8_t proc_port_count;

    /** list of iwarp_btl's that touched this proc **/
    opal_list_t iwarp_btls;
...
typedef struct mca_btl_iwarp_proc_t mca_btl_iwarp_proc_t;

OBJ_CLASS_DECLARATION(mca_btl_iwarp_proc_t);

mca_btl_iwarp_proc_t* mca_btl_iwarp_proc_get_locked(opal_proc_t* proc);
int mca_btl_iwarp_proc_insert(mca_btl_iwarp_proc_t*, mca_btl_base_endpoint_t*);
int mca_btl_iwarp_proc_remove(opal_proc_t* proc,
                               mca_btl_base_endpoint_t* module_endpoint);
int mca_btl_iwarp_proc_reg_btl(mca_btl_iwarp_proc_t* ib_proc,
                                mca_btl_iwarp_module_t* iwarp_btl);
