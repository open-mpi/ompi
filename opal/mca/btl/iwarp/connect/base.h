...
#ifndef BTL_IWARP_CONNECT_BASE_H
#define BTL_IWARP_CONNECT_BASE_H

#include "opal/mca/btl/iwarp/connect/connect.h"

#ifdef OPAL_HAVE_RDMAOE
#define BTL_IWARP_CONNECT_BASE_CHECK_IF_NOT_IB(btl)                       \
 ...
 */
int opal_btl_iwarp_connect_base_select_for_local_port
    (mca_btl_iwarp_module_t *btl);
 ...
 * Select function
 */
int opal_btl_iwarp_connect_base_find_match
    (mca_btl_iwarp_module_t *btl,
     struct mca_btl_iwarp_proc_modex_t *peer_port,
 ...
 */
int opal_btl_iwarp_connect_base_get_cpc_index
    (opal_btl_iwarp_connect_base_component_t *cpc);
 ...
 * Allocate a CTS frag
 */
int opal_btl_iwarp_connect_base_alloc_cts(
        struct mca_btl_base_endpoint_t *endpoint);

/*
 * Free a CTS frag
 */
int opal_btl_iwarp_connect_base_free_cts(
        struct mca_btl_base_endpoint_t *endpoint);
