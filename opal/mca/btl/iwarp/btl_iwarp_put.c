...
int mca_btl_iwarp_put (mca_btl_base_module_t *btl, struct mca_btl_base_endpoint_t *ep, void *local_address,
                        uint64_t remote_address, mca_btl_base_registration_handle_t *local_handle,
                        mca_btl_base_registration_handle_t *remote_handle, size_t size, int flags,
                        int order, mca_btl_base_rdma_completion_fn_t cbfunc, void *cbcontext, void *cbdata)
{
    mca_btl_iwarp_put_frag_t *frag = NULL;
    int rc, qp = order;
    ...
    rc = mca_btl_iwarp_put_internal (btl, ep, frag);
    if (OPAL_UNLIKELY(OPAL_SUCCESS != rc)) {
...
int mca_btl_iwarp_put_internal (mca_btl_base_module_t *btl, struct mca_btl_base_endpoint_t *ep,
                                 mca_btl_iwarp_put_frag_t *frag)
{
     ...
     * connected. By setting these values here instead of mca_btl_iwarp_put we guarantee
