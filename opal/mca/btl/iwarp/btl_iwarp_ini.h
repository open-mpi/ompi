...
#ifndef MCA_PTL_IWARP_PARAMS_H
#define MCA_PTL_IWARP_PARAMS_H
 ...
 * file
 */
typedef struct opal_btl_iwarp_ini_values_t {
    uint32_t mtu;
    bool mtu_set;
...
BEGIN_C_DECLS
     ...
     */
    int opal_btl_iwarp_ini_query(uint32_t vendor_id,
     ...
     */
    int opal_btl_iwarp_ini_intify(char *string);
    int opal_btl_iwarp_ini_intify_list(char *str, uint32_t **values, int *len);
