...
int mca_btl_iwarp_get (mca_btl_base_module_t *btl, struct mca_btl_base_endpoint_t *ep, void *local_address,
                        ...
                        int order, mca_btl_base_rdma_completion_fn_t cbfunc, void *cbcontext, void *cbdata)
{
    ...
    rc = mca_btl_iwarp_get_internal (btl, ep, frag);
...
int mca_btl_iwarp_get_internal (mca_btl_base_module_t *btl, struct mca_btl_base_endpoint_t *ep,
                                 mca_btl_iwarp_get_frag_t *frag)
{
