 ...
 */
typedef void (*orte_rmcast_callback_fn_t)(orte_rmcast_channel_t channel, opal_buffer_t *buf, void* cbdata);
...
typedef int (*orte_rmcast_base_module_recv_fn_t)(orte_rmcast_channel_t channel,
                                                 orte_rmcast_tag_t tag,
                                                 opal_buffer_t *buf);
